    ...
    public function configuration()
    {
        ...
        if ($offline_payment_status) {
            $offline_payment = [
                ...
                'image' => asset('assets/back-end/img/pay-offline.png'),
            ];
        }
        ...
        $company_cover_image = asset("storage/logo/") . '/' . BusinessSetting::where(['type' => 'shop_banner'])->first()->value;
        $company_fav_icon = asset("storage/company/") . '/' . BusinessSetting::where(['type' => 'company_fav_icon'])->first()->value;
        $footer_logo = asset("storage/company/") . '/' . BusinessSetting::where(['type' => 'company_footer_logo'])->first()->value;
        ...
        return response()->json([
            ...
            'base_urls' => [
                ...
                'review_image_url' => asset('storage'),
                ...
                'flag_image_url' => asset('assets/front-end/img/flags'),
                'delivery_man_verification_image' => asset('storage/delivery-man/verification-image'),
            ],
            'static_urls' => [
            ...
            'payment_method_image_path' => asset('storage/payment_modules/gateway_image'),
