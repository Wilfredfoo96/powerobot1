...
class PaymentMethodController extends Controller
{
    ...
    public function payment_config_set(Request $request)
    {
        ...
        if (!$additional_data_image || !isset($additional_data_image->gateway_image) || (isset($additional_data_image->gateway_image) && $additional_data_image->gateway_image == '') || (isset($additional_data_image->gateway_image) && !file_exists(base_path("storage/payment_modules/gateway_image/" . $additional_data_image->gateway_image)))) {
            $request->validate([
