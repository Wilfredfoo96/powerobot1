            ...
            <form class="needs-validation mt-2" autocomplete="off" action="{{route('customer.auth.login')}}"
                ...
                <div class="form-group d-flex flex-wrap justify-content-between">
                    <div class="rtl">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label text-primary" for="remember">{{ translate('remember_me')
                                }}</label>
                        </div>
                    </div>
                ...
                <div class="row py-2">
                    <div class="col-6 pr-2">
                        <input type="text" class="form-control border __h-40" name="default_recaptcha_id_customer_login"
            ...
            <div class="d-flex justify-content-center my-3 gap-2">
                ...
                <div>
                    <a class="d-block"
                        ...
                        <img src="{{asset('/assets/front-end/img/icons/'.$socialLoginService['login_medium'].'.png')}}"
                            alt="">
                    </a>
                </div>
                @endif
