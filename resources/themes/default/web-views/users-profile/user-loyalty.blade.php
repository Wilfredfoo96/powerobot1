                ...
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-2 mb-sm-0 d-sm-none">
                        <div class="position-relative">
                            <button type="button"
                                class="border-0 bg-trnasparent p-0 how-to-use-info-button rounded-circle lh-1">

                                <img src="{{asset('assets/front-end/img/icons/icon-i.png')}}" width="18">
                            </button>
                            <div class="how-to-use-hover-ele">
                                <h6 class='subtitle text-capitalize mb-2 fs-14 font-bold'>{{translate('how_to_use')}}
                                </h6>
                                <ul class='pl-4 fs-12'>
                                    <li>
                                    ...
                                    <li>
                                        {{translate('minimum')}}
                                        {{App\CPU\Helpers::get_business_settings('loyalty_point_minimum_point')}}
                                        {{translate('points_required_to_convert_into_currency')}}
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card btn--primary h-100 position-relative">
                                ...
                                <img class="wallet-card-bg z-1"
                                    src="{{ asset('assets/front-end/img/reward-card.png') }}" alt="">
                            </div>
                        </div>
                        <div class="col-md-6 d-none d-sm-block">
                            <div class="my-wallet-card-content h-100 text-break-word">
                                ...
                                <div class="mt-3 text-center d-none d-sm-block">
                                    ...
                                    <button type="button" class="btn btn-sm rounded btn--primary" data-toggle="modal"
                                        data-target="#convertToCurrency">
                                        <span>
            ...
            <div class="card __card loyalty-card">
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === " rtl" ? 'padding-right: 0px' : ''
                        ...
                        <div class="dropdown border rounded">
                            <button class="btn btn-sm pl-3 dropdown-toggle" type="button" id="dropdownMenuButton"
                                ...
                                {{ translate('filter')}} : {{ request()->has('type') ?
                                ucwords(translate(request('type'))):translate('all')}}
                            </button>
                ...
                <div class="card-body pt-0">
                        ...
                        <div class="bg--light my-1 p-3 p-sm-3 rounded d-flex justify-content-between g-2">
                            <div class="">
                                <h6 class="mb-2 d-flex align-items-center gap-8">
                                    @if($item['debit'] != 0)
                                    <img src="{{ asset('assets/front-end/img/icons/coin-danger.png') }}" width="25"
                                        alt="">
                                    @else
                                    <img src="{{ asset('assets/front-end/img/icons/coin-success.png') }}" width="25"
                                        alt="">
                                    @endif

                                    {{ $item['debit'] != 0 ? ' - '.\App\CPU\Helpers::currency_converter($item['debit'])
                    ...
                    <div class="d-flex flex-column gap-3 align-items-center text-center my-5">
                        <img width="72" src="{{ asset('assets/front-end/img/icons/empty-transaction-history.png')}}"
                            class="dark-support" alt="">
                        <h6 class="text-muted mt-3">{{translate('you_do_not_have_any')}}<br> {{ request('type') != 'all'
                            ? ucwords(translate(request('type'))) : '' }} {{translate('transaction_yet')}}</h6>
                    </div>
                    @endif
...
<div class="bottom-sticky4 bg-white d-md-none p-3">
    @if ($wallet_status == 1 && $loyalty_point_status == 1)
    <button type="button" class="btn rounded btn--primary w-100" data-toggle="modal" data-target="#convertToCurrency">
        <span>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title flex-grow-1 text-center" id="exampleModalLongTitle">{{translate('Convert point to
                    wallet money')}}</h5>
                ...
                <div class="modal-body py-sm-5">
                    <div class="px-sm-5">
                        ...
                        <div class="text-center mb-3 text-primary">
                            <span>
                                {{App\CPU\Helpers::get_business_settings('loyalty_point_exchange_rate')}}
                                {{translate('point')}} = {{\App\CPU\Helpers::currency_converter(1)}}
                            </span>
                        </div>
