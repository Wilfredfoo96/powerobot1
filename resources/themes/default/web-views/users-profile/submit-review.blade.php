...
<!-- Page Content-->
<div class="container pb-5 mb-2 mb-md-4 mt-2 rtl" style="text-align: {{Session::get('direction') === " rtl" ? 'right'
    : 'left' }};">
    <div class="row g-3">
        <!-- Sidebar-->
                    ...
                    <form action="{{route('review.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-1 text-info">{{translate('file_type')}}: jpg, jpeg, png. {{
                                    translate('maximum size')}}: 2MB</div>
                            </div>
