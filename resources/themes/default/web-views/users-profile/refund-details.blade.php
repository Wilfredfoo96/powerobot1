...
<div class="border rounded bg-white">
    ...
    <div class="d-flex justify-content-between gap-2 border-top py-2 px-3 fs-12">
        <div class="text-muted font-weight-bold text-capitalize">{{translate($refund->status == 'refunded' ?
            'total_refunded_amount' : 'total_refundable_amount')}}</div>
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a data-lightbox="mygallery" href="{{asset('storage/refund')}}/{{$photo}}">
                <img class="border rounded border-primary-light"
                    onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                    src="{{asset('storage/refund')}}/{{$photo}}" alt="VR Collection" width="60">
            </a>
            @endforeach
        </div>
