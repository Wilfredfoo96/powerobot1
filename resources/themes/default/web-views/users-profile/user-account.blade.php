                            ...
                            <div class="profile--info mb-4">
                                <div class="position-relative profile-img mb-3">
                                    <img id="blah"
                                        ...
                                        src="{{asset('storage/profile')}}/{{$customerDetail['image']}}" alt="">
                                ...
                                <h5 class="text-capitalize">{{$customerDetail->f_name. ' '.$customerDetail->l_name}}
                                </h5>
                            </div>
                            <div class="row g-3">
                                ...
                                <div class="form-group col-md-6 mb-0">
                                    <label for="phone" class="mb-2 text-capitalize">{{translate('phone_number')}}
                                        <small class="text-primary">(* {{translate('country_code_is_must_like_for_BD')}}
                                            880)</small>
                                    </label>
                                ...
                                <div class="form-group col-md-6 mb-0">
                                    ...
                                    <div class="password-toggle rtl">
                                        ...
                                        <label class="password-toggle-btn">
                                            ...
                                            <i class="tio-hidden password-toggle-indicator password"
                                ...
                                <div class="form-group col-md-6 mb-0">
                                    <label for="newPass" class="mb-2 text-capitalize">{{translate('confirm_password')}}
                                    </label>
                                    <div class="password-toggle rtl">
                                        ...
                                        <div>
                                            <label class="password-toggle-btn">
                                                <input class="custom-control-input" type="checkbox"
                                                    style="display: none">
                                                <i class="tio-hidden password-toggle-indicator "
