                        ...
                        <div class="bg-light rounded py-2 px-3 d-flex align-items-center">
                            <div class="fs-14">
                                {{translate('order_verification_code')}} : <strong
                                    class="text-base">{{$orderDetails['verification_code']}}</strong>
                            </div>
                        </div>
                        @endif
                    ...
                    <ul class="nav nav-tabs media-tabs nav-justified order-track-info">
                            ...
                            <div class="nav-link active-status">
                                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                                    <div class="media-tab-media mx-sm-auto mb-3">
                                        <img src="{{asset('/assets/front-end/img/track-order/order-placed.png')}}"
                                            alt="">
                                    </div>
                                    <div class="media-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-sm-center gap-1 mt-2">
                                            <img src="{{asset('/assets/front-end/img/track-order/clock.png')}}"
                                                width="14" alt="">
                            ...
                            <div
                                ...
                                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                                    <div class="media-tab-media mb-3 mx-sm-auto">
                                        <img src="{{asset('/assets/front-end/img/track-order/order-confirmed.png')}}"
                                            alt="">
                                    </div>
                                    <div class="media-body">
                                        <div class="text-sm-center">
                            ...
                            <div
                                ...
                                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                                    ...
                                    <div class="media-body">
                                        ...
                                        ($orderDetails['order_status']=='delivered') &&
                                        \App\CPU\order_status_history($orderDetails['id'],'out_for_delivery'))
                                        <div class="d-flex align-items-center justify-content-sm-center mt-2 gap-2">
                                            <img class="mx-1"
                                                src="{{asset('/assets/front-end/img/track-order/clock.png')}}"
                                                width="14" alt="">
                                            <span class="text-muted fs-12">
                                                {{date('h:i A, d M
                        ...
                        <li class="nav-item">
                            <div class="nav-link text-center">
                                <h1 class="text-warning text-capitalize">{{ translate('product_successfully_returned')}}
                                </h1>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <div class="nav-link text-center">
                                <h1 class="text-danger text-capitalize">{{ translate("your_order_has_been_canceled")}}
                                </h1>
                            </div>
                        </li>
                        @else
                        <li class="nav-item">
                            <div class="nav-link text-center">
                                <h1 class="text-danger text-capitalize">{{
                                    translate("sorry_we_can_not_complete_your_order")}}</h1>
                            </div>
                        </li>
                        @endif
                    </ul>
