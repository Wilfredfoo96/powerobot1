            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <div class="media flex-wrap gap-2 gap-sm-3 border rounded p-3">
                        <img class="rounded border seller-info-img"
                            ...
                            <div class="d-flex gap-2 gap-sm-3 align-items-sm-center justify-content-between">
                                        ...
                                        <span class="d-inline-block font-size-sm text-body">
                                            @for($inc=1;$inc<=5;$inc++) @if ($inc <=(int)$avg_rating) <i
                                                ...
                                                @elseif ($avg_rating != 0 && $inc <= (int)$avg_rating + 1.1 &&
                                                    ...
                                                    @endif
                                                    @endfor
                                                    <label class="badge-style">( {{number_format($avg_rating,1)}}
                                                        )</label>
                                        </span>
                                    </div>
                                ...
                                <div>
                                    <button type="button" class="btn btn-soft-info text-capitalize px-2 px-sm-4"
                                        ...
                                        ($order->seller->shop->temporary_close || ($order->seller->shop->vacation_status
                                        && date('Y-m-d') >= date('Y-m-d',
                                        strtotime($order->seller->shop->vacation_start_date)) && date('Y-m-d') <=
                                            date('Y-m-d', strtotime($order->seller->shop->vacation_end_date)))) ?
                                            'disabled' : '' }}>
                                            <img src="{{asset('/assets/front-end/img/seller-info-chat.png')}}" alt="">
                                            <span
                                                class="d-none d-sm-inline-block">{{translate('chat_with_seller')}}</span>
                                    </button>
                    ...
                    <div class="media flex-wrap gap-3 border rounded p-3">
                        <img class="rounded border" width="77" src="{{asset("
