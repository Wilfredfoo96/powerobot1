                ...
                <div class="card-header border-0 p-2 p-sm-3">
                    <div class="bg-section rounded d-flex gap-2 align-items-start justify-content-between p-3 ">
                        <div class="support_ticket_head-media media flex-wrap gap-2 gap-sm-3">
                            <div class="rounded-circle overflow-hidden">
                                <img onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                                    ...
                                    class="rounded other-store-logo" width="50" alt="img/products">
                            </div>
                            <div class="media-body">
                                <div class="d-flex flex-column">
                                    <div class="d-flex gap-2 align-items-center">
                                        <h6 class="text-capitalize m-0">{{ \App\CPU\customer_info()->f_name }} {{
                                            \App\CPU\customer_info()->l_name }}</h6>
                                    ...
                                    <div class="meta-info d-flex flex-wrap align-items-center column-gap-4 fs-14 mt-2">
                                        <div class="d-flex align-items-center gap-2 gap-md-3">
                                            ...
                                            <span
                                                class="{{$ticket->status ==  'open' ? ' text-info ' : 'text-danger'}} fw-semibold">{{
                                                ucwords($ticket->status) }}</span>
                                        </div>
                        ...
                        <a href="{{route('support-ticket.close',[$ticket['id']])}}"
                            class="btn btn-outline-danger d-none d-sm-inline-block">{{ translate('close_this_ticket')
                            }}</a>
                        <a href="{{route('support-ticket.close',[$ticket['id']])}}"
                            class="btn btn-outline-danger btn-sm d-sm-none">{{ translate('close') }}</a>
                        @endif
                    </div>
                </div>
                ...
                <div class="__media-wrapper p-2 p-sm-3 d-flex flex-column-reverse">
                    ...
                    <div class="media gap-3">
                        <div class="media-body d-flex">
                            ...
                            <img class="rounded-circle __img-40 mt-2"
                                style="text-align: {{Session::get('direction') === " rtl" ? 'left' : 'right' }};"
                                onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                src="{{asset('storage/admin/'.$admin['image'])}}" alt="" />
                            <div class="mx-1 __incoming-msg">

                                @if ($conversation['admin_message'])
                                <div class="d-flex justify-content-start">
                                    <p class="font-size-md mb-1 btn--primary message-text">
                                        {{$conversation['admin_message']}}</p>
                                </div>
                                @endif

                                @if ($conversation['attachment'] !=null &&
                                count(json_decode($conversation['attachment'])) > 0)
                                <div class="row g-2 flex-wrap mt-3 justify-content-start">
                                    ...
                                    <div class="col-sm-6 col-md-4 position-relative img_row{{$key}}">
                                        <a data-lightbox="mygallery" href="{{asset(" storage/support-ticket/".$photo)}}"
                                            ...
                                            <img onerror="this.src=' {{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                src="{{asset('storage/support-ticket')}}/{{$photo}}" class="img-fit"
                                                alt="img">
                                        </a>
                                    </div>
                                    @endforeach
                    ...
                    <div class="media  ">
                        <div class="media-body __outgoing-msg">
                            ...
                            @if ($conversation['attachment'] !=null && count(json_decode($conversation['attachment'])) >
                            0)
                        ...
                        <div class="d-flex flex-wrap align-items-baseline">
                            <div class="px-2 d-flex">
                                <label class="m-0 cursor-pointer position-relative">
                                    ...
                                    <input type="file" id="f_p_v_up1" class="h-100 position-absolute w-100" hidden
                                        multiple accept="image/*">
                                </label>
                            </div>
                            <div class="w-0 flex-grow-1">
                                <textarea class="form-control ticket-view-control px-0 py-3" name="comment" rows="8"
