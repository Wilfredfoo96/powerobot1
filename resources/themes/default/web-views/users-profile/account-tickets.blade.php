...
<div class="modal fade rtl" style="text-align: {{Session::get('direction') === " rtl" ? 'right' : 'left' }};"
    id="open-ticket" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg  " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="modal-title font-nameA ">{{translate('submit_new_ticket')}}</h5>
                    </div>
                    ...
                    <div class="d-flex flex-wrap upload_images_area">
                        ...
                        <label class="py-0 d-flex align-items-center m-0 cursor-pointer">
                            ...
                            <input type="file" id="attachmentfiles"
                                class="attachmentfiles h-100 position-absolute w-100 " hidden multiple accept="image/*">
                        </label>
            ...
            <div class="card __card h-100">
                <div class="p-md-3">
                    <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                        ...
                        <button type="submit" class="btn btn--primary float-{{Session::get('direction') === " rtl"
                            ? 'left' : 'right' }}" data-toggle="modal" data-target="#open-ticket">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span>{{Carbon\Carbon::createFromFormat('Y-m-d
                                            H:i:s',$ticket['created_at'])->format('Y-m-d h:i A')}}</span>
                                    </td>
                ...
                @if ($supportTickets->count() <=0) <div class="text-center pt-3 text-capitalize">
                    <img src="{{asset('assets/front-end/img/icons/nodata.svg')}}" alt="" width="70">
...
<div class="d-flex flex-column gap-3 d-md-none">
    ...
    <div class="bg-white border rounded p-3 shadow-sm"
        onclick="location.href='{{route('support-ticket.index',$ticket['id'])}}'">
        <div class="d-flex justify-content-between gap-2 align-items-end">
            <div class="d-flex flex-column gap-1 fs-12">
                ...
                <div class="d-flex gap-2">
                    ...
                    <div>{{Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$ticket['created_at'])->format('Y-m-d h:i A')}}
                    </div>
                </div>
                <div class="d-flex gap-2">
            ...
            <div>
                <a class="__action-btn btn-shadow rounded-full text-danger stopPropagation" href="javascript:" onclick="Swal.fire({
    ...
    @endforeach
    @if ($supportTickets->count() <=0) <div class="text-center pt-3 text-capitalize">
        <img src="{{asset('assets/front-end/img/icons/address.svg')}}" alt="" width="70">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5">
                <div class="text-center">
                    <img src="{{asset('/assets/front-end/img/icons/ticket-delete.png')}}" alt="">
