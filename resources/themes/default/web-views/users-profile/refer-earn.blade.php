                    ...
                    <div class="refer_and_earn_section">
                        ...
                        <div class="d-flex justify-content-center align-items-center py-2 mb-3">
                            <div class="banner-img">
                                <img class="img-fluid" src="{{ asset('assets/front-end/img/refer-and-earn.png') }}"
                                    alt="" width="300">
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                ...
                                <div class="refer_code_box">
                                    <div class="refer_code"
                                        onclick="click_to_copy('{{ $customer_detail->referral_code }}')">{{
                                        $customer_detail->referral_code }}</div>
                                    <span class="refer_code_copy"
                                        onclick="click_to_copy('{{ $customer_detail->referral_code }}')">
                                        <img class="w-100"
                                            src="{{ asset('assets/front-end/img/icons/solar_copy-bold-duotone.png') }}"
                                            alt="">
                                    </span>
                                </div>
                                ...
                                <div class="d-flex justify-content-center align-items-center share-on-social">
                                    ...
                                    @php
                                    $text = "Greetings,6Valley is the best e-commerce platform in the country.If you are
                                    new to this website dont forget to use " . $customer_detail->referral_code . " "
                                    ."as the referral code while sign up into 6valley.";
                                    $link = url('/');
                                    @endphp
                                    ...
                                    <a href="mailto:recipient@example.com?subject=Referral%20Code%20Text&body={{$text}}%20Link:%20{{$link}}"
                                        target="_blank">
                                        <img src="{{ asset('assets/front-end/img/icons/gmail.png') }}" alt=""
                                            onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'">
                                    </a>
                                    <a href="javascript:"
                                        onclick="click_to_copy('{{ route('home') }}?referral_code={{ $customer_detail->referral_code }}')">
                            ...
                            <div class="information-section col-md-10">
                                <h4 class="text-bold d-flex align-items-center"> <span class="custom-info-icon">i</span>
                                    {{ translate('how_you_it_works') }}?</h4>

                                <ul>
                                    <li>
                                        <span class="item-custom-index">{{ translate('1') }}</span>
                                        <span class="item-custom-text">{{ translate('invite_your_friends_&_businesses')
                                            }}</span>
                                    </li>
                                    <li>
                                        <span class="item-custom-index">{{ translate('2') }}</span>
                                        <span class="item-custom-text">{{ translate('they_register') }} {{
                                            $web_config['name']->value }} {{ translate('with_special_offer') }}</span>
                                    </li>
                                    <li>
