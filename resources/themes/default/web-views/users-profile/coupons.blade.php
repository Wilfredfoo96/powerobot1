                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6">
                            <div class="ticket-box">
                                <div class="ticket-start">
                                    ...
                                    @elseif ($item->coupon_type != "free_delivery" && $item->discount_type ==
                                    "percentage")
                                    ...
                                    <h2 class="ticket-amount">
                                        ...
                                        Off':\App\CPU\Helpers::currency_converter($item->discount)}}
                                        @endif
                                    </h2>
                                    <p>
                                        {{ translate('on') }}
                                        ...
                                        <a class="shop-name"
                                            ...
                                            {{ isset($item->seller->shop) ? $item->seller->shop->name :
                                ...
                                <div class="ticket-end">
                                    ...
                                    <button
                                        class="ticket-welcome-btn couponid-hide couponhideid-{{ $item->code }} d-none">{{
                                        translate('copied') }}</button>
                        ...
                        <div class="col-12">
                            <div class="text-center py-5 text-capitalize">
                                <img src="{{asset('assets/front-end/img/icons/coupon.svg')}}" alt="" class="mb-4"
                                    width="70">
