                        ...
                        <table class="table __table __table-2 text-center">
                            <thead class="thead-light">
                                <tr>
                                    <td class="tdBorder">
                                        <div><span
                                                class="d-block spandHeadO text-start text-capitalize">{{translate('order_list')}}</span>
                                        </div>
                                    </td>

                                    <td class="tdBorder">
                                        <div><span class="d-block spandHeadO"> {{translate('status')}}</span></div>
                                    </td>
                                    <td class="tdBorder">
                                        <div><span class="d-block spandHeadO"> {{translate('total')}}</span></div>
                                    </td>
                                    <td class="tdBorder">
                                        <div><span class="d-block spandHeadO"> {{translate('action')}}</span></div>
                                    </td>
                                </tr>
                            </thead>
                                ...
                                <tr>
                                        ...
                                        <div class="media-order">
                                            <a href="{{ route('account-order-details', ['id'=>$order->id])}}"
                                                ...
                                                <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                    src="{{ asset('storage/shop/'.(isset($order->seller->shop) ? $order->seller->shop->image:''))}}"
                                                    alt="img/products">
                                    ...
                                    <td class="bodytr">
                                        ...
                                        <span class="badge badge-danger text-capitalize">
                                            {{translate($order['order_status'] =='failed' ? 'failed_to_deliver' :
                                            $order['order_status'])}}
                                        </span>
            ...
            <div class="">
                <div class="media-order">
                    <a href="{{ route('account-order-details', ['id'=>$order->id]) }}"
                        ...
                        <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                            src="{{ asset('storage/shop/'.(isset($order->seller->shop) ? $order->seller->shop->image:''))}}"
                            class="border" alt="img/products">
                        @elseif($order->seller_is == 'admin')
                        <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                            class="border" src="{{asset(" storage/company")}}/{{$web_config['fav_icon']->value}}"
                        alt="img/products">
                        @endif
                    </a>
                    <div class="cont text-start">
                        ...
                        <div class="d-flex flex-column gap-1 fs-12">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <div class="text-dark font-weight-bold">
                                    {{\App\CPU\Helpers::currency_converter($order['order_amount'])}}</div>
                            </div>
                            <div>
                                @if($order['order_status']=='failed' || $order['order_status']=='canceled')
                                <span class="badge badge-danger text-capitalize">
