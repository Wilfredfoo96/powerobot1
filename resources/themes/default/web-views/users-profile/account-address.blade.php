                            ...
                            <div class="card __shadow h-100">
                                <div
                                    ...
                                    <div class="w-0 flex-grow-1">
                                        <h6 class="mb-0 fw-semibold"> {{translate($shippingAddress['address_type'])}}
                                            {{translate('address')}}
                                    ...
                                    <div class="d-flex justify-content-between gap-2 align-items-center">
                                        <a class="" title="Edit Address" id="edit"
                                            ...
                                            <img src="{{asset('/assets/front-end/img/address-edit-icon.png')}}"
                                                width="19" alt="">
                                        </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div><span class="font-nameA"> <span
                                                class="fw-semibold min-w-60px">{{translate('phone')}} </span> :&nbsp;
                                    ...
                                    <div><span class="font-nameA"> <span
                                                class="fw-semibold min-w-60px">{{translate('address')}} </span>
                                            :&nbsp;{{$shippingAddress['address']}}</span>
                                    </div>
                                    <div><span class="font-nameA"> <span
                                                class="fw-semibold min-w-60px">{{translate('country')}} </span>
