...
<!-- Page Content-->
<div class="container pb-5 mb-2 mb-md-4 mt-3 rtl __inline-47" style="text-align: {{Session::get('direction') === " rtl"
    ? 'right' : 'left' }};">
    <div class="row g-3">
        <!-- Sidebar-->
                ...
                <div class="p-lg-3 p-0">
                    <div class="d-flex justify-content-between gap-2 flex-wrap mb-3">
                        <div class="d-flex gap-3 flex-wrap">
                            ...
                            \App\CPU\Helpers::get_business_settings('order_verification'))
                        ...
                        <div class="d-flex align-items-start gap-2">
                            <button type="button" class="btn btn-square d-none d-md-block"
                                onclick="location.href='{{route('generate-invoice',[$order->id])}}'">
                                <img src="{{asset('assets/front-end/img/icons/downloads.png')}}">
                            </button>
                            @if($order->order_status=='delivered')
                            <button class="btn btn--primary btn-sm h-40px rounded text_capitalize d-none d-md-block"
                                            ...
                                            <td class="order_table_td">
                                                <div class="">
                                                    <div
                                                        ...
                                                        <button type="button" class="btn btn-square d-sm-none"
                                                            onclick="location.href='{{route('generate-invoice',[$order->id])}}'">
                                                            <img
                                                                src="{{asset('assets/front-end/img/icons/downloads.png')}}">
                                                        </button>
                                                    </div>
                                                    <div class="fs-12">
                                                        <span
                                                ...
                                                <div class="media gap-3 align-items-center">
                                                    <div class="position-relative">
                                                        ...
                                                        <span class="for-discoutn-value px-1">
                                                            ...
                                                            {{round($product['discount'],(!empty($decimal_point_settings)
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <div class="d-flex flex-wrap gap-2 mt-2">
                                                            ...
                                                            && $detail->product->digital_product_type ==
                                                            'ready_after_sell')
                                                            ...
                                                            <span class="" data-toggle="tooltip" data-placement="top"
                                                                ...
                                                                <a class="btn btn-sm rounded btn--primary disabled">{{translate('download')}}
                                                            ...
                                                            <button type="button" class="btn btn-sm rounded btn-warning"
                                                                ...
                                                                <i
                                                                    class="tio-star-half"></i>{{translate('Update_Review')}}
                                                                @else
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                onclick="refund_details('{{route('refund-details',['id'=>$detail->id])}}')">{{translate('refund_details')}}</button>
                                                            @endif
                    ...
                    <div class="pt-2 d-flex flex-column gap-2 d-lg-none">
                        ...
                        <div class="bg-white border rounded p-3">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <small class="d-flex align-items-center gap-2">
                                                ...
                                                <div class="font-weight-bold amount">
                                                    {{\App\CPU\Helpers::currency_converter($detail->price)}} </div>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-end flex-wrap gap-2 mt-2">
                                ...
                                @if($order->order_status=='delivered')
                                @if (isset($detail->product))
                                <button type="button" class="btn btn-sm rounded btn-warning" data-toggle="modal"
                                    data-target="#submitReviewModal{{$detail->id}}">
                                    @if (isset($detail->product->reviews_by_customer[0]))
                                ...
                                <div class="card-body ">
                                    <table class="calculation-table table table-borderless mb-0">
                                        <tbody class="totals">
                                            <tr>
                                                <td>
                                                    <div class="text-{{Session::get('direction') === " rtl" ? 'right'
                                                        : 'left' }}"><span
                                                            class="product-qty ">{{translate('item')}}</span></div>
                                                </td>
                                                <td>
                                                    <div class="text-{{Session::get('direction') === " rtl" ? 'left'
                                                        : 'right' }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-{{Session::get('direction') === " rtl" ? 'left'
                                                        : 'right' }}">
                                                        <span>{{\App\CPU\Helpers::currency_converter($summary['total_shipping_cost']
                                                            - ($order['is_shipping_free'] ? $order['extra_discount'] :
                                                            0))}}</span>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    <button class="btn btn-block bg-soft-danger text-danger mt-3"
                                        onclick="route_alert('{{ route('order-cancel',[$order->id]) }}','{{translate('want_to_cancel_this_order?')}}','order-cancel')">{{translate('cancel_order')}}</button>
                                    @endif
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="verifyViewModal" tabindex="-1" aria-labelledby="verifyViewModalLabel" style="display: none;"
    aria-hidden="true">
                ...
                <div class="shadow-sm rounded p-3">
                    ...
                    <div class="d-flex flex-column gap-2 fs-12">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span class="text-dark"> <a class="text-body text-capitalize" href="Javascript:">
                                    {{$order->customer->f_name ??
                                    transalte('name_not_found')}}&nbsp;{{$order->customer->l_name ?? ''}} </a> </span>
                        </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="d-flex flex-column gap-2 fs-12">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="text-dark"> <a class="text-body text-capitalize" href="#"> {{$value}} </a>
                                </span>
                            </div>
                            @endif
                            @endforeach
