                        ...
                        <div class="__cate-side-price pb-3">
                            <div class="input-group-overlay input-group-sm">
                                <input style="{{Session::get('direction') === " rtl" ? 'padding-right: 32px;' : '' }}"
                                    placeholder="{{ translate('search_by_brands') }}"
                            ...
                            <div class="menu--caret-accordion">
                                ...
                                <div class="card-body p-0 {{Session::get('direction') === " rtl" ? 'mr-2' : 'ml-2' }}"
                                    ...
                                    <div class="menu--caret-accordion">
                                        ...
                                        <div class="card-body p-0 {{Session::get('direction') === " rtl" ? 'mr-2'
                                            : 'ml-2' }}" id="collapse-{{$child['id']}}" style="display: none">
