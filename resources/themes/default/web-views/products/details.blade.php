                        ...
                        <div class="cz-product-gallery">
                            <div class="cz-preview">
                                ...
                                <div class="cz-preview-item d-flex align-items-center justify-content-center {{ $key == 0 ? 'active' : '' }}"
                                    ...
                                    <img class="cz-image-zoom img-responsive w-100 __max-h-323px"
                                        onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                                        src="{{ asset('storage/product/'. $photo) }}" data-zoom="{{ asset("
                                        storage/product/$photo") }}" alt="Product image" width="">
                                    <div class="cz-image-zoom-pane"></div>
                                </div>
                                @endforeach
                                @endif
                            ...
                            <div class="d-flex flex-column gap-3">
                                <button type="button" onclick="addWishlist('{{ $product['id'] }}')"
                                    ...
                                    <i class="fa {{ $wishlist_status == 1 ? 'fa-heart' : 'fa-heart-o' }} wishlist_icon_{{ $product['id'] }}"
                                        style="color: {{ $web_config['primary_color'] }}" aria-hidden="true"></i>
                                </button>
                        ...
                        <div class="details __h-100">
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-2 pro">
                                <div class="star-rating"
                                    style="{{ Session::get('direction') === ' rtl' ? 'margin-left: 10px;' : 'margin-right: 10px;' }}">
                                ...
                                <span class="d-inline-block  align-middle mt-1 {{ Session::get('direction') === ' rtl' ? 'ml-md-2 ml-sm-0' : 'mr-md-2 mr-sm-0' }} fs-14
                                ...
                                <span class="font-regular font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{ Session::get('direction') ===
                                    ...
                                    : 'ml-1 mr-md-2 mr-1 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1' }}"><span
                                        style="color: {{ $web_config['primary_color'] }}">{{ $overallRating[1] }}</span>
                                    {{ translate('reviews') }}</span>
                                <span class="__inline-25"></span>
                                <span class="font-regular font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{ Session::get('direction') ===
                                        " rtl" ? 'mr-1 ml-md-2 ml-1 pr-md-2 pr-sm-1 pl-md-2 pl-sm-1'
                                    : 'ml-1 mr-md-2 mr-1 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1' }}"><span
                                        style="color: {{ $web_config['primary_color'] }}">{{ $countOrder }}</span>
                                    {{ translate('orders') }} </span>
                                <span class="__inline-25"> </span>
                                <span class="font-regular font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{ Session::get('direction') ===
                                        " rtl" ? 'mr-1 ml-md-2 ml-0 pr-md-2 pr-sm-1 pl-md-2 pl-sm-1'
                                    : 'ml-1 mr-md-2 mr-0 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1' }} text-capitalize">
                            ...
                            <form id="add-to-cart-form" class="mb-2">
                                ...
                                <div
                                    ...
                                    <div class="flex-start align-items-center mb-2">
                                        ...
                                        <div>
                                            <ul class="list-inline checkbox-color mb-0 flex-start {{ Session::get('direction') ===
                                                    " rtl" ? 'mr-2' : 'ml-2' }}"
                                ...
                                <div class="row flex-start mx-0 align-items-center">
                                    <div class="product-description-label text-dark font-bold {{ Session::get('direction') ===
                                                " rtl" ? 'pl-2' : 'pr-2' }} text-capitalize mb-2">
                                        {{ $choice->title }}
                                        :
                                    </div>
                                    <div>
                                ...
                                <div class="mt-3">
                                    <div class="product-quantity d-flex flex-column __gap-15">
                                        ...
                                        <div id="chosen_price_div">
                                            <div class="d-none d-sm-flex justify-content-start align-items-center {{ Session::get('direction') ===
                                                    " rtl" ? 'ml-2' : 'mr-2' }}">
                                                <div
                                                ...
                                                <small
                                                    class="{{ Session::get('direction') === ' rtl' ? 'mr-2' : 'ml-2' }} font-regular">
                                ...
                                <div class="__btn-grp mt-2 mb-3 d-none d-sm-flex">
                                    ...
                                    $current_date <= $seller_vacation_end_date))) || ($product->added_by == 'admin' &&
                                        ($inhouse_temporary_close ||
                                        ($inhouse_vacation_status &&
                                        $current_date >= $inhouse_vacation_start_date &&
                                        $current_date <= $inhouse_vacation_end_date)))) <button
                                            ...
                                            @else
                                            <button class="btn btn-secondary element-center __iniline-26 btn-gap-{{ Session::get('direction') ===
                                                " rtl" ? 'left' : 'right' }}" onclick="buy_now()" type="button">
                                                <span class="string-limit">{{ translate('buy_now') }}</span>
                                            </button>
                                            <button class="btn btn--primary element-center btn-gap-{{ Session::get('direction') ===
                                                " rtl" ? 'left' : 'right' }}" onclick="addToCart()" type="button">
                                            ...
                                            <button type="button" onclick="addWishlist('{{ $product['id'] }}')"
                                                ...
                                                <i class="fa {{ $wishlist_status == 1 ? 'fa-heart' : 'fa-heart-o' }} wishlist_icon_{{ $product['id'] }}"
                                                    ...
                                                    aria-hidden="true"></i>
                                                <span
                                                    class="fs-14 text-muted align-bottom countWishlist-{{ $product['id'] }}">{{
                                                    $countWishlist }}</span>
                                            </button>
                                            @if (
                                            ($product->added_by == 'seller' &&
                                            ...
                                            $product->seller->shop->vacation_status &&
                                            $current_date >= $seller_vacation_start_date &&
                                            $current_date <= $seller_vacation_end_date))) || ($product->added_by ==
                                                'admin' &&
                                                ($inhouse_temporary_close ||
                                                ($inhouse_vacation_status &&
                                                $current_date >= $inhouse_vacation_start_date &&
                                                $current_date <= $inhouse_vacation_end_date)))) <div
                                    ...
                                    <div class="tab-content px-lg-3">
                                        ...
                                        <div class="tab-pane fade show active text-justify" id="overview"
                                            ...
                                            <div class="row pt-2 specification">
                                                ...
                                                @if ($product->video_url != null && str_contains($product->video_url,
                                                'youtube.com/embed/'))
                                            ...
                                            @if (!$product['details'] && ($product->video_url == null ||
                                            !str_contains($product->video_url, 'youtube.com/embed/')))
                                            <div>
                                                <div class="text-center text-capitalize">
                                                    <img class="mw-90"
                                                        src="{{ asset('/assets/front-end/img/icons/nodata.svg') }}"
                                                        alt="">
                                        ...
                                        <div class="tab-pane fade" id="reviews" role="tabpanel">
                                            ...
                                            <div class="row pt-2 pb-3">
                                                <div class="col-lg-4 col-md-5 ">
                                                    <div class=" row d-flex justify-content-center align-items-center">
                                                        ...
                                                        <div
                                                            ...
                                                            @for ($inc = 1; $inc <= 5; $inc++) @if ($inc <=(int)
                                                                $overallRating[0]) <i class="tio-star text-warning"></i>
                                                                @elseif ($overallRating[0] != 0 && $inc <= (int)
                                                ...
                                                <div class="col-lg-8 col-md-7 pt-sm-3 pt-md-0">
                                                    ...
                                                    <div class=" d-flex align-items-center mb-2 text-body
                                                                font-size-sm">
                                                        <div class="__rev-txt"><span
                                            ...
                                            <div class="row pb-4 mb-3">
                                                <div class="__inline-30">
                                                    <span class="text-capitalize">{{ translate('Product_review')
                                                        }}</span>
                                                </div>
                                            </div>
                                            @endif
                                            ...
                                            <div class="row pb-4">
                                                ...
                                                <div class="col-12">
                                                    <div
                                                        ...
                                                        <button class="btn text-white view_more_button"
                                                            style="background: {{ $web_config['primary_color'] }};"
                                                            onclick="load_review()">{{ translate('view_more')
                                                            }}</button>
                                                    </div>
                                                </div>
                                                @endif
                    ...
                    <div class="col-12 position-relative">
                        <a href="{{route('shopView',['id'=>$product->seller->id])}}" class="d-block">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                ($product->seller->shop->vacation_status && $current_date >= $seller_vacation_start_date
                                && $current_date <= $seller_vacation_end_date))) <span class="chat-seller-info"
                                    ...
                                    <img src="{{asset('/assets/front-end/img/info.png')}}" alt="i">
                                    </span>
                                    @endif
                            </div>
                        </a>
                        ...
                        <div class="row d-flex justify-content-between">
                            <div class="col-6 ">
                                <div
                                    ...
                                    <div class="text-center">
                                        <img src="{{asset('/assets/front-end/img/rating.svg')}}" class="mb-2" alt="">
                            ...
                            <div class="col-6">
                                <div class="d-flex justify-content-center align-items-center rounded __h-79px">
                                    <div class="text-center">
                                        <img src="{{asset('/assets/front-end/img/products.svg')}}" class="mb-2" alt="">
                                        <div class="__text-12px text-base">
                                            <strong>{{$products_for_review->count()}}</strong>
                                            {{translate('products')}}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 position-static mt-3">
                        <div class="chat_with_seller-btns">
                            ...
                            <button class="btn w-100 d-block text-center"
                                style="background: {{$web_config['primary_color']}};color:#ffffff" data-toggle="modal"
                                data-target="#chatting_modal" {{ ($product->seller->shop->temporary_close ||
                                ($product->seller->shop->vacation_status
                                && date('Y-m-d') >= date('Y-m-d',
                                strtotime($product->seller->shop->vacation_start_date)) && date('Y-m-d') <=
                                    date('Y-m-d', strtotime($product->seller->shop->vacation_end_date)))) ?
                                    'disabled' : '' }}>
                                    <img src="{{asset('/assets/front-end/img/chat-16-filled-icon.png')}}" class="mb-1"
                                        alt="">
                                    <span class="d-none d-sm-inline-block">{{translate('chat_with_seller')}}</span>
                            </button>
                            @else
                            <a href="{{route('customer.auth.login')}}" class="btn w-100 d-block text-center"
                ...
                <div class="row d-flex justify-content-between">
                    <div class="col-9 ">
                        <a href="{{route('shopView',[0])}}" class="row d-flex ">
                            <div>
                                <img class="__inline-32" src="{{asset("
                                    storage/company")}}/{{$web_config['fav_icon']->value}}"
                                onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                alt="">
                            </div>
                            <div class="{{Session::get('direction') === " rtl" ? 'right' : 'mt-3 ml-2' }}"
                                onclick="location.href='{{route('shopView',[0])}}'">
                                <span class="font-bold __text-16px">
                                    {{$web_config['name']->value}}
                                </span><br>
                            </div>

                            @if ($product->added_by == 'admin' && ($inhouse_temporary_close || ($inhouse_vacation_status
                            && $current_date >= $inhouse_vacation_start_date && $current_date <=
                                $inhouse_vacation_end_date))) <div class="{{Session::get('direction') === " rtl"
                                ? 'right' : 'ml-3' }}">
...
<div class="bottom-sticky bg-white d-sm-none">
    <div class="d-flex flex-column gap-1 py-2">
        <div class="d-flex justify-content-center align-items-center fs-13">
            <div class="product-description-label text-dark font-bold"><strong class="text-capitalize">{{
                    translate('total_price') }}</strong> : </div>
            ...
            <div class="row flex-between">
                ...
                <div class="view_all d-flex justify-content-center align-items-center">
                    <div>
                        ...
                        @if ($category)
                        <a class="text-capitalize view-all-text" style="color:{{ $web_config['primary_color'] }} !important;{{ Session::get('direction') ===
                                        " rtl" ? 'margin-left:10px;' : 'margin-right: 8px;' }}"
        ...
        <div class="modal-content">
            <div class="modal-body flex justify-content-center">
                <button class="btn btn-default __inline-33"
                    style="{{ Session::get('direction') === ' rtl' ? 'left' : 'right' }}: -7px;" data-dismiss="modal">
