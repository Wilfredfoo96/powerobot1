...
@section('content')
    ...
    <div class="container py-4 rtl __inline-56 px-0 px-md-3"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label>{{ translate('address') }}<span
                                                                        class="text-danger">*</span></label>
                                                                <textarea class="form-control" id="address" type="text" name="address" id="address"
                                        ...
                                        <div id="accordion">
                                            <div class="">
                                                <div class="">
                                                    ...
                                                    <input type="hidden" name="billing_method_id" id="billing_method_id"
                                                        value="0">
                                                    @if (auth('customer')->check())
                                                        <div class=" d-flex gap-3 align-items-center">
