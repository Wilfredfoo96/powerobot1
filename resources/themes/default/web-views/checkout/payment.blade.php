...
@section('content')
<!-- Page Content-->
<div class="container pb-5 mb-2 mb-md-4 rtl px-0 px-md-3" style="text-align: {{Session::get('direction') === " rtl"
    ? 'right' : 'left' }};">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                                    ...
                                    <form action="{{route('checkout-complete')}}" method="get" class="needs-validation"
                                        ...
                                        <label class="m-0">
                                            ...
                                            <span
                                                ...
                                                <img width="20"
                                                    src="{{asset('assets/front-end/img/icons/money.png')}}" />
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center mb-4 ">
                            ...
                            <span
                                class="fs-10 text-capitalize mt-1">({{translate('faster_&_secure_way_to_pay_bill')}})</span>
                        </div>
                                ...
                                <form method="post" class="digital_payment d--none"
                                    ...
                                    <label class="d-flex align-items-center gap-2 mb-0 form-check py-2 cursor-pointer">
                                        ...
                                        <img width="30" onerror="this.src='{{asset('assets/front-end/img/img1.jpg')}}'"
                                            src="{{asset('storage/payment_modules/gateway_image')}}/{{(json_decode($payment_gateway->additional_data)->gateway_image) != null ? (json_decode($payment_gateway->additional_data)->gateway_image) : ''}}"
                                            alt="">
                                        <span
                                            class="text-capitalize form-check-label">{{(json_decode($payment_gateway->additional_data)->gateway_title)}}</span>
                                    </label>
                                </form>
                            </div>
                            @endforeach
        ...
        <div class="modal-content">
            ...
            <form action="{{route('checkout-complete-wallet')}}" method="get" class="needs-validation">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn--primary" {{$remain_balance>0? '':'disabled'}}>{{
