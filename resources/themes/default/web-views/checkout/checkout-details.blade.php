...
<div class="container pb-5 mb-2 mb-md-4 rtl __inline-54" style="text-align: {{Session::get('direction') === " rtl"
    ? 'right' : 'left' }};">
    <div class="row">
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="si-email">{{ translate('email_address')}}</label>
                                                <input class="form-control" type="email" name="email" id="si-email"
                                                    value="{{old('email')}}" placeholder="johndoe@example.com" required>
                                            ...
                                            <div class="form-group d-flex flex-wrap justify-content-between">
                                                <div class="mb-2">
                                                    <input type="checkbox" name="remember" {{ old('remember')
                                                        ? 'checked' : '' }} id="remember_me">
                                                    <label for="remember_me" class="cursor-pointer">
                                                        {{ translate('remember_me')}}
                                                    </label>

                                                    <a class="font-size-sm {{Session::get('direction') === " rtl"
                                                        ? 'mr-5' : 'ml-5' }}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="f_name" placeholder="John"
                                                    required>
                                                <div class="invalid-feedback">{{
                                                    translate('please_fill_in_your_first_name.')}}</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="l_name" placeholder="Doe"
                                                    required>
                                                <div class="invalid-feedback">{{
                                                    translate('please_fill_in_your_last_name.')}}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="su-email">{{ translate('email_address')}}</label>
                                                <input class="form-control" name="email" type="email" id="su-email"
                                                    placeholder="johndoe@example.com" required>
                                                <div class="invalid-feedback">{{
                                                    translate('please_provide_a_valid_email_address.')}}</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="su-email">{{ translate('phone')}}</label>
                                                <input class="form-control" name="phone" type="number" id="su-phone"
