        ...
        <table class="bs-0 mb-30 px-10">
            <tr>
                <th class="content-position-y text-left">
                    ...
                    <h4 class="text-uppercase mb-1 fz-14">
                        {{ ucwords('shop Name')}}
                        : {{ $order->seller_is == 'admin' ? $company_name : (isset($order->seller->shop) ?
                        $order->seller->shop->name : ucwords('not found')) }}
                    </h4>
                    @if($order['seller_is']!='admin' && isset($order['seller']->gst) != null)
                    <h4 class="text-capitalize fz-12">{{ ucwords('GST')}}
                        : {{ $order['seller']->gst }}</h4>
                    @endif
                </th>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="h4 montserrat-normal-600">
                                        ...
                                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$order->customer !=null?
                                            $order->customer['email']: ucwords('email not found')}}</p>
                                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$order->customer !=null?
                                            $order->customer['phone']: ucwords('phone not found')}}</p>
                                        @endif
                                    </div>
                                    @endif
                                    </p>
                        ...
                        <table>
                            <tr>
                                <td class="text-right">
                                    ...
                                    <div class="h4 montserrat-normal-600">
                                        <p class="font-weight-normal" style=" margin-top: 6px; margin-bottom:0px;">
                                            {{$order->billingAddress ? $order->billingAddress['contact_person_name'] :
                                            ""}}</p>
                                        <p class="font-weight-normal" style=" margin-top: 6px; margin-bottom:0px;">
                                            {{$order->billingAddress ? $order->billingAddress['phone'] : ""}}</p>
                                        <p class="font-weight-normal" style=" margin-top: 6px; margin-bottom:0px;">
                                            {{$order->billingAddress ? $order->billingAddress['address'] : ""}}</p>
                                        <p class="font-weight-normal" style=" margin-top: 6px; margin-bottom:0px;">
            ...
            <table>
                <tr>
                    <th class="content-position-y bg-light py-4">
                        ...
                        <div>
                            {{ ucwords('all copy right reserved © '.date('Y').' ').$company_name}}
                        </div>
                    </th>
                </tr>
            </table>
