                    ...
                    <div class="table-responsive">
                        <table class="table __table text-capitalize text-start table-align-middle min-w400">
                            ...
                            <tbody>
                                ...
                                @php($productDetails = App\Model\Product::where('id',
                                $order_details->product_id)->first())
                                <tr>
                                    <td>
                                        <div class="media align-items-center gap-3">
                                            ...
                                            <div>
                                                <h6 class="title-color mb-2">{{Str::limit($productDetails['name'],30)}}
                                                </h6>
                                                <div class="d-flex flex-column">
                                                    <small>
                                                        ...
                                                        ({{translate('tax_incl.')}})
                                                        @else
                                                        ({{translate('tax').":".($productDetails->tax)}}{{$productDetails->tax_type
                                                        ==="percent" ? '%' :''}})
                                                        @endif
                                                    </small>
                                                    @if ($order_details->variant)
                                                    <small><strong>{{translate('variation')}} :</strong>
                                                ...
                                                <a onclick="digital_product_download('{{ route('digital-product-download', $order_details->id) }}')"
                                                    href="javascript:" class="btn btn-success btn-sm"
                                                    data-toggle="tooltip" data-placement="bottom"
                                                    title="{{translate('download')}}">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                                @elseif($order_details->product && $orderDetails->payment_status ==
                                                'paid' && $order_details->product->digital_product_type ==
                                                'ready_after_sell')
                        ...
                        <table class="table __table text-end table-align-middle text-capitalize">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @if ($orderDetails['order_type'] == 'default_type')
                                    <td class="text-dark">
                                        {{\App\CPU\Helpers::currency_converter($orderDetails['is_shipping_free'] ?
                                        $total_shipping_cost-$orderDetails['extra_discount']:$total_shipping_cost)}}
                                    </td>
                                    ...
                                    <td class="text-dark">
                                        ...
                                        - $coupon_discount - $extra_discount)}}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <div class="card border-0 box-shadow-lg">
        <div class="card-body py-5">
            ...
            <ul class="nav nav-tabs media-tabs nav-justified order-track-info">
                        ...
                        <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                            ...
                            <div class="media-body">
                                ...
                                <div class="d-flex align-items-center justify-content-sm-center gap-1 mt-2">
                                    <img src="{{asset('/assets/front-end/img/track-order/clock.png')}}" width="14"
                                        alt="">
                                    <span class="text-muted fs-12">{{date('h:i A, d M
                                        Y',strtotime($orderDetails->created_at))}}</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                            ...
                            <div class="media-body">
                                ...
                                @if(($orderDetails['order_status']=='confirmed') ||
                                ...
                                <div class="d-flex align-items-center justify-content-sm-center mt-2 gap-1">
                                    ...
                                    <span class="text-muted fs-12">
                                        {{date('h:i A, d M
                                        Y',strtotime(\App\CPU\order_status_history($orderDetails['id'],'confirmed')))}}
                                    </span>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                            ...
                            <div class="media-body">
                                ...
                                <div class="d-flex align-items-center justify-content-sm-center mt-2 gap-2">
                                    ...
                                    <span class="text-muted fs-12">
                                        {{date('h:i A, d M
                                        Y',strtotime(\App\CPU\order_status_history($orderDetails['id'],'processing')))}}
                                    </span>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                            ...
                            <div class="media-body">
                                ...
                                <div class="d-flex align-items-center justify-content-sm-center mt-1">
                                    <img class="mx-sm-1" src="{{asset('/assets/front-end/img/track-order/clock.png')}}"
                                        width="20" alt="">
                                    <span class="text-muted fs-14">
                                        @if(\App\CPU\order_status_history($orderDetails['id'],'out_for_delivery'))
                                        {{date('h:i A, d M
                                        Y',strtotime(\App\CPU\order_status_history($orderDetails['id'],'out_for_delivery')))}}
                                        @endif
                                    </span>
                                </div>
                                @endif
                                ...
                                <div class="mt-1">
                                    <span class="d-flex align-items-center justify-content-sm-center text-nowrap">
                                        <span
                                            class="text-muted fs-14 text-capitalize">{{translate('delivery_service_name')}}
                                            : </span> <span
                                            class="fs-14 fw-semibold text-dark">{{$orderDetails->delivery_service_name}}</span>
                                    </span>
                                    <span class="d-flex align-items-center justify-content-sm-center text-nowrap">
                                        <span class="text-muted fs-14 text-capitalize"> {{translate('tracking_ID')}} :
                                        </span><span
                                            class="fs-14 fw-semibold text-dark">{{$orderDetails->third_party_delivery_tracking_id}}</span>
                                    </span>
                                </div>
                                @endif
                                @if ($orderDetails->delivery_type == 'self_delivery' &&
                                isset($orderDetails->delivery_man))
                                <div class="mt-1">
                                    <span class="d-flex align-items-center justify-content-sm-center text-nowrap">
                                        <span
                                            class="text-muted fs-14 text-capitalize">{{translate('delivery_man_name')}}
                                            : </span> <span
                                            class="fs-14 fw-semibold text-dark">{{$orderDetails->delivery_man->f_name.'
                                            '.$orderDetails->delivery_man->l_name}}</span>
                                    </span>
                                    <span class="d-flex align-items-center justify-content-sm-center text-nowrap">
                                        <span class="text-muted fs-14 text-capitalize"> {{translate('contact_number')}}
                                            : </span><span
                ...
                <li class="nav-item">
                    <div class="nav-link {{($orderDetails['order_status']=='delivered')?'active-status' : ''}}">
                        <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                            ...
                            <div class="media-body">
                                <div class="text-sm-center">
                                    <h6 class="media-tab-title text-nowrap mb-0 fs-14">{{ translate('order_Shipped')}}
                                    </h6>
                                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-sm-center mt-2 gap-2">
                                    ...
                                    <span class="text-muted fs-12">
                                        {{date('h:i A, d M
                                        Y',strtotime(\App\CPU\order_status_history($orderDetails['id'],'delivered')))}}
                                    </span>
                                </div>
                                @endif
                            </div>
                ...
                <li class="nav-item">
                    <div class="nav-link text-center">
                        <h1 class="text-danger text-capitalize">{{ translate("sorry_we_can_not_complete_your_order")}}
                        </h1>
                    </div>
                </li>
                @endif
            ...
            <div class="text-center pt-4">
                <a class="btn btn--primary btn-sm text-capitalize" href="#order-details" data-toggle="modal">{{
                    translate('view_order_details')}}</a>
            </div>
        </div>
    </div>
</div>
