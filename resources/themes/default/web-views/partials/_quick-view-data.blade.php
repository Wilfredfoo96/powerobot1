                ...
                <div class="cz-preview">
                    ...
                    <div
                        ...
                        <img class="show-imag img-responsive" style="max-height: 500px!important;"
                            ...
                            storage/product/$photo->image_name")}}" alt="Product image" width="">
                    </div>
                    @else
                    <div
                        class="cz-preview-item d-flex align-items-center justify-content-center  {{$key==0?'active':''}}">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="cz-thumblist">
                            <a href="javascript:"
                                ...
                                <img class="click-img" id="preview-img{{$photo->color}}" src="{{asset("
                        ...
                        <div class="cz-thumblist">
                            <a href="javascript:"
                                class=" cz-thumblist-item d-flex align-items-center justify-content-center">
                                <img class="click-img" id="preview-img{{$key}}" src="{{asset("
                                    storage/product/$photo->image_name")}}"
                                onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                alt="Product thumb">
                            </a>
        ...
        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3" style="direction: {{ Session::get('direction') }}">
            <div class="details __h-100">
                ...
                <div class="d-flex flex-wrap align-items-center mb-2 pro">
                    <div class="star-rating" style="{{Session::get('direction') === " rtl" ? 'margin-left: 10px;'
                        : 'margin-right: 10px;' }}">
                    ...
                    <span class="d-inline-block  align-middle mt-1 {{Session::get('direction') === " rtl"
                        ? 'ml-md-2 ml-sm-0' : 'mr-md-2 mr-sm-0' }} fs-14 text-muted">({{$overallRating[0]}})</span>
                    <span
                        class="font-regular font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "
                    ...
                    <span
                        ...
                        : 'ml-1 mr-md-2 mr-0 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1' }} text-capitalize"> <span
                            style="color: {{$web_config['primary_color']}}"> {{$countWishlist}}</span>
                ...
                <form id="add-to-cart-form" class="mb-2">
                        ...
                        <div class="flex-start">
                            ...
                            <div class="__pl-15 mt-1">
                                <ul class="flex-start checkbox-color mb-0 p-0" style="list-style: none;">
                                    ...
                                    <li>
                                        <input type="radio"
                                            id="{{ $product->id }}-color-{{ str_replace('#','',$color) }}" name="color"
                            ...
                            <ul class="checkbox-alphanumeric checkbox-alphanumeric--style-1 mt-1">
                                ...
                                <span>
                                    <input type="radio" id="{{ $choice->name }}-{{ $option }}"
                                        name="{{ $choice->name }}" value="{{ $option }}" @if($index==0) checked @endif>
                    ...
                    <div class="mt-3">
                        <div class="product-quantity d-flex flex-column __gap-15">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="d-flex justify-content-center align-items-center quantity-box border rounded border-base"
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-number __p-10" type="button" data-type="minus"
                            ...
                            <div id="chosen_price_div">
                                <div class="d-flex justify-content-start align-items-center {{Session::get('direction') === "
                                    rtl" ? 'ml-2' : 'mr-2' }}">
                                    ...
                                    <small class="{{Session::get('direction') === " rtl" ? 'mr-2' : 'ml-2' }}
                                        font-regular">
                    ...
                    <div class="row no-gutters d-none mt-2 flex-start d-flex">
                        <div class="col-12">
                            @if(($product['product_type'] == 'physical') && ($product['current_stock']<=0)) <h5
                                class="mt-3 text-danger">{{translate('out_of_stock')}}</h5>
                                @endif
                        </div>
                    </div>
                    ...
                    <div class="__btn-grp align-items-center mt-2">
                        ...
                        <= $seller_vacation_end_date))) || ($product->added_by == 'admin' && ($inhouse_temporary_close
                            ...
                            <= $inhouse_vacation_end_date)))) <button class="btn btn-secondary" type="button" disabled>
                                {{translate('buy_now')}}
                                </button>
                                ...
                                $current_date >=
                                $seller_vacation_start_date && $current_date <= $seller_vacation_end_date))) ||
                                    ($product->
                                    added_by == 'admin' && ($inhouse_temporary_close || ($inhouse_vacation_status &&
                                    $current_date >= $inhouse_vacation_start_date && $current_date <=
                                        $inhouse_vacation_end_date)))) <div class="alert alert-danger" role="alert">
