        ...
        <div class="col-xl-3 col-md-4">
            <div class="deal_of_the_day h-100 bg--light">
                ...
                <div class="d-flex justify-content-center align-items-center py-4">
                    <h4 class="font-bold m-0 align-items-center text-uppercase text-center px-2"
                        style="color: {{$web_config['primary_color']}}"> {{ translate('deal_of_the_day') }}</h4>
                </div>
                <div class="recomanded-product-card mt-0">
                    <div class="d-flex justify-content-center align-items-center __pt-20 __m-20-r">
                        <div class="position-relative">
                            ...
                            <span class="for-discoutn-value p-1 pl-2 pr-2">
                                ...
                                {{round($deal_of_the_day->discount,(!empty($decimal_point_settings) ?
                    ...
                    <div class="__i-1 bg-transparent text-center mb-0">
                        <div class="__p-20px px-0">
                            @php($overallRating =
                            \App\CPU\ProductManager::get_overall_rating($deal_of_the_day->product['reviews']))
                            @if($overallRating[0] != 0 )
                            <div class="rating-show">
                                <span class="d-inline-block font-size-sm text-body">
                                    @for($inc=1;$inc<=5;$inc++) @if ($inc <=(int)$overallRating[0]) <i
                                        class="tio-star text-warning"></i>
                                        @elseif ($overallRating[0] != 0 && $inc <= (int)$overallRating[0] + 1.1) <i
                                            class="tio-star-half text-warning"></i>
                                            @else
                                            <i class="tio-star-outlined text-warning"></i>
                                            @endif
                                            @endfor
                                            <label class="badge-style">( {{$deal_of_the_day->product->reviews_count}}
                                                )</label>
                                </span>
                            </div>
                            @endif
                            ...
                            <button class="btn btn--primary font-bold px-4 rounded-10 text-uppercase"
                                onclick="location.href='{{route('product',$deal_of_the_day->product->slug)}}'">{{translate('buy_now')}}
                            </button>
                ...
                <div class="d-flex justify-content-center align-items-center py-4">
                    <h4 class="font-bold m-0 align-items-center text-uppercase text-center px-2"
                        style="color: {{$web_config['primary_color']}}"> {{ translate('recommended_product') }}</h4>
                </div>
                <div class="recomanded-product-card mt-0">
                    ...
                    <div class="d-flex justify-content-center align-items-center __pt-20 __m-20-r">
                        <div class="position-relative">
                            ...
                            <span class="for-discoutn-value p-1 pl-2 pr-2">
                                ...
                                {{round($product->discount,(!empty($decimal_point_settings) ? $decimal_point_settings:
                                0))}}%
                    ...
                    <div class="__i-1 bg-transparent text-center mb-0">
                        <div class="__p-20px px-0 pb-0">
                            ...
                            <div class="rating-show">
                                <span class="d-inline-block font-size-sm text-body">
                                    @for($inc=0;$inc<5;$inc++) @if ($inc <=(int)$overallRating[0]) <i
                                        class="tio-star text-warning"></i>
                            ...
                            <button class="btn btn--primary font-bold px-4 rounded-10 text-uppercase"
                                onclick="location.href='{{route('product',$product->slug)}}'">{{translate('buy_now')}}
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between mb-14px">
                    <div class="text-center">
                        <span class="for-feature-title __text-22px font-bold text-center">{{
                            translate('latest_products')}}</span>
                    </div>
                    <div class="mr-1">
                        <a class="text-capitalize view-all-text"
                            ...
                            {{ translate('view_all')}}
                            <i class="czi-arrow-{{Session::get('direction') === " rtl"
                                ? 'left mr-1 ml-n1 mt-1 float-left' : 'right ml-1 mr-n1' }}"></i>
                        </a>
                    </div>
                </div>
