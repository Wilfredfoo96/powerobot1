                ...
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="seller-list-view-all">
                        <a class="text-capitalize view-all-text"
                            style="color: {{$web_config['primary_color']}}!important" href="{{route('sellers')}}">{{
                            translate('view_all')}}
                            ...
                            <div class="info-area">
                                <div class="info-item">
                                    <h6 style="color:{{$web_config['primary_color']}}">{{$seller->review_count < 1000 ?
                                            $seller->review_count : number_format($seller->review_count/1000 , 1).'K'}}
                                    </h6>
                                    <span>{{ translate('reviews') }}</span>
                                </div>
                                <div class="info-item">
                                    <h6 style="color:{{$web_config['primary_color']}}">{{$seller->product_count < 1000 ?
                                            $seller->product_count : number_format($seller->product_count/1000 ,
                                            1).'K'}}</h6>
