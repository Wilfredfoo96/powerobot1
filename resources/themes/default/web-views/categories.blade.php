    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4">
            ...
            <div class="card-header mb-2 p-2 side-category-bar"
                ...
                <img src="{{asset('storage/category/'. $category->icon)}}"
                    onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" class="__img-18 mr-1">
        ...
        <div class="col-lg-9 col-md-8">
            ...
            <div class="row" id="ajax-categories">
                <label class="col-md-12 text-center mt-5">{{ translate('select_your_desire_category.')}}</label>
            </div>
            <!-- Pagination-->
        </div>
    </div>
