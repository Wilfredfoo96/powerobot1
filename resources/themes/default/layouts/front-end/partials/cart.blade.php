        ...
        <div class="widget widget-cart px-3 pt-2 pb-3">
            ...
            <div
                ...
                <small>{{translate('you_have_saved')}} <span
                        class="total_discount">{{\App\CPU\Helpers::currency_converter($total_discount)}}</span>!</small>
            </div>
            <div class="__h-20rem" data-simplebar data-simplebar-auto-hide="false">
                ...
                <div class="widget-cart-item">
                    <div class="media">
                        <a class="d-block {{Session::get('direction') === " rtl" ? 'ml-2' : 'mr-2' }} position-relative
                            overflow-hidden" href="{{route('product',$cartItem['slug'])}}">
                        ...
                        <div
                            ...
                            <div class="w-0 flex-grow-1">
                                ...
                                <div class="widget-product-meta">
                                    <span class="text-muted {{Session::get('direction') === " rtl" ? 'ml-2' : 'mr-2'
                                        }}">x <span
                                            class="cart_quantity_multiply{{$cartItem['id']}}">{{$cartItem['quantity']}}</span></span>
                                    <span class="text-accent {{Session::get('direction') === " rtl" ? 'ml-2' : 'mr-2' }}
                                        discount_price_of_{{$cartItem['id']}}">
                            ...
                            <div class="__quantity">
                                ...
                                <input type="text"
                                    class="quantity__qty cart-qty-input form-control p-0 text-center cartQuantity{{$cartItem['id']}}"
                                ...
                                <div class="quantity__plus cart-qty-btn"
                            ...
                            <div class="__quantity mr-29 mb-4">
                                <div class="quantity__minus cart-qty-btn form-control "
                                    onclick="updateCartQuantity('{{ $cartItem['id'] }}','{{ $cartItem['product_id'] }}', '-1', 'minus')">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center pb-2">
                <div class="font-size-sm {{Session::get('direction') === " rtl" ? 'ml-2 float-left' : 'mr-2 float-right'
                        ...
                        <span
                            class=" text-accent font-size-base cart_total_amount {{Session::get('direction')==="rtl"
                    ? 'mr-1' : 'ml-1' }}">
                ...
                <a class="btn btn-outline-secondary btn-sm" href="{{route('shop-cart')}}">
                    {{translate('expand_cart')}}<i class="czi-arrow-{{Session::get('direction') === " rtl"
