    ...
    <footer class="page-footer font-small mdb-color rtl">
        ...
        <div class="pt-4" style="background:{{ $web_config['primary_color'] }}20;">
            <div class="container text-center __pb-13px">
                ...
                <!-- Footer links -->
                <div class="row text-center {{ Session::get('direction') === ' rtl' ? 'text-md-right' : 'text-md-left' }}
                    mt-3 pb-3 ">
                    <!-- Grid column -->
                    <div class=" col-md-3 footer-web-logo">
                        <a class="d-block" href="{{ route('home') }}">
                            <img style="height: 144px !important;"
                                class="{{ Session::get('direction') === ' rtl' ? 'rightalign' : '' }}"
                        ...
                        <div class="store-contents d-flex justify-content-center pr-lg-4">
                            ...
                            <div class="{{ Session::get('direction') === ' rtl' ? 'ml-2' : 'mr-2' }} mb-2">
                                <a class="" href="{{ $web_config['ios']['link'] }}" role="button">
                                    <img width="100" src="{{ asset(' assets/front-end/png/apple_app.png') }}" alt="">
                                </a>
                            </div>
                            @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 footer-padding-bottom">
                                ...
                                <ul class="widget-list __pb-10px">
                                    @php
                                    $flash_deals = \App\Model\FlashDeal::where([
                                    'status' => 1,
                                    ...
                                    'start_date',
                                    '
                                    <=', date('Y-m-d'), ) ->whereDate('end_date', '>=', date('Y-m-d'))
                                        ->first();
                                        @endphp
                            ...
                            <div class="col-md-4 footer-padding-bottom"
                                ...
                                @php($cancellation_policy =
                                \App\CPU\Helpers::get_business_settings('cancellation-policy'))
                                @if (auth('customer')->check())
                                <ul class="widget-list __pb-10px">
                                    <li class="widget-list-item">
                                        <a class="widget-list-link" href="{{ route('user-account') }}">{{
                                            translate('profile_info') }}</a>
                                    </li>
                                    ...
                                    <li class="widget-list-item">
                                        <a class="widget-list-link" href="{{ route('cancellation-policy') }}">{{
                                            translate('cancellation_policy') }}</a>
                                    </li>
                                    @endif
        ...
        <div style="background: rgba(255, 255, 255, 0.05);">
            <div class="container">
                <div class="d-flex flex-wrap end-footer footer-end last-footer-content-align">
                    <div class="mt-3">
                        <p class="{{ Session::get('direction') === ' rtl' ? 'text-right ' : 'text-left' }} __text-16px">
                            {{ $web_config['copyright_text']->value }}</p>
                    </div>
                    {{-- <div class="max-sm-100 justify-content-center d-flex flex-wrap mt-md-3 mt-0 mb-md-3 {{ Session::get('direction') ===
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16"
                                    ...
                                    <g opacity=".3">
                                        <polygon fill="#fff" fill-rule="evenodd"
                                            points="16.002,19 6.208,5 8.255,5 18.035,19" clip-rule="evenodd"></polygon>
                    ...
                    <div class="d-flex __text-14px">
                        <div class="{{ Session::get('direction') === ' rtl' ? 'ml-3' : 'mr-3' }}">
                            <a class="widget-list-link" href="{{ route('terms') }}">{{ translate('terms_&_conditions')
                                }}</a>
                        </div>
                        <div>
