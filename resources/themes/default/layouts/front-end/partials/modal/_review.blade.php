                ...
                <form action="{{route('review.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="p-3">
                            ...
                            <div class="media gap-3">
                                ...
                                <div class="media-body">
                                    ...
                                    @endif
                                    <div><small class="text-muted">{{translate('qty')}} :
                                            {{$order_details->qty}}</small></div>
                    ...
                    <div class="">
                        ...
                        <textarea rows="4" class="form-control text-area-class" name="comment"
                            placeholder="{{translate('best_product,_highly_recommended')}}.">{{$order_details->product->reviews_by_customer[0]->comment ?? ''}}</textarea>
                    </div>
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                <div class="d-flex gap-4 flex-wrap coba_review">
                                    ...
                                    <div class="position-relative img_row{{$key}} border rounded border-primary-light">
                                        <span class="img_remove_icon" onclick="remove_img_row('{{$key}}')"><i
                                                class="czi-close"></i></span>
                                        <div class="overflow-hidden upload_img_box_img rounded">
                                            <img class="h-auto"
                                                onerror="this.src=' {{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                src="{{asset('storage/review')}}/{{$photo}}" alt="VR Collection">
                                        </div>
                                    </div>
                                    @endforeach
                                    @endif
