            ...
            <div class="modal-body d-flex flex-column gap-3">
                    ...
                    <div class="p-3">
                        <div class="media gap-3">
                            ...
                            <div class="media-body">
                                ...
                                <div><small class="text-muted">{{translate('variant')}} : {{$detail->variant}}</small>
                                </div>
                                @endif
                                ...
                                <div><small class="text-muted">{{ $order_details->created_at->format('d M Y, h:i a')
                                        }}</small></div>
                            </div>
                            @else
                            <div class="media-body">
                ...
                <div class="border rounded bg-white">
                    ...
                    <div class="d-flex justify-content-between gap-2 border-top py-2 px-3 fs-12">
                        <div class="text-muted font-weight-bold text-capitalize">
                            {{translate('total_refundable_amount')}}</div>
                ...
                <form action="{{route('refund-store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mt-3 d-flex justify-content-end">
                        <button type="submit"
                            class="btn btn--primary text-capitalize">{{translate('send_request')}}</button>
                    </div>
                </form>
            </div>
        </div>
