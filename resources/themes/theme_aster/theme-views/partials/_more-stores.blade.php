                ...
                <div class="card rounded-10 flex-grow-1">
                    <div class="p-3">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                            ...
                            <a href="javascript:" onclick="order_again({{ $order['id'] }})" class="btn btn-primary">{{
                                translate('order_again') }}</a>
                        </div>
                    </div>
                </div>
                @endforeach
        ...
        <div class="pb-3">
            <div class="">
                <div class="d-flex flex-wrap justify-content-between gap-3 mb-4">
                    ...
                    <a href="{{route('sellers')}}" class="btn-link">{{translate('view_all')}}<i
                    ...
                    <div class="d-flex gap-3 justify-content-between store-list">
                        ...
                        <a href="{{route('shopView',['id'=>$seller['id']])}}"
                            ...
                            <div class="position-relative">
                                ...
                                @if($seller->shop->vacation_status && ($current_date >= $start_date) && ($current_date
                                <= $end_date)) <span class="temporary-closed position-absolute rounded-circle">
                            ...
                            <div class="d-flex flex-column align-items-center text-center gap-2 w-100">
                                ...
                                <div class="text-muted text-truncate product-count">{{$seller->product_count}}
