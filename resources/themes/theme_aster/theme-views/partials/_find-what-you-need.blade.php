    ...
    <div class="container">
        <div class="flexible-grid lg-down-1 gap-3">
            ...
            <div class="bg-primary-light rounded p-3 d-none d-sm-block">
                ...
                <p>{{ translate('Want_to_order_your_usuals') }}? {{ translate('Just_reorder_from_your_previous_orders.')
                    }}</p>
                ...
                <div class="d-flex flex-wrap gap-3 custom-scrollbar" style="--height: 26.5rem">
                    ...
                    <div class="card rounded-10 flex-grow-1">
                        <div class="p-3">
                            ...
                            <div class="fs-10">{{ translate('on') }} {{date('d M Y',strtotime($order['updated_at']))}}
                            </div>
                            ...
                            <div class="bg-light my-2 rounded-10 p-4">
                                <div class="d-flex align-items-center justify-content-between gap-3">
                                    ...
                                    <h6 class="fw-medium fs-12 text-center">+{{ count($order['details'])-3 }} <br>
                                        <a href="{{ route('account-order-details', ['order_id'=>$order['id']]) }}">{{
                                            translate('more') }}</a>
                                    </h6>
                                    @endif
                                </div>
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                <div class="">
                                    <h6 class="fs-10 mb-2"><a
                                            href="{{ route('account-order-details', ['id' => $order['id']]) }}">{{
                                            translate('Order_ID') }}: #{{ $order['id'] }}</a></h6>
                                    <h6>{{ translate('Final_Total') }} : {{
                                        \App\CPU\Helpers::currency_converter($order['order_amount']) }}</h6>
                                </div>
                                <a href="javascript:" onclick="order_again({{ $order['id'] }})"
                                    class="btn btn-primary">{{ translate('order_again') }}</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
            ...
            <div class="d-none d-sm-block">
                ...
                <a href="{{ $sidebar_banner['url'] }}">
                    <img src="{{asset('storage/banner')}}/{{$sidebar_banner ? $sidebar_banner['photo'] : ''}}"
                        onerror="this.src='{{ theme_asset('assets/img/top-side-banner-placeholder.png') }}'" alt=""
                        class="dark-support rounded w-100">
                </a>
                @else
                ...
                <div class="p-3 p-sm-4">
                    <div class="d-flex flex-wrap justify-content-between gap-3 mb-3 mb-sm-4">
                        ...
                        <div class="swiper-nav d-flex gap-2 align-items-center">
                            <div class="swiper-button-prev find-what-you-need-nav-prev position-static rounded-10">
                            </div>
                            <div class="swiper-button-next find-what-you-need-nav-next position-static rounded-10">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-container">
                        ...
                        <div class="position-relative d-none d-md-block">
                            <div class="swiper" data-swiper-loop="true" data-swiper-margin="16" data-swiper-speed="2000"
                                                ...
                                                <div
                                                    ...
                                                    <div class="">
                                                        <h5 class="mb-1 text-truncate" style="--width: 16ch">
                                                            {{$category['name']}}</h5>
                                                        <div class="text-muted">{{$category['product_count']}}
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="floting-text">
                                                                <span class="truncate text-center">
                                                                    <span>
                                                                        {{
                                                                        count($category['childes'])<4 && in_array($key,
                                                                            [0,1,2]) && !array_key_exists(++$key,
                                                                            $category['childes']) ?
                                                                            ($sub_category['sub_category_product_count']>
                                                                            1 ?
                                                                            ($sub_category['sub_category_product_count']-1).'+'
                                                                            :
                                                                            $sub_category['sub_category_product_count'])
                                                                            :
                                                                            $sub_category['sub_category_product_count']
                                                            ...
                                                            <div class="ov-hidden rounded w-100" style="height: 5rem;">
                                                                <img onerror="this.src='{{ theme_asset('assets/img/image-place-holder.png') }}'"
                                                                    src="{{asset('storage/category')}}/{{$sub_category['icon']}}"
                                                                    alt="" loading="lazy" class="dark-support img-fit ">
                                                            </div>
                                                        </div>
                                                        <div class="truncate text-center">{{$sub_category['name']}}
                                                        </div>
                                                    </a>
                                                    @endforeach
                                                </div>
                        ...
                        <div class="position-relative d-md-none">
                            <div class="swiper" data-swiper-loop="true" data-swiper-speed="2000" data-swiper-margin="10"
                                data-swiper-pagination-el="null"
                                data-swiper-navigation-next=".find-what-you-need-nav-next"
                                data-swiper-navigation-prev=".find-what-you-need-nav-prev">
                                <div class="swiper-wrapper">
                                        ...
                                        <div>
                                            ...
                                            <div class="auto-col gap-3" style="--minWidth: 3.75rem; --maxWidth: 5rem">
                                                ...
                                                <a href="{{route('products',['id'=> $sub_category['id'],'data_from'=>'category','page'=>1])}}"
                                                    ...
                                                    <div class="avatar avatar-xxl ov-hidden hover-zoom-in rounded">
                                                        <img onerror="this.src='{{ theme_asset('assets/img/image-place-holder.png') }}'"
                                                            src="{{asset('storage/category')}}/{{$sub_category['icon']}}"
                                                            alt="" loading="lazy" class="dark-support img-fit ">
                                                    </div>
                        ...
                        <div class="club-card card custom-border-color hover-shadow flex-grow-1"
                            ...
                            <div class="d-flex flex-column gap-2 p-3">
                                <h5 class="d-flex gap-2 align-items-center">
                                    ...
                                    \App\CPU\Helpers::currency_converter($coupon->discount) : $coupon->discount.'%' }}
                                    OFF
