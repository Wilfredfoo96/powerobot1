    ...
    <div class="container">
                ...
                <div class="d-flex gap-4 flex-wrap">
                        ...
                        <div class="media-body d-flex flex-column gap-2">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                <span class="star-rating text-gold fs-12">
                                    @for ($i = 1; $i <= 5; $i++) @if ($i <=$avg_rating) <i class="bi bi-star-fill"></i>
                            ...
                            <ul class="list-unstyled list-inline-dot fs-12">
                                ...
                                <li>{{ \App\CPU\Helpers::currency_converter($shop->seller->minimum_order_amount)}}
                                    {{translate('minimum_order_amount')}} </li>
                                @endif
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="media gap-3">
                        ...
                        <div class="media-body d-flex flex-column gap-2">
                            ...
                            <span class="text-sm-nowrap">{{
                                \App\CPU\Helpers::currency_converter($minimum_order_amount)}}
                    ...
                    <div class="d-flex flex-wrap flex-lg-column flex-lg-down-grow-1 justify-content-center gap-3">
                        ...
                        <button type="button" class="btn btn-outline-primary flex-lg-down-grow-1 fs-16"
                            data-bs-toggle="modal" data-bs-target="#loginModal"><i class="bi bi-plus-lg"></i> {{
                            translate('follow') }}</button>
                        @else
                        <button type="button" class="btn btn-outline-primary flex-lg-down-grow-1 fs-16 follow_button"
                            data-status="{{$follow_status}}" data-titletext="{{translate('are_you_sure')}}?"
                            data-titletext2="{{translate('want_to_unfollow_this_shop')}}!"
                            data-cancelbuttontext="{{translate('cancel')}}"
                            onclick="shopFollowAction('{{$shop['id']}}')"> {{($follow_status ==
                            0?translate('Follow'):translate('Unfollow'))}}</button>
                        @endif
        ...
        <div class="">
            <img src="{{asset('storage/shop/banner')}}/{{$shop->bottom_banner}}" class="dark-support rounded img-fit"
                onerror="this.src='{{theme_asset('assets/img/image-place-holder-4_1.png')}}'" alt="">
        </div>
        @elseif($shop['id'] == 0)
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="dropdown">
                                            <button type="button"
                                                ...
                                                str_replace(['-', '_', '/'], ' ',
                                                translate($data['data_from'])):translate('Choose_Option')}}
                                            </button>
                    ...
                    <div class="card-body d-flex flex-column gap-4">
                                ...
                                <ul class="common-nav flex-column nav custom-scrollbar flex-nowrap custom_common_nav">
                                    ...
                                    <li>
                                        <div class="d-flex justify-content-between">
                                            <a
                                                href="{{route('shopView',['id'=> $seller_id,'category_id'=>$category['id']])}}">{{$category['name']}}</a>
                                        ...
                                        <ul class="sub_menu">
                                            ...
                                            <li>
                                                <div class="d-flex justify-content-between">
                                                    <a
                                                        href="{{route('shopView',['id'=> $seller_id,'category_id'=>$child['id']])}}">{{$child['name']}}</a>
                                                ...
                                                <ul class="sub_menu">
                                                    ...
                                                    <li>
                                                        <label class="custom-checkbox">
                                                            <a
                                                                href="{{route('shopView',['id'=> $seller_id,'category_id'=>$ch['id']])}}">{{$ch['name']}}</a>
                                                        </label>
                                                    </li>
                                                    @endforeach
                                                </ul>
                                ...
                                <ul class="common-nav nav flex-column pe-2">
                                    ...
                                    <li>
                                        <div class="flex-between-gap-3 align-items-center">
                                            <label class="custom-checkbox">
                                                <a
                                                    href="{{route('shopView',['id'=>$seller_id,'brand_id'=>$brand->id])}}">{{
                                                    $brand['name'] }}</a>
                                            </label>
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-end gap-2">
                                ...
                                <button class="btn btn-primary py-1 px-2 fs-13" onclick="sortByfilterBy()"><i
                            ...
                            <ul class="product-view-option option-select-btn gap-3">
                                ...
                                <li>
                                    <label>
                                        ...
                                        id="list-view">
                                        <span class="py-2 d-flex align-items-center gap-2"><i class="bi bi-list-ul"></i>
                                            {{translate('List_View')}}</span>
                                    </label>
                                </li>
                            </ul>
                        </div>
