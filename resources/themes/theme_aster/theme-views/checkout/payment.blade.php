                    ...
                    <div class="card-body  px-sm-4">
                        <div class="d-flex justify-content-center mb-30">
                            <ul class="cart-step-list">
                                <li class="done cursor-pointer" onclick="location.href='{{route('shop-cart')}}'">
                                    <span><i class="bi bi-check2"></i></span> {{ translate('cart') }}</li>
                                <li class="done cursor-pointer"
                                    onclick="location.href='{{ route('checkout-details') }}'"><span><i
                                            class="bi bi-check2"></i></span> {{ translate('Shipping_Details') }}</li>
                        ...
                        <div class="mb-30">
                            <ul class="option-select-btn flex-wrap gap-3">
                                ...
                                <li>
                                    <form action="{{route('checkout-complete')}}" method="get">
                                        <label>
                                            ...
                                            <button type="submit"
                                                class="payment-method d-flex border-0 align-iems-center gap-3 overflow-hidden">
                                                <img width="32" src="{{ theme_asset('assets/img/icons/cash-on.png') }}"
                                ...
                                <li>
                                    <label class="">
                                        <button
                                            ...
                                            type="submit" data-bs-toggle="modal" data-bs-target="#wallet_submit_button">
                                            <img width="30" src="{{ theme_asset('assets/img/icons/wallet.png') }}"
                                                class="dark-support" alt="">
                                ...
                                <li
                                    class="{{ (($payment_gateway_published_status == 1 && count($payment_gateways_list) == 0)? 'd-none':'') }}">
                                ...
                                <li>
                                    <form method="post" class="digital_payment d--none"
                                        ...
                                        <label>
                                            @php($additional_data = $payment_gateway['additional_data'] != null ?
                                            json_decode($payment_gateway['additional_data']) : [])
                                            <button
                                ...
                                <li>
                                    <form action="{{route('offline-payment-checkout-complete')}}" method="get"
                                        class="digital_payment d--none">
                                        <label>
                                            <input type="hidden" name="weight">
                                            <span class="payment-method d-flex align-iems-center gap-3 overflow-hidden"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('checkout-complete-wallet')}}" method="get"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-12">
                                                        ...
                                                        <input class="form-control" type="text"
                                                            value="{{\App\CPU\Helpers::currency_converter($amount)}}"
                                                            readonly>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-12">
                                                        ...
                                                        <input class="form-control" type="text"
                                                            value="{{\App\CPU\Helpers::currency_converter($remain_balance)}}"
                                                            readonly>
                                                        @if ($remain_balance<0) <label class="__color-crimson">{{
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="update_cart_button fs-16 btn btn-secondary"
                                                    data-dismiss="modal">{{ translate('close') }}</button>
                                                <button type="submit" class="update_cart_button fs-16 btn btn-primary"
                                                    {{$remain_balance>0? '':'disabled'}}>{{ translate('submit')
                                                    }}</button>
                                            </div>
                                        </form>
                                    </div>
                                            ...
                                            <div class="modal-body p-3 p-md-5">
                                                ...
                                                <div class="">
                                                    ...
                                                    <select class="form-select" id="pay_offline_method"
                                                        ...
                                                        <option value="">{{ translate('select_Payment_Method') }}
                                                        </option>
                                                ...
                                                <div class="" id="method-filed__div">
                                                    <div class="text-center py-5">
                                                        ...
                                                        <p class="py-2 pb-5 text-muted">{{
                                                            translate('select_a_payment_method first') }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
