...
<main class="main-content d-flex flex-column gap-3 pt-3 mb-sm-5">
    <div class="page-title overlay py-5 __opacity-half background-custom-fit" style="--opacity: .5" @if
        ($page_title_banner) @if (File::exists(base_path('storage/banner/'.json_decode($page_title_banner['value'])->
        image)))
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse{{ $help['id'] }}"
                        ...
                        aria-labelledby="flush-heading{{ $help['id'] }}" data-bs-parent="#accordionFlushExample">
