    ...
    <div class="container">
        <div class="card h-100">
            <div class="card-body py-4 px-sm-4">
                <div class="mt-4">
                    <h4 class="text-center text-uppercase mb-5">{{ translate('Your_order') }} #{{ $orderDetails['id'] }}
                        {{ translate('is') }}
                        @if($orderDetails['order_status']=='failed' || $orderDetails['order_status']=='canceled')
                        {{translate($orderDetails['order_status'] =='failed' ? 'Failed To Deliver' :
                        $orderDetails['order_status'])}}
                        @elseif($orderDetails['order_status']=='confirmed' ||
                        $orderDetails['order_status']=='processing' || $orderDetails['order_status']=='delivered')
                        {{translate($orderDetails['order_status']=='processing' ? 'packaging' :
                        $orderDetails['order_status'])}}
                        @else
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            <div id="timeline">
                                <div @if($orderDetails['order_status']=='processing' ) class="bar progress two"
                                    @elseif($orderDetails['order_status']=='out_for_delivery' )
                                    class="bar progress three" @elseif($orderDetails['order_status']=='delivered' )
                                    class="bar progress four" @else class="bar progress one" @endif></div>
                                <div class="state">
                                    <ul>
                                        <li>
                                            <div class="state-img">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-2 fs-12">{{date('d M, Y h:i
                                                    A',strtotime($orderDetails->created_at))}}</div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="state-img">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-2 fs-12">
                                                    ...
                                                    {{date('d M, Y h:i
                                                    A',strtotime(\App\CPU\order_status_history($orderDetails['id'],'processing')))}}
                                                    @endif
                                                </div>
                                                @endif
                                        ...
                                        <li>
                                            ...
                                            <div class="mt-2 fs-12">
                                                ...
                                                {{date('d M, Y h:i
                                                A',strtotime(\App\CPU\order_status_history($orderDetails['id'],'out_for_delivery')))}}
                                                @endif
                                            </div>
                                            @endif
                                        </li>
                                        <li>
                                            ...
                                            <div class="mt-2 fs-12">
                                                ...
                                                {{date('d M, Y h:i
                                                A',strtotime(\App\CPU\order_status_history($orderDetails['id'],
                                                'delivered')))}}
                                                @endif
                                            </div>
                                            @endif
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <div class="column-2">
                                        ...
                                        <div class="fw-bold cursor-pointer"
                                            onclick="location.href='{{ route('account-order-details', ['id'=>$orderDetails->id]) }}'">
                                            {{ $orderDetails['id'] }}</div>
                                        @else
                                    ...
                                    <div class="column-2">
                                        ...
                                        <div class="fw-bold cursor-pointer">{{ $orderDetails['verification_code'] }}
                                        </div>
                                    </div>
                                    @endif
                                    <div class="column-2">
                                        <div>{{ translate('Order_Created_At') }}</div>
                                        <div class="fw-bold">{{date('D, d M, Y
            ...
            <div class="modal-content">
                <div class="modal-header mx-3 border-0">
                    <div>
                        ...
                        @if ($order_verification_status && $orderDetails->order_type == "default_type")
                        <h5 class="small">{{translate('verification_code')}} : {{ $orderDetails['verification_code'] }}
                        </h5>
                        @endif
                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center gap-3">
                                                ...
                                                <div>
                                                    <h6 class="title-color mb-2">
                                                        {{Str::limit($productDetails['name'],30)}}</h6>
                                                ...
                                                <a onclick="digital_product_download('{{ route('digital-product-download', $order_details->id) }}')"
                                                    href="javascript:" class="btn btn-primary btn-sm rounded-pill mb-1"
