...
<head>
    ...
    <style>
        :root {
            ...
            --bs-primary-rgb: {
                    {
                    \App\CPU\hex_to_rgb($web_config['primary_color'])
                }
            }
            ...
            --primary-light: {
                    {
                    $web_config['primary_color_light']
                }
            }
            ...
            --bs-secondary-rgb: {
                    {
                    \App\CPU\hex_to_rgb($web_config['secondary_color'])
                }
            }
        ...
        .announcement-color {
            ...
            color: {
                    {
                    $web_config['announcement']['text_color']
                }
            }
...
<body class="toolbar-enabled">
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id={{$google_tag_manager_id}}" height="0" width="0"
    ...
    <div class="preloader d--none" id="loading">
        <img width="200" src="{{asset('storage/company')}}/{{\App\CPU\Helpers::get_business_settings('loader_gif')}}"
