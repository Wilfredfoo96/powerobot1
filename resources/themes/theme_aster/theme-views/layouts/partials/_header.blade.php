                ...
                <ul class="nav justify-content-center justify-content-sm-end align-items-center gap-4">
                    <li>
                        <div class="language-dropdown">
                            ...
                            <ul class="dropdown-menu" style="--bs-dropdown-min-width: 10rem">
                                ...
                                <li onclick="currency_change('{{$currency['code']}}')"><a href="javascript:">{{
                                        $currency->name }}</a></li>
                                @endforeach
                    ...
                    <li class="d-none d-xl-block">
                        <a href="{{route('shop.apply')}}" class="d-flex">
                            <div class="fz-16">{{ translate('Become_a_Seller')}}</div>
                        </a>
                    </li>
                    @endif
                </ul>
            ...
            <div class="d-flex align-items-center justify-content-between gap-3">
                ...
                <div class="offer-btn">
                    ...
                    <a href="{{ $web_config['header_banner']['url'] }}">
                        <img width="180" src="{{asset('storage/banner')}}/{{$web_config['header_banner']['photo']}}"
                            onerror="this.src='{{theme_asset('assets/img/header-banner-placeholder.png')}}'"
                            loading="lazy" class="dark-support" alt="" />
                    </a>
                    @endif
                </div>
            </div>
        ...
        <div class="container">
            ...
            <aside class="aside d-flex flex-column d-xl-none">
                        ...
                        <ul class="main-nav nav">
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub_menu">
                                            ...
                                            <li>
                                                <a href="javascript:">
                                                    <span
                                                        onclick="location.href='{{route('products',['id'=> $subCategory['id'],'data_from'=>'category','page'=>1])}}'">{{$subCategory['name']}}</span>
                                                </a>
                            ...
                            <li>
                                ...
                                <ul class="sub_menu">
                                    ...
                                    <li><a href="{{route('products',['data_from'=>'featured_deal'])}}">{{
                                            translate('featured_Deal') }}</a></li>
                                    @endif

                                    @if($web_config['flash_deals'])
                                    <li><a
                                            href="{{route('flash-deals',[$web_config['flash_deals']?$web_config['flash_deals']['id']:0])}}">{{
                                            translate('Flash_Deal') }}</a></li>
                                    @endif
                                </ul>
                            </li>
                            @endif
                            ...
                            <li>
                                ...
                                <ul class="sub_menu">
                                    ...
                                    <li>
                                        <a href="{{route('shopView',['id'=>$shop['id']])}}">{{Str::limit($shop->name,
                                            14)}}</a>
                                    </li>
                                    @endforeach
                                </ul>
                ...
                <div class="d-flex justify-content-center mb-5 pb-5 mt-auto px-4">
                    <a href="{{route('customer.auth.logout')}}" class="btn btn-primary w-100">{{ translate('logout')
                        }}</a>
                </div>
                @else
                <div class="d-flex justify-content-center mb-5 pb-5 mt-auto px-4">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown d-none d-xl-block">
                        ...
                        <ul class="dropdown-menu dropdown--menu">
                            @foreach($categories as $key=>$category)
                            @if($key<8) <li class="{{ $category->childes->count() > 0 ? 'menu-item-has-children':'' }}">
                                <a href="javascript:"
                                    onclick="location.href='{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}'">
                                    {{$category['name']}}
                                </a>
                        ...
                        <ul class="nav main-menu align-items-center d-none d-xl-flex flex-nowrap">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    @if($web_config['featured_deals']->count()>0)
                                    <li>
                                        <a href="{{route('products',['data_from'=>'featured_deal'])}}">{{
                                            translate('Featured_Deal') }}</a>
                                    </li>
                                    @endif
                    ...
                    <li class="login-register d-flex align-items-center gap-4">
                        <div class="profile-dropdown">
                            <button type="button"
                                ...
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="avatar overflow-hidden header-avatar rounded-circle"
                                    style="--size: 1.5rem">
                                    <img loading="lazy"
