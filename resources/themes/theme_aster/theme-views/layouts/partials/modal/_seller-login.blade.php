        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-sm-5">
                <div class="mb-3 text-center">
                    <img width="123" src="{{asset(" storage/company")."/".$web_config['web_logo']->value}}"
                    alt=""
                    class="dark-support"
                    />
                </div>
                ...
                <form action="{{route('seller.auth.login')}}" method="post" id="seller_login_form">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input name="email" id="seller-email" class="form-control" value="{{old('email')}}"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-inner-end-ele">
                            <input name="password" type="password" id="seller-password" class="form-control"
                                placeholder="{{ translate('Ex:_8+_character') }}" required />
