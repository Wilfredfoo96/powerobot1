        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-4 px-lg-5">
                <div class="mb-4 text-center">
                    <img width="200" src="{{asset(" storage/company")."/".$web_config['web_logo']->value}}"
                ...
                <div class="mb-4">
                    ...
                    <p class="text-muted">
                        ...
                        <span class="text-primary fw-bold" data-bs-toggle="modal" data-bs-target="#loginModal">
                            {{ translate('login') }}
                        </span>
                    </p>
                </div>

                <form action="{{ route('customer.auth.sign-up') }}" method="POST" id="customer_form"
                    ...
                    <div class="custom-scrollbar" style="--height: 45vh;">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" id="f_name" name="f_name" class="form-control"
                                        placeholder="{{ translate('Ex') }}: Jhone" value="{{old('f_name')}}" required />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group mb-4">
                            ...
                            <div class="col-sm-12">
                                <div class="mb-4">
                                    <div class="form-group">
                                        <label class="form-label form--label text-capitalize" for="referral_code">{{
                                            translate('refer_code') }} <small class="text-muted">({{
                                                translate('optional') }})</small></label>
                        ...
                        <div class="d-flex gap-3 justify-content-center py-2 mt-4 mb-3">
                            ...
                            <div class="input-icons rounded bg-white">
                                <a onclick="re_captcha_customer_regi();"
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <label for="agree" class="d-flex gap-1 align-items-center mb-0">
                                ...
                                {{translate('i_agree_with_the')}} <a href="{{route('terms')}}" class="text-info">{{
                                    translate('Terms_&_Conditions') }}</a>
                            </label>
                        </div>
                    </div>

                    <div class="d-flex justify-content-center mt-4 mb-3">
                        <button type="submit" id="sign-up" class="btn btn-primary px-5" disabled>{{ translate('Sign_Up')
                            }}</button>
                    </div>
                </form>
                ...
                <div class="d-flex justify-content-center gap-3 align-items-center flex-wrap pb-3">
                    ...
                    <a href="{{route('customer.auth.service-login', $socialLoginService['login_medium'])}}">
                        <img width="35"
                            src="{{ theme_asset('assets/img/svg/'.$socialLoginService['login_medium'].'.svg') }}" alt=""
                            class="dark-support" />
                    </a>
                    @endif
                    @endforeach
