...
<main class="main-content d-flex flex-column gap-3 pt-3 mb-sm-5">
    <div class="container">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide position-relative"
                                                    ...
                                                    <div class="easyzoom easyzoom--overlay">
                                                        ...
                                                        "percent")
                                                        <span
                                                            class="product__discount-badge">-{{$product->discount}}%</span>
                                    ...
                                    <div class="product-details-content position-relative">
                                        ...
                                        <div class="d-flex gap-2 align-items-center mb-2">
                                            <div class="star-rating text-gold fs-12">
                                                @for ($i = 1; $i <= 5; $i++) @if ($i <=(int)$overallRating[0]) <i
                                                    ...
                                                    @elseif ($overallRating[0] != 0 && $i <= (int)$overallRating[0] +
                                        ...
                                        @if(($product['product_type'] == 'physical') && ($product['current_stock']<=0))
                                            ...
                                            <p class="fw-semibold text-muted"><span
                                                    class="in_stock_status">{{$product->current_stock}}</span>
                                                {{translate('in_Stock')}}
                                            </p>
                                            @endif
                                            @endif
                                            ...
                                            <div class="product__price d-flex flex-wrap align-items-end gap-2 mb-4">
                                                ...
                                                @endif
                                                <ins class="product__new-price">{{\App\CPU\Helpers::get_price_range($product)
                                                    }}</ins>
                                            </div>
                                                ...
                                                <div class="">
                                                            ...
                                                            <div class="flex-between-gap-3">
                                                                <div class="">
                                                                    ...
                                                                    <h6 class="flex-middle-gap-2">
                                                                        ...
                                                                        <span class="product_vat">{{ $product->tax_model
                                                                            == 'include' ? 'incl.' :
                                                                            \App\CPU\Helpers::currency_converter($product->tax)}}</span>
                                                                    </h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="mx-w d-flex flex-wrap gap-3 mt-4"
                                                        ...
                                                        $seller_vacation_start_date && $current_date <=
                                                            $seller_vacation_end_date))) || ($product->added_by ==
                                                            'admin' && ($inhouse_temporary_close ||
                                                            ($inhouse_vacation_status && $current_date >=
                                    ...
                                    <div class="col-lg-5">
                                        <div class="rating-review mx-auto text-center mb-30">
                                            <h2 class="rating-review__title"><span
                                                    class="rating-review__out-of">{{round($overallRating[0],
                                                    1)}}</span>/5
                                            </h2>
                                            ...
                                            <div class="card border-primary-light flex-grow-1">
                                                <div class="media flex-wrap align-items-centr gap-3 p-3">
                                                    <div class="avatar overflow-hidden border rounded-circle"
                                                        style="--size: 3.437rem">
                                                        <img src="{{asset("
                                                            storage/profile")}}/{{(isset($item->user)?$item->user->image:'')}}"
                                                        alt=""
                                                    ...
                                                    <div class="media-body d-flex flex-column gap-2">
                                                        ...
                                                        <div class="d-flex flex-wrap gap-2 products-comments-img">
                                                            ...
                                                            @if(file_exists(base_path("storage/review/".$img)))
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h6 class="text-danger text-center m-0">
                                                        {{translate('product_review_not_available')}}</h6>
                                                </div>
                                            </div>
                                            @endif
                                        </div>
        ...
        <div class="col-lg-4 col-xl-3 d-flex flex-column gap-3">
            ...
            <div class="card order-0 order-sm-1">
                <div class="card-body">
                    <div class="p-2 overlay shop-bg-card"
                        data-bg-img="{{asset('storage/shop/banner')}}/{{$product->seller->shop->banner}}">
                        <div class="media flex-wrap gap-3 p-2">
                            <div class="avatar border rounded-circle" style="--size: 3.437rem">
                                <img src="{{asset('storage/shop')}}/{{$product->seller->shop->image}}" alt=""
                            ...
                            <div class="media-body d-flex flex-column gap-2 text-absolute-whtie">
                                <div class="d-flex flex-column gap-1 justify-content-start">
                                    ...
                                    <div class="d-flex gap-2 align-items-center ">
                                        <div class="star-rating text-gold fs-12">
                                            @for ($i = 1; $i <= 5; $i++) @if ($i <=(int)$avg_rating) <i
                                                class="bi bi-star-fill"></i>
                                                @elseif ($avg_rating != 0 && $i <= (int)$avg_rating + 1.1 &&
                                    ...
                                    <h6 class="fw-semibold">{{$products_for_review->count()}} {{translate('products')}}
                                    </h6>
                                </div>
            ...
            <div class="card  order-0 order-sm-1">
                <div class="card-body">
                    <div class="p-2 overlay shop-bg-card" data-bg-img="{{asset(" storage/shop/")}}/{{
                        \App\CPU\Helpers::get_business_settings('shop_banner') }}">
                        <div class="media flex-wrap gap-3 p-2">
                            <div class="avatar border rounded-circle" style="--size: 3.437rem">
