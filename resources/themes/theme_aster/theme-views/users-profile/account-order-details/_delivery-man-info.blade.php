                                ...
                                <div class="d-flex justify-content-between align-items-center gap-4 flex-wrap">
                                    ...
                                    <div class="media gap-2 gap-sm-3">
                                        ...
                                        <div class="media-body d-flex flex-column gap-2">
                                            <h4>{{$order->delivery_man->f_name}}&nbsp{{$order->delivery_man->l_name}}
                                            </h4>
                                            ...
                                            <ul class="list-unstyled list-inline-dot flex-wrap fs-12">
                                                ...
                                                <li>{{$order->delivery_man->review_count}} {{translate('Reviews')}}
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-sm-5">
                                                    <form action="{{route('messages_store')}}" method="post"
                                                        ...
                                                        <input value="{{$order->delivery_man->id}}"
                                                            name="delivery_man_id" hidden>
                                                        @endif
                                                        ...
                                                        @if($order->delivery_man->id != 0)
                                                        <button
                                                            class="btn btn-secondary m-0">{{translate('send')}}</button>
                                                        @else
                                    ...
                                    <div class="modal fade" id="reviewModal" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header px-sm-5">
                                                    <h1 class="modal-title fs-5" id="reviewModalLabel">
                                                        {{translate('Submit_a_review')}}</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <form action="{{route('submit-deliveryman-review')}}" method="post"
                                                    ...
                                                    <div class="modal-footer gap-3 pb-4 px-sm-5">
                                                        <a href="{{ URL::previous() }}" class="btn btn-secondary m-0"
                                                            data-bs-dismiss="modal">{{translate('Back')}}</a>
                                                        <button type="submit"
                                                            class="btn btn-primary m-0">{{translate('Submit')}}</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    </div @else <div class="d-flex justify-content-center flex-grow-1">
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <a href="{{asset(" storage/delivery-man/verification-image/".$image->image)}}"
                                        data-lightbox="">
                                        <img src="{{asset(" storage/delivery-man/verification-image/".$image->image)}}"
                                        class="height-100 rounded remove-mask-img"
