                        ...
                        <div class="mt-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media gap-3 align-items-center mn-w200">
                                                    <div class="avatar rounded" style="--size: 3.75rem">
                                                        ...
                                                        onerror="this.src='{{
                                                        theme_asset('assets/img/image-place-holder.png') }}'"
                                                        class="img-fit dark-support rounded" alt="">
                                                        @endif
                                                    </div>
                                                    <div class="media-body">
                                                        <h6>
                                                            <a
                                                                href="{{ route('account-order-details', ['id'=>$order->id]) }}">{{translate('Order')}}
                                                                #{{$order['id']}}</a>
                                                        </h6>
                                                        <div class="text-dark fs-12">{{count($order->details)}}
                                                            {{translate('items')}}</div>
                                                        <p class="text-muted fs-12">{{date('d M, Y h:i
                                                            A',strtotime($order['created_at']))}}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <span class="text-center badge bg-success rounded-pill">
                                                    {{translate($order['order_status']=='processing' ? 'packaging' :
                                                    $order['order_status'])}}
                                                </span>
                                                @else
                                                ...
                                                <div
                                                    class="{{ $order['payment_status']=='unpaid' ? 'text-danger':'text-dark' }} mt-1">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2 align-items-center">
                                                    ...
                                                    <button class="btn btn-danger btn-action"
                                                        title="{{ translate('Cancel')}}" onclick="cancel_message()">
                                                        <i class="bi bi-trash"></i>
                                                    </button>
                                                    @endif
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex gap-2 justify-content-between py-2 border-bottom d-sm-none">
                                    <div class="media gap-2 mn-w200"
                                        onclick="location.href='{{ route('account-order-details', ['id'=>$order->id]) }}'">
                                        <div class="avatar rounded" style="--size: 3.75rem">
                                            @if($order->seller_is == 'seller')
                                            <img onerror="this.src='{{ theme_asset('assets/img/image-place-holder.png') }}'"
                                                src="{{ asset('storage/shop/'.$order->seller->shop->image)}}"
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="text-dark fs-12">{{count($order->details)}}
                                                {{translate('items')}}</div>
                                            <div class="text-muted fs-12">{{date('d M, Y h:i
                                                A',strtotime($order['created_at']))}}</div>
                                            ...
                                            <div class="d-flex gap-2 align-items-center fs-12">
                                                ...
                                                <div
                                                    class="{{ $order['payment_status']=='unpaid' ? 'text-danger':'text-dark' }}">
                                                    {{ translate($order['payment_status']) }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="">
                                        ...
                                        @else
                                        <button class="btn btn-danger btn-action mb-1" title="{{ translate('Cancel')}}"
