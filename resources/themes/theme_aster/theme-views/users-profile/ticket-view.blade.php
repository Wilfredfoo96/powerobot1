                            ...
                            <div class="media-body">
                                <div class="d-flex flex-column gap-1">
                                    <div class="d-flex gap-2 align-items-center">
                                        <h6 class="">{{ \App\CPU\customer_info()->f_name }}&nbsp{{
                    ...
                    <div class="messaging">
                        <div class="inbox_msg custom-scrollbar p-3 msg_history __h-30rem">
                            <div class="outgoing_msg">
                                ...
                                <span class="time_date d-flex justify-content-end"> {{ date('h:i:A | M
                                    d',strtotime($ticket['created_at'])) }}<i class="bi px-1"></i></span>
                            </div>
                            ...
                            <div class="outgoing_msg">
                                ...
                                <div class="d-flex flex-wrap g-2 gap-2 justify-content-end">
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <img onerror="this.src=' {{asset('assets/front-end/img/image-place-holder.png')}}'"
                                            src="{{asset('storage/support-ticket')}}/{{$photo}}" height="100"
                                ...
                                <span class="time_date d-flex justify-content-end"> {{ date('h:i:A | M
                                    d',strtotime($conversation['created_at'])) }}<i class="bi px-1"></i></span>
                            </div>
                            @endif
                            ...
                            <div class="received_msg">
                                ...
                                <span class="time_date"> {{ date('h:i:A | M d',strtotime($conversation['created_at']))
                                    }} <i class="bi px-1"></i></span>
                            </div>
                            @endif
                            @endforeach
                        </div>
                        ...
                        <div class="type_msg">
                            <form action="{{route('support-ticket.comment',[$ticket['id']])}}" method="post">
                                @csrf
                                <div
                                    class="input_msg_write border-top py-2 px-2 px-sm-3 d-flex align-items-start justify-content-between gap-2 gap-sm-3 lh-base">

                                    <textarea class="w-100 custom-height" style="--h: 5rem" id="msgInputValueTicket"
                                        name="comment" rows="6"
