                            ...
                            <form action="#">
                                <div
                                    ...
                                    <div class="media align-items-center gap-3">
                                        <div class="avatar avatar-xxl rounded border overflow-hidden">
                                            <img onerror="this.src='{{ theme_asset('assets/img/image-place-holder.png') }}'"
                                                ...
                                                class="dark-support img-fit rounded" alt="">
                                        </div>
                                        <div class="media-body d-flex gap-1 flex-column">
                                            <h6 class="text-truncate" style="--width: 20ch">
                                                <h6>
                                                    ...
                                                    <small class="text-warning"> ({{translate('refund_pending')}})
                                                    </small> <br>
                                                    @elseif($order_details->refund_request == 2)
                                                    <small class="text-primary"> ({{translate('refund_approved')}})
                                                    </small> <br>
                                                    @elseif($order_details->refund_request == 3)
                                                    <small class="text-danger"> ({{translate('refund_rejected')}})
                                                    </small> <br>
                                                    @elseif($order_details->refund_request == 4)
                                                    <small class="text-success"> ({{translate('refund_refunded')}})
                                                    </small> <br>
                                                    @endif<br>
                                                </h6>
                                    ...
                                    <div class="d-flex flex-column gap-1 fs-12">
                                        <span>{{ translate('QTY') }} :
                                            {{\App\CPU\Helpers::currency_converter($order_details->qty)}}</span>
                                    ...
                                    <div class="d-flex flex-column gap-1 fs-12">
                                        ...
                                        <span>{{translate('Coupon_discount')}}:
