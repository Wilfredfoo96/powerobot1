                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div class="wallet-card pb-3 rounded-10 overlay ov-hidden"
                                    ...
                                    <div class="card-body d-flex flex-column gap-2 absolute-white">
                                        <div class="d-flex justify-content-between mb-3">
                                            <img width="34" src="{{theme_asset('assets/img/icons/profile-icon5.png')}}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="w-100 mb-2">
                                                        ...
                                                        <p class="mb-2 text-dark">{{ translate('valid_till') }} {{
                                                            date('d M, Y',strtotime($bonus->end_date_time)) }}</p>
                                                    </div>
                                                    <div>
                                                        ...
                                                        @endif
                                                        <p class="fw-bold text-primary mb-0">{{ $bonus->description ?
                                                            Str::limit($bonus->description, 50):'' }}</p>
                                                    </div>
                                ...
                                <div class="mt-4 d-none d-md-block">
                                    ...
                                    <ul>
                                        <li>{{translate('Earn_money_to_your_wallet_by_completing_the_offer_&_challenged')}}
                                        </li>
                                        <li>{{translate('Convert_your_loyalty_points_into_wallet_money')}}</li>
                                        <li>{{translate('Admin_also_reward_their_top_customers_with_wallet_money')}}
                                        </li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="bg-light p-3 p-sm-4 rounded d-flex justify-content-between gap-3">
                                        ...
                                        <div class="text-end">
                                            <div class="text-muted mb-1">{{date('d M, Y H:i
                                ...
                                <div class="d-flex flex-column gap-3 align-items-center text-center my-5">
                                    ...
                                    <h6 class="text-muted">{{translate('You_do_not_have_any')}}<br> {{ request('type')
                                        != 'all' ? ucwords(translate(request('type'))) : '' }}
                    ...
                    <form action="{{ route('customer.add-fund-request') }}" method="post" id="add_fund_to_wallet_Form">
                        ...
                        <div class="pb-4">
                            ...
                            <p class="text-center pb-3">{{
                                translate('add_fund_by_from_secured_digital_payment_gateways') }}</p>
                        ...
                        <div id="add-fund-list-area" style="display: none">
                            <h5 class="mb-4">{{ translate('payment_Methods') }} <small>({{
                                    translate('faster_&_secure_way_to_pay_bill') }})</small></h5>
                            <div class="gatways_list">
                                ...
                                <label class="form-check form--check rounded">
                                    ...
                                    (json_decode($gateway->additional_data)->gateway_title ?? ucwords(str_replace('_','
                                    ', $gateway->key_name))) : ucwords(str_replace('_',' ', $gateway->key_name)) )
                        ...
                        <div class="d-flex justify-content-center pt-2 pb-3">
                            <button type="submit" class="btn btn-primary w-75 mx-3" id="add_fund_to_wallet_form_btn">{{
                                translate('add_Fund') }}</button>
                        </div>
                    </form>
