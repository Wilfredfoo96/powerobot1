                            ...
                            <div class="tab-content p-2 pt-0">
                                <div class="tab-pane fade show active" id="seller-tab-pane" role="tabpanel"
                                    ...
                                    <div class="chat-list custom-scrollbar ">
                                        ...
                                        <div onclick="location.href='{{route('chat', ['type' => $type])}}/?id={{$unique_id}}'"
                                            ...
                                            <div class="media-body">
                                                <div class="chat-people-name gap-2 align-items-center mb-1">
                                                    <div class="text-truncate d-flex align-items-center gap-1"
                                                        style="--width: 100%">
                                                        <h6 class="fs-12 seller" id="{{$unique_id}}">{{$shop->f_name?
                                                            $shop->f_name. ' ' . $shop->l_name: $shop->name}}</h6>
                                                        <div class="fs-12 text-muted"></div>
                                                    </div>

                                                    <div class="fs-10">{{date('M d',strtotime($shop->created_at))}}
                                                    </div>
                                                </div>
                                                <p class="fs-10">{{$shop->seller_email ? $shop->seller_email :
                                                    $shop->email}}</p>
                                            </div>
                                        </div>
                                        @endforeach
                                    ...
                                    <div class="media-body">
                                        <div class="d-flex flex-column gap-1">
                                            <h6 class="" id="name">
                                                ...
                                                '.$last_chat->delivery_man->l_name : $last_chat->shop->name }} </h6>
                                ...
                                <div class="inbox_msg custom-scrollbar p-3 msg_history" style="height: 480px"
                                    ...
                                    <div class="received_msg">
                                        ...
                                        <div class="row g-2 flex-wrap mt-3 justify-content-start">
                                            ...
                                            <div class="col-sm-6 col-md-3">
                                                <img src="{{asset(" storage/chatting/".$photo)}}"
                                        ...
                                        <span class="time_date"> {{ date('h:i:A | M d',strtotime($chat->created_at)) }}
                                        </span>
                                    </div>
                                    @else
                                    <div class="outgoing_msg" id="outgoing_msg">
                                        ...
                                        <span class="time_date d-flex justify-content-end"> {{ date('h:i:A | M
                                            d',strtotime($chat->created_at)) }} </span>
                                    </div>
                                    @endif
                                    @endForeach
                                    <div id="down"></div>
