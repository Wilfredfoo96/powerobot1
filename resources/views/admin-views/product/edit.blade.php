...
<div class="content container-fluid">
    ...
    <!-- Form -->
    <form class="product-form text-start" action="{{route('admin.product.update',$product->id)}}" method="post"
                                ...
                                <div class="row g-2" id="additional_Image_Section">
                                        ...
                                        <div
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                                <img id="additional_Image_{{ $unique_id }}"
                                                    class="h-auto aspect-1 bg-white" src="{{asset("
                                                    storage/product/$photo")}}" onerror="this.classList.add('d-none')">
                                            </div>
                                            <div
                                                class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                <div
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <div
                                            class="custom_upload_input custom-upload-input-file-area position-relative border-dashed-2">
                                            <a class="delete_file_input_css btn btn-outline-danger btn-sm square-btn"
                                                href="{{route('admin.product.remove-image',['id'=>$product['id'],'name'=>$photo->image_name,'color'=>'null'])}}">
                                                <i class="tio-delete"></i>
                                            </a>
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                                <img id="additional_Image_{{ $unique_id }}"
                                                    class="h-auto aspect-1 bg-white" src="{{asset("
                                                    storage/product/".$photo->image_name)}}"
                                                onerror="this.classList.add('d-none')">
                                            </div>
                                            <div
                                                class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <div class="custom_upload_input position-relative border-dashed-2">
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                                <img id="additional_Image_1" class="h-auto aspect-1 bg-white" src="img"
                                                    onerror="this.classList.add('d-none')">
                                            </div>
                                            <div
                                                class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
        ...
        <div class="d-flex justify-content-end mt-3">
            ...
            <button type="button" onclick="check()"
                class="btn btn--primary px-5">{{translate('update_&_Publish')}}</button>
            @else
