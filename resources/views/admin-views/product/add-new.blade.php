...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Form -->
        <form class="product-form text-start" action="{{ route('admin.product.store') }}" method="POST"
                                ...
                                <label class="title-color d-flex justify-content-between gap-2">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('/assets/back-end/img/info-circle.svg') }}"
                                                alt="">
                                        </span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="custom_upload_input">
                                            <input type="file" name="image" class="custom-upload-input-file"
                                        ...
                                        <p class="text-muted mt-2">{{ translate('image_format') }} : Jpg, png, jpeg,
                                            webp,
                                            <br>
    ...
    <script>
        ...
        function add_more_customer_choice_option(i, name) {
            ...
            $('#customer_choice_options').append(
                ...
                '[]" placeholder="{{ translate('enter_choice_values') }}" data-role="tagsinput" onchange="update_sku()"></div></div></div>'
            );
