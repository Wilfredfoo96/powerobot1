                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2-custom form-control" name="sub_category_id"
                                ...
                                <option
                                    ...
                                    {{request('sub_category_id') != null ? $sub_category['defaultName']:
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2-custom form-control" name="sub_sub_category_id"
                                ...
                                <option
                                    ...
                                    {{request('sub_sub_category_id') != null ? $sub_sub_category['defaultName'] :
                                    translate('select_Sub_Sub_Category') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="d-flex gap-3 justify-content-end">
                            <a href="{{ route('admin.product.list',['type'=>request('type')])}}"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ route('admin.product.export-excel',['type'=>request('type')])}}?brand_id={{request('brand_id')}}&search={{ request('search') }}&category_id={{request('category_id')}}&sub_category_id={{request('sub_category_id')}}&sub_sub_category_id={{request('sub_sub_category_id')}}&seller_id={{request('seller_id')}}&status={{request('status')}}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{route('admin.product.featured-status')}}" method="post"
                                        id="product_featured{{$p['id']}}_form" class="product_featured_form">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$p['id']}}">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input"
                                                id="product_featured{{$p['id']}}" name="status" value="1" {{
                                ...
                                <td class="text-center">
                                    <form action="{{route('admin.product.status-update')}}" method="post"
                                        id="product_status{{$p['id']}}_form" class="product_status_form">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$p['id']}}">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input"
                                                id="product_status{{$p['id']}}" name="status" value="1" {{
                                                $p['status']==1 ? 'checked' :'' }}
