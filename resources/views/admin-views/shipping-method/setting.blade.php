                            ...
                            <div class="mt-2" id="product_wise_note">
                                <p>
                                    <img width="16" class="mt-n1"
                                        src="{{asset('/assets/back-end/img/danger-info.png')}}" alt="">
                                    <strong>{{translate('note')}}</strong>
                                    : {{translate("please_make_sure_all_the
                                    product`s_delivery_charges_are_up_to_date.")}}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-wrap justify-content-center gap-10">
                                    ...
                                    <a title="{{translate('delete')}}" class="btn btn-outline-danger btn-sm delete"
                                        id="{{ $method['id'] }}">
