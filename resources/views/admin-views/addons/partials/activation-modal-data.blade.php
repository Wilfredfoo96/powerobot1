...
<div class="modal-body px-4 px-sm-5">
    <div class="mb-4 text-center">
        <img width="200" src="{{asset($path.'/addon.png')}}"
            onerror="this.src='{{asset('assets/front-end/img/placeholder.png')}}'" alt="" class="dark-support" />
    </div>
    ...
    <form action="{{route('admin.addon.activation')}}" method="post" id="customer_login_modal" autocomplete="off">
        ...
        <div class="form-group mb-4">
            ...
            <input name="username" id="username" class="form-control" placeholder="{{translate('Ex:_Riad_Uddin')}}"
                required />
        </div>
        ...
        <div class="d-flex justify-content-center gap-3 mb-3">
            <button type="button" class="fs-16 btn btn-secondary flex-grow-1" data-dismiss="modal">{{
