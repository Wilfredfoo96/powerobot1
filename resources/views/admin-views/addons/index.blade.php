                        ...
                        <div class="pl-sm-5">
                            ...
                            <ul class="pl-3 d-flex flex-column gap-2 instructions-list">
                                <li>
                                    ...
                                    "{{translate('upload_max_filesize')}}"
                                    {{translate('value_is_grater_or_equal_to_20MB') }}. {{ translate('current_value_is')
                                    }}
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-end">
                            <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}" class="btn btn--primary px-4"
                    ...
                    <div class="d-flex gap-2 gap-sm-3 align-items-center">
                        ...
                        <button class="text-danger bg-transparent p-0 border-0" data-toggle="modal"
                            data-target="#deleteThemeModal_{{ $key }}"><img
                                src="{{asset('assets/back-end/img/icons/delete.svg')}}" class="svg" alt=""></button>
                        ...
                        <div class="modal fade" id="deleteThemeModal_{{ $key }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header border-0 pb-0 d-flex justify-content-end">
                                        <buttongit type="button" class="btn-close border-0" data-dismiss="modal"
                                            aria-label="Close"><i class="tio-clear"></i></button>
                                    </div>
                                    <div class="modal-body px-4 px-sm-5 text-center">
                                        <div class="mb-3 text-center">
                                            <img width="75" src="{{asset('assets/back-end/img/delete.png')}}" alt="">
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-center gap-3 mb-3">
                                            ...
                                            <button type="submit" class="fs-16 btn btn-danger px-sm-5"
                                                data-dismiss="modal" onclick="theme_delete('{{$addon}}')">{{
                        ...
                        <button class="text-muted bg-transparent p-0 border-0" data-toggle="modal"
                            data-target="#shiftThemeModal_{{ $key }}"><img
                                src="{{asset('assets/back-end/img/icons/check.svg')}}"
                                class="svg {{ $data['is_published'] == 1 ? 'text--primary' : '' }}" alt=""></button>
                                    ...
                                    <div class="modal-body px-4 px-sm-5 text-center">
                                        ...
                                        <div class="d-flex justify-content-center gap-3 mb-3">
                                            ...
                                            <button type="button" class="fs-16 btn btn--primary px-sm-5"
                                                data-dismiss="modal" onclick="publish_addon('{{ $addon }}')">{{
                ...
                <div class="p-2 p-sm-3">
                    <div class="aspect-ration-3:2 border border-color-primary-light radius-10">
                        <img class="img-fit radius-10"
                            onerror="this.src='{{asset('assets/back-end/img/placeholder.png')}}'" \
