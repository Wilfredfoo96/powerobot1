                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a class="dropdown-item"
                                    href="{{route('admin.customer.export',['search'=>request('search')])}}">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{route('admin.customer.status-update')}}" method="post"
                                id="customer_status{{$customer['id']}}_form" class="customer_status_form">
                                @csrf
                                <input type="hidden" name="id" value="{{$customer['id']}}">
                                <label class="switcher mx-auto">
                                    <input type="checkbox" class="switcher_input"
                                        id="customer_status{{$customer['id']}}" name="status" value="1" {{
