                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="bonus_title"
                                placeholder="{{translate('Ex: EID_Dhamaka')}}" required>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control" id="short_desc"
                                placeholder="{{translate('Ex: EID_Dhamaka')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4" id="bonus_amount_area">
                        <div class="form-group">
                            <label for="bonus_amount"
                                class="title-color text-capitalize d-flex">{{translate('bonus_amount')}} (<span
                                    id="bonus_title_percent">%</span>)</label>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="min_add_money_amount" min="0" class="form-control"
                                id="min_add_money_amount" value="0" placeholder="{{translate('Ex: 100')}}" required>
                        </div>
                    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                <div>{{translate('minimum_add_amount')}} -
                                    {{\App\CPU\Helpers::currency_converter($item->min_add_money_amount) }}</div>
                                @if ($item->bonus_type != "fixed")
                                <div>{{translate('maximum_bonus')}} -
                                    {{\App\CPU\Helpers::currency_converter($item->max_bonus_amount) }}</div>
                                @endif
                            </div>
                        </td>
                        <td class="text-center">{{ $item->bonus_type == 'percentage' ? $item->bonus_amount.'%' :
                            \App\CPU\Helpers::currency_converter($item->bonus_amount) }}</td>
                        ...
                        <td>
                            <label class="switcher">
                                <input type="checkbox" class="switcher_input status" data-id="{{ $item->id }}" {{
