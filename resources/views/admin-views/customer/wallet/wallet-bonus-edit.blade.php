                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body px-4 px-sm-5 pt-0 text-center">
                        <div class="d-flex flex-column align-items-center gap-2">
                            <img width="80" class="mb-3" src="{{asset('/assets/back-end/img/para.png')}}" loading="lazy"
                                alt="">
                            <h4 class="lh-md">{{
                                translate('wallet_bonus_is_only_applicable_when_a_customer_add_fund_to_wallet_via_outside_payment_gateway')
                                }} !</h4>
                            <p>{{
                                translate('customer_will_get_extra_amount_to_his_or_her_wallet_additionally_with_the_amount_he_or_she_added_from_other_payment_gateways').'
                                '.translate('the_bonus_amount_will_be_deduct_from_admin_wallet_&_will_consider_as_admin_expense')
                                }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="bonus_title"
                                placeholder="{{translate('Ex: EID_Dhamaka')}}" value="{{ $data->title }}" required>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control" id="short_desc"
                                placeholder="{{translate('Ex: EID_Dhamaka')}}" value="{{ $data->description }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="bonus_type" id="bonus_type" class="form-control">
                                <option value="percentage" {{ $data->bonus_type == 'persentage' ? 'selected':''
                                    }}>{{translate('persentage (%)')}}</option>
                                <option value="fixed" {{ $data->bonus_type == 'fixed' ? 'selected':''
                                    }}>{{translate('fixed_amount')}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-4" id="bonus_amount_area">
                        <div class="form-group">
                            <label for="bonus_amount"
                                class="title-color text-capitalize d-flex">{{translate('bonus_amount')}}</label>
                            <input type="number" name="bonus_amount" min="0" class="form-control" id="bonus_amount"
                                placeholder="{{translate('Ex: 5')}}"
                                value="{{ $data->bonus_type == 'fixed' ? (\App\CPU\Convert::default($data->bonus_amount) ?? 0) : $data->bonus_amount }}"
                                required>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="min_add_money_amount" min="0" class="form-control"
                                ...
                                value="{{ \App\CPU\Convert::default($data->min_add_money_amount) ?? 0 }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4" id="max_bonus_amount_area">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" name="max_bonus_amount" class="form-control"
                                ...
                                value="{{ \App\CPU\Convert::default($data->max_bonus_amount) ?? 0 }}">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-3 justify-content-end">
                            <a onclick="location.href='{{ route('admin.customer.wallet.bonus-setup') }}'"
