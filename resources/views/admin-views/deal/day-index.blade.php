...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.deal.day')}}" style="text-align: {{Session::get('direction') === " rtl"
                        ? 'right' : 'left' }};" method="post">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            <button type="reset" id="reset" class="btn btn-secondary px-5">{{
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="#" target="_blank"
                                        class="font-weight-semibold title-color hover-c1">{{$deal['title']}}</a></td>
                                ...
                                <td>
                                    <form action="{{route('admin.deal.day-status-update')}}" method="post"
                                        id="deal_of_the_day{{$deal['id']}}_form" class="deal_of_the_day_form">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$deal['id']}}">
                                        <label class="switcher">
                                            <input type="checkbox" class="switcher_input"
                                                id="deal_of_the_day{{$deal['id']}}" name="status" value="1" {{
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-10">
                                        ...
                                        <a title="{{ trans ('Delete')}}" class="btn btn-outline-danger btn-sm delete"
                                            id="{{$deal['id']}}">
