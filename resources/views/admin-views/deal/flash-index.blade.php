                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="{{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="title-color font-weight-medium text-capitalize">{{
                                            translate('title')}} ({{strtoupper($lang)}})</label>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('admin.deal.status-update')}}" method="post"
                                        id="flash_deal_status{{$deal['id']}}_form" class="flash_deal_status_form">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$deal['id']}}">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input"
                                                id="flash_deal_status{{$deal['id']}}" name="status"
                                                value="{{ $deal['status'] == 'open' ? 'close':'open' }}" {{
                                                $deal['status']==1?'checked':'' }}
                                                onclick="toogleStatusModal(event,'flash_deal_status{{$deal['id']}}','flash-deal-status-on.png','flash-deal-status-off.png','{{translate('Want_to_Turn_ON_Flash_Deal_Status')}}','{{translate('Want_to_Turn_OFF_Flash_Deal_Status')}}',`<p>{{translate('if_enabled_this_flash_sale_will_be_available_on_the_website_and_customer_app')}}</p>`,`<p>{{translate('if_disabled_this_flash_sale_will_be_hidden_from_the_user_website_and_customer_app')}}</p>`)">
