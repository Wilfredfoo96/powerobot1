                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                ...
                                <span class="badge badge-soft-dark radius-50 fz-12 ml-1">{{ $notifications->total()
                                    }}</span>
                            </h5>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('admin.notification.status')}}" method="post"
                                        id="notification_status{{$notification['id']}}_form"
                                        class="notification_status_form">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$notification['id']}}">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input"
                                                id="notification_status{{$notification['id']}}" name="status" value="1"
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <a class="btn btn-outline-danger btn-sm delete" title="{{translate('delete')}}"
                                            href="javascript:" id="{{$notification['id']}}')">
