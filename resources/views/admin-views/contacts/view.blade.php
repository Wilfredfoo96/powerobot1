                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <textarea class="form-control" name="feedback"
                                            placeholder="{{translate('please_send_a_Feedback')}}">
                                                {{$contact->feedback}}
                                            </textarea>
                                    </div>
                                </div>
                    ...
                    <div class="card-body d-flex flex-column gap-2">
                        <div class="mb-3">
                            ...
                            <div class="flex-start mb-1">
                                <strong class="{{Session::get('direction') === " rtl" ? 'ml-1' : 'mr-1'
                                    }}">{{translate('subject')}}: </strong>
                                <div><strong>{{$contact->subject}}</strong></div>
                            </div>
                            <div class="flex-start">
                                <strong class="{{Session::get('direction') === " rtl" ? 'ml-1' : 'mr-1'
                                    }}">{{translate('message')}}: </strong>
                        ...
                        <div class="row " style="text-align: {{Session::get('direction') === " rtl" ? 'right' : 'left'
                            ...
                            <div class="col-12">
                                <center>
                                    ...
                                    <label
                                        class="badge-soft-danger px-1">{{translate('configure_your_mail_setup_first')}}.</label>
                                </center>
