                    ...
                    <div class="row gy-2">
                        <div class="col-sm-6 col-md-4 d-flex flex-column gap-10">
                            ...
                            <div>{{translate('seller_name')}} :
                                <a class="text-dark" href="{{ route('admin.sellers.view', [$order->seller->id]) }}">
                                    {{$order->seller->f_name . ' '. $order->seller->l_name}}
                                </a>
                            </div>
                            <div>{{translate('seller_email')}} : <a class="text-dark"
                                    href="mailto:{{ $order->seller->email }}">{{$order->seller->email}}</a>
                            </div>
                            <div>{{translate('seller_phone')}} :
                                <a class="text-dark" href="tel:{{ $order->seller->phone }}">{{$order->seller->phone}}
                                </a>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 d-flex flex-column gap-10">
                            ...
                            <div>{{translate('deliveryman_name')}} :
                                ...
                                .$order->delivery_man->l_name:translate('not_assigned')}}</div>
