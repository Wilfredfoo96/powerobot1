            ...
            <form action="{{ route('admin.business-settings.web-config.app-settings-update') }}" method="post">
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        ...
                        json_decode($user_app_version_control['value'], true) : [];
                        $seller_app_version_control = $seller_app_version_control ?
                        json_decode($seller_app_version_control['value'], true) : [];
                        $delivery_man_app_version_control = $delivery_man_app_version_control ?
                        json_decode($delivery_man_app_version_control['value'], true) : [];
                        @endphp
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    <label
                                        class="title-color mb-0">{{translate('minimum_Customer_App_Version')}}</label>
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{translate('the_minimum_customer_app_version_required_for_the_app_functionality') }}">
                                ...
                                <input type="text" class="form-control" name="for_android[version]"
                                    ...
                                    value="{{ $user_app_version_control['for_android']['version'] ?? '' }}">
                            </div>

                            <div class="">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    <label
                                        class="title-color mb-0">{{translate('download_URL_For_Customer_App')}}</label>
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{translate('customers_will_download_the_latest_customer_app_version_using_this_URL') }}">
                                        <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </div>
                                <input type="url" class="form-control" name="for_android[link]"
                                    ...
                                    value="{{ $user_app_version_control['for_android']['link'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="for_ios[version]"
                                    placeholder="{{translate('ex: 2.1')}}" required
                                    value="{{ $user_app_version_control['for_ios']['version'] ?? '' }}">
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="url" class="form-control" name="for_ios[link]"
                                    ...
                                    value="{{ $user_app_version_control['for_ios']['link'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    ...
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{translate('the_minimum_seller_app_version_required_for_the_app_functionality') }}">
                                        <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </div>
                                <input type="hidden" name="for_android[status]" value="1">
                                <input type="text" class="form-control" name="for_android[version]"
                                    placeholder="{{translate('ex: 2.1')}}" required
                                    value="{{ $seller_app_version_control['for_android']['version'] ?? '' }}">
                            </div>
                            ...
                            <div class="">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    ...
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{translate('sellers_will_download_the_latest_seller_app_version_using_this_URL') }}.">
                                        <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </div>
                                <input type="url" class="form-control" name="for_android[link]"
                                    placeholder="{{translate('ex')}} : https://play.google.com/store/apps" required
                                    value="{{ $seller_app_version_control['for_android']['link'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="for_ios[version]"
                                    placeholder="{{translate('ex: 2.1')}}" required
                                    value="{{ $seller_app_version_control['for_ios']['version'] ?? '' }}">
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="url" class="form-control" name="for_ios[link]"
                                    placeholder="{{translate('ex')}} : https://www.apple.com/app-store/" required
                                    value="{{ $seller_app_version_control['for_ios']['link'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    <label
                                        class="title-color mb-0">{{translate('minimum_Deliveryman_App_Version')}}</label>
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{translate('the_minimum_deliveryman_app_version_required_for_the_app_functionality') }}">
                                        <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </div>
                                <input type="hidden" name="for_android[status]" value="1">
                                <input type="text" class="form-control" name="for_android[version]"
                                    placeholder="{{translate('ex: 2.1')}}" required
                                    value="{{ $delivery_man_app_version_control['for_android']['version'] ?? '' }}">
                            </div>

                            <div class="">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    <label
                                        class="title-color mb-0">{{translate('download_URL_For_Deliveryman_App')}}</label>
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{translate('deliverymen_will_download_the_latest_deliveryman_app_version_using_this_URL') }}">
                                        <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </div>
                                <input type="url" class="form-control" name="for_android[link]"
                                    placeholder="{{translate('ex')}} : https://play.google.com/store/apps" required
                                    value="{{ $delivery_man_app_version_control['for_android']['link'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="for_ios[version]"
                                    placeholder="{{translate('ex: 2.1')}}" required
                                    value="{{ $delivery_man_app_version_control['for_ios']['version'] ?? '' }}">
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="url" class="form-control" name="for_ios[link]"
                                    placeholder="{{translate('ex')}} : https://www.apple.com/app-store/" required
                                    value="{{ $delivery_man_app_version_control['for_ios']['link'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/what_app_version.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">{{ translate('what_is_App_Version') }} ?</h4>
                                <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                    <li>{{
                                        translate('this_app_version_means_the_minimum_version_of_Seller_Deliveryman_and_Customer_apps_that_are_required_for_the_update')
                                        }}</li>
                                    <li>{{ translate('it_does_not_represent_the_Play_Store_or_App_Store_version') }}
                                    </li>
                                </ul>
                            </div>
                        </div>
