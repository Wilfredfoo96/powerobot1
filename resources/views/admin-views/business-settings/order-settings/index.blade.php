        ...
        <div class="card-body">
            <form action="{{route('admin.business-settings.order-settings.update-order-settings')}}" method="post"
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="form-group d-flex justify-content-between align-items-center gap-10 form-control">
                            ...
                            <label class="switcher" for="order_verification">
                                <input type="checkbox" value="1" class="switcher_input" name="order_verification"
                                    id="order_verification" {{ $order_Verification==1 ? 'checked' :'' }}
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="d-flex justify-content-between align-items-center gap-10 form-control form-group">
                            <span class="title-color">
                                ...
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                    data-placement="top"
                                    title="{{translate('if_enabled_customers_must_place_at_least_or_more_than_the_order_amount_that_admin_or_sellers_set')}}">
                                    <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                </span>
                            </span>
                            ...
                            <label class="switcher" for="minimum_order_amount_status">
                                <input type="checkbox" value="1" class="switcher_input"
                                    name="minimum_order_amount_status" id="minimum_order_amount_status" {{
                                    $minimum_order_amount_status==1 ? 'checked' :'' }}
                    ...
                    <div class="col-xl-4 col-md-6">
                        ...
                        <div class="d-flex justify-content-between align-items-center gap-10 form-control form-group">
                            <span class="title-color d-flex align-items-center gap-1">
                                ...
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                    data-placement="top"
                                    title="{{translate('if_enabled_the_billing_address_will_be_shown_on_the_checkout_page')}}">
                                    <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                </span>
                            </span>

                            <label class="switcher" for="billing_input_by_customer">
                                <input type="checkbox" value="1" class="switcher_input" name="billing_input_by_customer"
                                    id="billing_input_by_customer" {{$billing_input_by_customer==1?'checked':''}}
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="d-flex justify-content-between align-items-center gap-10 form-control form-group">
                            ...
                            <label class="switcher" for="free_delivery_status">
                                <input type="checkbox" value="1" class="switcher_input" name="free_delivery_status"
                                    id="free_delivery_status" {{$free_delivery==1?'checked':''}}
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="form-group">
                            <label class="title-color d-flex"
                                for="free_delivery_responsibility">{{translate('free_Delivery_Responsibility')}}
                            </label>
                            <select name="free_delivery_responsibility" id="free_delivery_responsibility"
                                class="form-control  js-select2-custom">
                                <option value="admin" {{ $free_delivery_responsibility=='admin' ? 'selected' :'' }}>{{
                                    translate('admin') }}</option>
                                <option value="seller" {{ $free_delivery_responsibility=='seller' ? 'selected' :'' }}>{{
                    ...
                    <div class="col-xl-4 col-md-6"
                        style="{{ $free_delivery_responsibility == 'seller'? 'display:none':''}}"
                        id="free_delivery_over_amount_admin_area">
                        <div class="form-group">
                            <label class="title-color d-flex align-items-center gap-2"
                                for="free_delivery_over_amount_seller">
                                {{translate('free_Delivery_Over')}} ({{\App\CPU\BackEndHelper::currency_symbol()}})
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                    data-placement="top"
                                    title="{{translate('free_delivery_over_amount_for_every_seller_if_they_do_not_set_any_range_yet')}}">
                                    <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                </span>
                            </label>
                            <input type="number" class="form-control" min="0" name="free_delivery_over_amount_seller"
                                id="free_delivery_over_amount_seller"
                                placeholder="{{translate('ex')}} : {{translate('10')}}"
                                value="{{ \App\CPU\Convert::default($free_delivery_over_amount_seller) ?? 0 }}">
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="form-group">
                            <label class="title-color" for="refund_day_limit">{{translate('Refund_Order_Validity')}}
                                ({{translate('days')}})</label>
                            <input type="text" class="form-control" name="refund_day_limit" id="refund_day_limit"
                                placeholder="{{translate('ex')}} : {{translate('10')}}"
                                value="{{ $refund_day_limit ?? 0 }}">
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="d-flex justify-content-between align-items-center gap-10 form-control form-group">
                            ...
                            <label class="switcher" for="guest_checkout">
                                <input type="checkbox" value="1" class="switcher_input" name="guest_checkout"
                                    id="guest_checkout" {{$guest_checkout==1?'checked':''}}
