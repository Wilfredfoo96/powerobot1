                    ...
                    <div class="row gy-4 gx-xl-4">
                        <div class="col-lg-6 col-xl-5">
                            ...
                            <div class="card">
                                <div class="p-3 px-xl-4 py-sm-5">
                                    <img width="76" class="mb-4" src="{{asset('/assets/back-end/img/logo.png')}}"
                                        alt="">
                                    ...
                                    <img src="{{asset('/assets/back-end/img/new-store.png')}}" alt=""
                                    ...
                                    <div class="d-flex gap-4 justify-content-center align-items-center mb-3 fz-16">
                                        <a href="https://pinterest.com/" target="_blank"><i
                                                class="tio-pinterest-circle"></i></a>
                        ...
                        <div class="col-lg-6 col-xl-7">
                            ...
                            <div class="d-flex align-items-center gap-2 mb-3">
                                <img width="20" src="{{asset('/assets/back-end/img/header-content.png')}}" alt="">
                                <h5 class="mb-0">Header Content</h5>
                            </div>
                            <div class="bg-light p-3 rounded mb-3">
                                <div class="form-group">
                                    <label for="main_title" class="title-color">Main Title</label>
                                    <input type="text" id="main_title" name="main_title" placeholder="Ex: Main Title"
                                        class="form-control">
                                </div>
                            ...
                            <div class="bg-light p-3 rounded mb-3">
                                <p>Product Information will be automatically bind from database. If you don’t want to
                                    see the information in the mail. just turn the switch button off.</p>
                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="button_name" name="button_name"
                                                placeholder="Ex: Submit" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="d-flex align-items-center gap-2 mb-2">
                                                <label for="redirect_link" class="title-color mb-0">Redirect
                                                    Link</label>
                                            ...
                                            <input type="text" id="redirect_link" name="redirect_link"
                                                placeholder="Ex: www.google.com" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-light p-3 rounded mb-3">
                                <p>Order Information will be automatically bind from database. If you don’t want to see
                                    the information in the mail. just turn the switch button off.</p>
                            </div>
                            ...
                            <div class="bg-light p-3 rounded mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="section_text" name="section_text" placeholder="Ex: Submit"
                                        class="form-control">
                                </div>
                                <div class="mb-5">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center gap-3">
                                        <div class="form-check text-left">
                                            ...
                                            <label class="form-check-label text-dark" for="privacy_policy">Privacy
                                                Policy</label>
                                        </div>
                                        <div class="form-check text-left">
                                            <input type="checkbox" class="form-check-input" id="refund_policy">
                                            <label class="form-check-label text-dark" for="refund_policy">Refund
                                                Policy</label>
                                        </div>
                                        <div class="form-check text-left">
                                            <input type="checkbox" class="form-check-input" id="cancelation_policy">
                                            <label class="form-check-label text-dark"
                                                for="cancelation_policy">Cancelation Policy</label>
                                        </div>
                                        <div class="form-check text-left">
                                            <input type="checkbox" class="form-check-input" id="contact_us">
                                            <label class="form-check-label text-dark" for="contact_us">Contact
                                                Us</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="copyright_content" class="title-color font-weight-bold">Copyright
                                        Content</label>
                                    <input type="text" id="copyright_content" name="copyright_content"
                                        placeholder="Ex: Copyright 2023" class="form-control">
                                </div>
                            </div>
    ...
    <div class="my-5">
        ...
        <div class="row gy-4">
                    ...
                    <div class="p-3 px-xl-4 py-sm-5">
                        <div class="text-center">
                            <img width="160" class="mb-4"
                                src="{{asset('/assets/back-end/img/email-template/change-pass.png')}}" alt="">
                            <h3 class="mb-3">Change password request </h3>
                        </div>
                        <p><b>Hi Sabrina,</b></p>
                        <p>Please click <a href="#">Here</a> or click the link below to change your password</p>
                        <p>Click here <br> <a
                                href="https://6ammart/changepasswordi357092349-38505320">https://6ammart/changepasswordi357092349-38505320</a>
                        </p>
                        <hr>
                        <p>Please contact us for any queries, we’re always happy to help. </p>
                        <p>Thanks & Regards, <br> 6amMart</p>
                        ...
                        <div class="d-flex justify-content-center mb-3">
                            <img width="76" src="{{asset('/assets/back-end/img/logo.png')}}" alt="">
                        </div>
                        <div class="d-flex justify-content-center gap-2">
                            <ul class="list-inline gap-3">
                                <li><a href="#" class="text-dark">Privacy Policy</a></li>
            ...
            <div class="col-xl-4 col-md-6">
                ...
                <div class="card">
                    <div class="p-3 px-xl-4 py-sm-5">
                        <img width="76" class="mb-4" src="{{asset('/assets/back-end/img/logo.png')}}" alt="">
                        <h3 class="mb-3">New Store Registration Request</h3>
                        <p>Hi Admin,</p>
                        <p><b>Morning Mart</b> has requested to open their store in 6amMart. </p>
                        <p>Review their request from admin panel.</p>
                        <img src="{{asset('/assets/back-end/img/new-store.png')}}" alt="" class="mt-4 mb-3 w-100">
                        <p>Click on the button below to review the request</p>
                        <button class="btn btn--primary rounded-0 px-5">See Registration Request</button>
                        <hr>
                        <p>Please contact us for any queries, we’re always happy to help. </p>
                    ...
                    <div class="p-3 px-xl-4 py-sm-5">
                        <div class="text-center">
                            <img width="100" class="mb-4"
                                src="{{asset('/assets/back-end/img/email-template/store-withdraw.png')}}" alt="">
                            <h3 class="mb-3">New Withdraw Request From Morning Mart</h3>
                            <p>Transaction # 453876934ce76538 </p>
                            <p><span class="text-primary">Morning Mart</span> has requested to withdraw money from their
                                balance</p>
...
<div class="modal fade" id="readInstructionModal" tabindex="-1" aria-labelledby="readInstructionModal"
    aria-hidden="true">
                ...
                <div class="swiper mySwiper pb-3">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/email-template/1.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Select Theme</h4>
                                <p class="text-center"> Choose a related email template theme for the purpose for which
                                    you are creating the email.</p>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/email-template/5.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Choose Logo</h4>
                                <p class="text-center">Upload your company logo in 1:1 format. This will show above the
                                    Main Title of the email.</p>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/email-template/2.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Write a Title</h4>
                                <p class="text-center">Give your email a ‘Catchy Title’ to help the reader understand
                                    easily.</p>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/email-template/3.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Write a message in the Email Body</h4>
                                <p class="text-center">You can add your message using placeholders to include dynamic
                                    content. Here are some examples of placeholders you can use:</p>
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/email-template/4.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Add Button & Link</h4>
                                <p class="text-center">Specify the text and URL for the button that you want to include
                                    in your email.</p>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                ...
                                <p class="text-center">Choose the relevant banner image for the email theme you use for
                                    this mail.</p>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/email-template/6.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Add Content to Email Footer</h4>
                                <p class="text-center">Write text on the footer section of the email and choose
                                    important page links and social media links.</p>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/email-template/7.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Create a copyright notice</h4>
                                <p class="text-center">Include a copyright notice at the bottom of your email to protect
                                    your content.</p>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/email-template/8.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Save and publish</h4>
                                <p class="text-center">Once you ve set up all the elements of your email template save
                                    and publish it for use.</p>
                                <button class="btn btn-primary px-10 mt-3" data-dismiss="modal">{{ translate('Got_It')
                                    }}</button>
                            </div>
                        </div>
                    </div>
