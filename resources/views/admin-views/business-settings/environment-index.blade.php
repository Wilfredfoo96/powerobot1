                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ env('APP_MODE') != 'demo' ? env('DB_CONNECTION') : '---' }}"
                                name="db_connection" class="form-control" placeholder="{{ translate('ex') }} : mysql"
                                required disabled>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ env('APP_MODE') != 'demo' ? env('DB_PORT') : '---' }}"
                                name="db_port" class="form-control" placeholder="{{ translate('ex') }} : 3306" required
                                disabled>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ env('APP_MODE') != 'demo' ? env('DB_DATABASE') : '---' }}"
                                name="db_database" class="form-control" placeholder="{{ translate('ex') }} : demo_db"
                                required disabled>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ env('BUYER_USERNAME') }}" class="form-control"
                                placeholder="6valley-admin-demo-jhisdfhisufjifjfijqw5467" disabled>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="form-group" id="purchase_code_div">
                            ...
                            <div class="input-icons">
                                <input type="password" value="{{ env('PURCHASE_CODE') }}" class="form-control"
                                    id="purchase_code" placeholder="00000000000000" disabled>
                            </div>
                        </div>
                    </div>
                </div>
