                ...
                <form
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between gap-2 align-items-center mb-3">
                            ...
                            <div
                                class="text-primary d-flex align-items-center gap-3 font-weight-bolder mb-2 text-capitalize">
                        ...
                        <div class="bg-white rounded-bottom overflow-hidden mb-4">
                            <div class="border rounded border-color-c1 px-4 py-3 d-flex justify-content-between">
                                <h5 class="mb-0 d-flex gap-1 c1">
                                    {{translate('turn')}} {{translate(isset($config) &&
                                    $config['status']==1?'OFF':'ON')}}
                                </h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label
                                        class="title-color font-weight-bold d-flex">{{translate('secret_Key')}}</label>
                        ...
                        <ol class="pl-4 instructions-list">
                            ...
                            <li>{{translate('copy_Site_Key_and_Secret_Key,_Paste_in_the_input_filed_below_and_Save.')}}
                            </li>
                        </ol>
