            ...
            <div class="col-md-12 mb-3">
                <div class="card">
                    <div class="card-header justify-content-between">
                        ...
                        <span onclick="addThisFeaturesCard_middle()" class="btn btn--primary"><i
                                class="tio-add pr-2"></i>{{ translate('add_New') }}</span>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                name="features_section_middle[title][]" value="{{ $item->title }}"
                                                required placeholder="{{ translate('type_your_title_text') }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="title">{{ translate('sub_Title') }}</label>
                                            <textarea class="form-control" name="features_section_middle[subtitle][]"
                                                required
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="title">{{ translate('title') }}</label>
                                            <input type="text" class="form-control"
                                                name="features_section_middle[title][]" value="" required
                                                placeholder="{{ translate('type_your_title_text') }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="title">{{ translate('sub_Title') }}</label>
            ...
            <div class="col-md-12 mb-3">
                <div class="card">
                    <div class="card-header justify-content-between">
                        ...
                        <span onclick="addThisFeaturesCard_bottom()" class="btn btn--primary"><i
                                class="tio-add pr-2"></i>{{ translate('add_New') }}</span>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-sm-12 col-md-3 mb-4">
                                <div class="card">
                                    <div class="card-header align-items-center justify-content-between">
                                        ...
                                        <span
                                            class="cursor-pointer text-danger remove_icon_box_with_titles btn btn-outline-danger btn-sm square-btn"
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" disabled value="{{ $item->title }}"
                                                name="icontitle" placeholder="{{ translate('type_your_title_text') }}">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-2 d-flex">
                                            <div class="custom_img_upload aspect-ratio-3-15">
                                                <img id="pre_img_header_logo{{ $card_index }}"
                                                    src="{{asset('storage/banner')}}/{{$item->icon}}"
                            ...
                            <div class="col-sm-12 col-md-3 mb-4 removeThisFeaturesCard_div">
                                <div class="card">
                                    <div class="card-header align-items-center justify-content-between">
                                        ...
                                        <div class="cursor-pointer removeThisFeaturesCard_class">
                                            <span
                                                class="btn btn-outline-danger btn-sm square-btn btn btn-outline-danger btn-sm square-btn">
                                                <i class="tio-delete"></i>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="title">{{ translate('title') }}</label>
                                            <input type="text" class="form-control"
                                                name="features_section_bottom[title][]" value="" required
                                                placeholder="{{ translate('type_your_title_text') }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="title">{{ translate('Sub_Title') }}</label>
                                            <textarea class="form-control" name="features_section_bottom[subtitle][]"
                                                required
                                                placeholder="{{ translate('type_your_subtitle_text') }}"></textarea>
                                        </div>
                                        ...
                                        <div class="custom_upload_input">
                                            <input type="file" name="features_section_bottom_icon[]"
                                                class="custom-upload-input-file aspect-ratio-3-15" id=""
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2">
                                                <img id="pre_img_header_logo" class="h-auto aspect-ratio-3-15 bg-white"
