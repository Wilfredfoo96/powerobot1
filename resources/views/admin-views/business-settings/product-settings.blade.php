...
<div class="content container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.product-settings.update-product-settings') }}" method="post"
                        ...
                        <div class="form-group">
                            <div class="d-flex gap-2">
                                ...
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                    ...
                                    title="{{translate('set_the_stock_limit_for_the_Reorder_level')}}
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                <span class="title-color">
                                    ...
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{translate('if_enabled_sellers_can_sell_digital_products') }} ({{ translate('software') }}, {{ translate('ebooks') }}, {{ translate('activation_keys') }}, JPG, PNG, etc.) {{ translate('in_their_shops') }}">
                                        <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </span>

                                <label class="switcher" for="digital_product">
                                    <input type="checkbox" class="switcher_input" value="1" name="digital_product"
                                        id="digital_product" {{ $digital_product ? 'checked' :'' }}
                                        onclick="toogleModal(event,'digital_product','digital-product-on.png','digital-product-off.png','{{translate('want_to_Turn_ON_Digital_Product')}}?','{{translate('want_to_Turn_OFF_Digital_Product')}}?',`<p>{{translate('if_enabled_sellers_can_sell_digital_products_in_their_shops')}}</p>`,`<p>{{translate('if_disabled_sellers_can_not_sell_digital_products_in_their_shops')}}</p>`)">
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="product_brand">
                                    <input type="checkbox" class="switcher_input" value="1" name="product_brand"
                                        id="product_brand" {{ $brand ? 'checked' :'' }}
