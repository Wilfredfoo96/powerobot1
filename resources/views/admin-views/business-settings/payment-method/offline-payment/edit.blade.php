    ...
    <form action="{{ route('admin.business-settings.payment-method.offline.update') }}" method="POST"
        ...
        <div class="card mt-3">
            <div class="card-header gap-2 flex-wrap">
                ...
                <a href="javascript:" onclick="add_input_fields_group()" class="btn btn--primary text-capitalize"><i
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="input_data[]" class="form-control"
                                    ...
                                    required value="{{ $item['input_data'] }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                    ...
                                    <div class="form-check text-start mb-3">
                                        ...
                                        <label class="form-check-label text-dark" for="{{ $cRandomNumber+1 }}">
                                            <input type="checkbox" class="form-check-input" id="{{ $cRandomNumber+1 }}"
                                                name="is_required[{{ $key }}]" {{ (isset($item['is_required']) &&
                                                $item['is_required'])==1 ? 'checked' :'' }}> {{ translate('is_Required')
                                            }} ?
                                        </label>
                                    </div>
