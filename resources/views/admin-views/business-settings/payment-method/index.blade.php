                            ...
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="cash_on_delivery">
                                    <input type="checkbox" class="switcher_input" name="cash_on_delivery"
                                        ...
                                        `<p>{{translate('if_disabled_the Cash_on_Delivery_payment_method_will_be_hidden_from_the_checkout_page')}}</p>`)" id="cash_on_delivery" value="1"
                                        {{$cash_on_delivery['status']==1?'checked':''}}>
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="digital_payment">
                                    <input type="checkbox" class="switcher_input" name="digital_payment"
                                        ...
                                        `<p>{{translate('if_disabled_Digital_Payment_options_will_be_hidden_from_the_checkout_page')}}</p>`)" id="digital_payment" value="1"
                                        {{$digital_payment['status']==1?'checked':''}}>
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="offline_payment">
                                    <input type="checkbox" class="switcher_input" name="offline_payment"
                                        ...
                                        `<p>{{translate('if_disabled_customers_have_to_use_the_system-added_payment_gateways')}}</p>`)" id="offline_payment" value="1"
                                        {{$offline_payment['status']==1?'checked':''}}>
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
            ...
            <div class="card">
                <form action="{{route('admin.business-settings.payment-method.addon-payment-set')}}" method="POST"
                    ...
                    <div class="card-header d-flex flex-wrap align-content-around">
                        ...
                        @php($additional_data = $payment['additional_data'] != null ?
                        json_decode($payment['additional_data']) : [])
                        ...
                        <label class="switcher show-status-text">
                            <input class="switcher_input" type="checkbox" name="status" value="1"
                                onclick="paymentMethodStatusModal(event,'{{$payment->key_name}}','{{ $img_path }}',
                                    ...
                                    `<p>{{translate('if_disabled_this_payment_method_will_be_hidden_from_the_checkout_page')}}</p>`)" id="{{$payment->key_name}}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group" style="margin-bottom: 10px">
                            <label for="exampleFormControlInput1" class="form-label">{{ucwords(str_replace('_','
                                ',$key))}}</label>

                            <div class="d-flex">
                                <span class="form-control" id="id_paystack">{{ url('/')
                                    }}/payment/paystack/callback</span>
                                <span class="btn btn--primary text-nowrap" onclick="copyToClipboard('#id_paystack')"><i
                        ...
                        <div class="form-group" style="margin-bottom: 10px">
                            <label for="exampleFormControlInput1" class="form-label">{{translate('Choose_Logo')}}
                            </label>
