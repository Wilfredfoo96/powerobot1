                ...
                <div class="card-body">
                    <div class="row gy-4">
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="card">
                                <form
                                    action="{{ route('admin.business-settings.company-reliability.store',['item'=>$value->item]) }}"
                                    ...
                                    <div class="card-header align-items-center justify-content-between">
                                        <span class="title-color">
                                            ...
                                            <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                                data-placement="top"
                                                title="{{translate('if_enabled,_the_'.$value->item.'_will_be_available_on_the_system.')}}.">
                                        ...
                                        <label class="switcher" for="{{$value->item}}">
                                            ...
                                            `<p>{{translate('if_disabled_the_'.$value->item.'_will_be_hidden_from_customer')}}</p>`)" id="{{$value->item}}" value="1"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="custom_upload_input">
                                            <input type="file" name="image"
                                                class="custom-upload-input-file aspect-ratio-3-15"
                                                data-imgpreview="pre_img_header_logo{{$key}}"
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2">
                                                <img id="pre_img_header_logo{{$key}}"
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="submit"
                                            class="btn btn--primary mb-3 mx-4 px-3 text-uppercase">{{translate('save')}}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
