...
<div class="content container-fluid">
    ...
    <!-- End Inlile Menu -->
    <form action="{{ route('admin.business-settings.otp-setup-update') }}" method="post" enctype="multipart/form-data"
        id="update-settings">
        @csrf
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                        {{translate('OTP_&_login_settings')}}</h5>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="{{$maximum_otp_hit}}" name="maximum_otp_hit"
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" step="0.01" value="{{$otp_resend_time}}" name="otp_resend_time"
                                class="form-control" placeholder="{{translate('ex: 30 ')}}" required>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="{{$temporary_block_time}}" step="0.01"
                                name="temporary_block_time" class="form-control" placeholder="{{translate('ex: 120')}}"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="{{$maximum_login_hit}}"
                                placeholder="{{translate('ex: 5')}}" name="maximum_login_hit" class="form-control"
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" step="0.01" value="{{$temporary_login_block_time}}"
                                placeholder="{{translate('ex: 1210')}}" name="temporary_login_block_time"
