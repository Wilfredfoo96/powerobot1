    ...
    <div class="row" style="margin-top: 20px">
        <div class="col-md-12">
            <div class="alert alert-warning sticky-top" id="alert_box" style="display:none;">
                ...
                {{translate('follow_the_documentation_to_setup_from_app_end')}}, <a
                    ...
                    <form action="{{route('admin.business-settings.web-config.update-language')}}" method="post">
                        ...
                        <div class="form-group">
                            <select name="language[]" id="language" onchange="$('#alert_box').show();"
                                ...
                                class="form-control js-select2-custom country-var-select" required multiple=true>
                        ...
                        <button type="submit" class="btn btn--primary float-right ml-3">{{translate('save')}}</button>
                    </form>
                </div>
            </div>
        </div>
