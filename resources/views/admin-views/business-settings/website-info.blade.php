    ...
    <div class="card mb-3">
        <div class="card-body">
                ...
                <div class="border rounded border-color-c1 px-4 py-3 d-flex justify-content-between mb-1">
                    ...
                    <div class="position-relative">
                        <label class="switcher">
                            <input type="checkbox" class="switcher_input" id="maintenance_mode" {{isset($config) &&
                                $config?'checked':''}}
            ...
            <p>*{{translate('by_turning_the').', "'.
                ...
                {{translate('all_your_apps_and_customer_website_will_be_disabled_until_you_turn_this_mode_OFF')}}.{{translate('only_the_Admin_Panel_&_Seller_Panel_will_be_functional')}}
            </p>
        </div>
    </div>

    <form action="{{ route('admin.business-settings.update-info') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <!-- Company Information -->
        <div class="card mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <select id="country" name="country" class="form-control  js-select2-custom">
                                ...
                                <option value="CD" {{ $cc?($cc=='CD' ?'selected':''):'' }}>Congo, the Democratic
                                    Republic
                                    of the
                                </option>
                                ...
                                <option value="MK" {{ $cc?($cc=='MK' ?'selected':''):'' }}>Macedonia, the former
                                    Yugoslav
                                    Republic of
                                </option>
                                ...
                                <option value="KN" {{ $cc?($cc=='KN' ?'selected':''):'' }}>Saint Kitts and Nevis
                                </option>
                                ...
                                <option value="ST" {{ $cc?($cc=='ST' ?'selected':''):'' }}>Sao Tome and Principe
                                </option>
                                ...
                                <option value="VE" {{ $cc?($cc=='VE' ?'selected':''):'' }}>Venezuela, Bolivarian
                                    Republic
                                    of
                                </option>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="timezone" class="form-control js-select2-custom">
                                ...
                                <option value="America/Los_Angeles" {{$tz?($tz=='America/Los_Angeles'
                                    ?'selected':''):''}}>
                                ...
                                <option value="America/Mexico_City" {{$tz?($tz=='America/Mexico_City'
                                    ?'selected':''):''}}>
                                    (GMT-06:00) Guadalajara, Mexico City, Monterrey
                                </option>
                                <option value="Canada/Saskatchewan" {{$tz?($tz=='Canada/Saskatchewan'
                                    ?'selected':''):''}}>
                                ...
                                <option value="Canada/Newfoundland" {{$tz?($tz=='Canada/Newfoundland'
                                    ?'selected':''):''}}>
                                ...
                                <option value="America/Montevideo" {{$tz?($tz=='America/Montevideo'
                                    ?'selected':''):''}}>
                                ...
                                <option value="Atlantic/Cape_Verde" {{$tz?($tz=='Atlantic/Cape_Verde'
                                    ?'selected':''):''}}>
                                ...
                                <option value="Asia/Yekaterinburg" {{$tz?($tz=='Asia/Yekaterinburg'
                                    ?'selected':''):''}}>
                                ...
                                <option value="Australia/Adelaide" {{$tz?($tz=='Australia/Adelaide'
                                    ?'selected':''):''}}>
                                    (GMT+09:30) Adelaide
                                </option>
                                ...
                                <option value="Australia/Brisbane" {{$tz?($tz=='Australia/Brisbane'
                                    ?'selected':''):''}}>
                                    (GMT+10:00) Brisbane
                                </option>
                                <option value="Australia/Canberra" {{$tz?($tz=='Australia/Canberra'
                                    ?'selected':''):''}}>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="language" class="form-control js-select2-custom">
                                ...
                                <option value="{{ $item->code }}" {{ $item->default == 1?'selected':'' }}>{{ $item->name
                                    }}</option>
                                @endforeach
                                @endif
                            </select>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $business_setting['shop_address'] }}" name="shop_address"
                                class="form-control" placeholder="{{translate('your_shop_address')}}" required>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="currency_id" class="form-control js-select2-custom">
                                ...
                                <option value="{{ $item->id }}" {{ $item->id ==
                                    $business_setting['system_default_currency'] ?'selected':'' }}>
                                    {{ $item->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control form-group d-flex gap-2">
                            ...
                            <div class="custom-control custom-radio flex-grow-1">
                                <input type="radio" class="custom-control-input" value="left"
                                    ...
                                    $business_setting['currency_symbol_position']=='left' ? 'checked' :'' }}>
                            ...
                            <div class="custom-control custom-radio flex-grow-1">
                                <input type="radio" class="custom-control-input" value="right"
                                    ...
                                    $business_setting['currency_symbol_position']=='right' ? 'checked' :'' }}>
                                <label class="custom-control-label" for="currency_position_right">{{translate('right')}}
                        ...
                        <div class="form-control form-group d-flex gap-2">
                            ...
                            <div class="custom-control custom-radio flex-grow-1">
                                <input type="radio" class="custom-control-input" value="email"
                                    name="forgot_password_verification" id="verification_by_email" {{
                                    $business_setting['forgot_password_verification']=='email' ? 'checked' :'' }}>
                                <label class="custom-control-label"
                            ...
                            <div class="custom-control custom-radio flex-grow-1">
                                <input type="radio" class="custom-control-input" value="phone"
                                    name="forgot_password_verification" id="verification_by_phone" {{
                                    $business_setting['forgot_password_verification']=='phone' ? 'checked' :'' }}>
                                <label class="custom-control-label" for="verification_by_phone">{{translate('phone
                                    (OTP)')}}</label>
                            </div>
                            <!-- End Custom Radio -->
                        </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="email_verification"
                                    ...
                                    <input type="checkbox" class="switcher_input" name="email_verification"
                                        id="email_verification" value="1" {{ $business_setting['email_verification']==1
                                        ? 'checked' :'' }}>
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="otp_verification"
                                    ...
                                    <input type="checkbox" class="switcher_input" name="phone_verification"
                                        id="otp_verification" value="1" {{ $phone_verification==1 ? 'checked' :'' }}>
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
            ...
            <div class="card-body">
                <div class="row gy-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-2 mb-2">
                                ...
                                <label class="switcher" for="app_store_download_status"
                                    ...
                                    <input type="checkbox" value="1" class="switcher_input"
                                        name="app_store_download_status" id="app_store_download_status" {{
                                        $app_store_download['status']==1 ? 'checked' :'' }}>
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        @php($play_store_download =
                        \App\CPU\Helpers::get_business_settings('download_app_google_stroe'))
                        ...
                        <div class="bg-aliceblue p-3 rounded">
                            <div class="d-flex justify-content-between align-items-center gap-2 mb-2">
                                ...
                                <label class="switcher" for="play_store_download_status"
                                    ...
                                    <input type="checkbox" value="1" class="switcher_input"
                                        name="play_store_download_status" id="play_store_download_status" {{
                                        $play_store_download['status']==1 ? 'checked' :'' }}>
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                    ...
                    <div class="card-body d-flex flex-wrap gap-4 justify-content-around">
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-center">
                                <div class="title-color mb-4 mt-3">{{ strtoupper($business_setting['primary_color']) }}
                                </div>
                        ...
                        <div class="form-group">
                            <input type="color" name="secondary" value="{{ $business_setting['secondary_color'] }}"
                                class="form-control form-control_color">
                            <div class="text-center">
                                <div class="title-color mb-4 mt-3">{{ strtoupper($business_setting['secondary_color'])
                                    }}</div>
                        ...
                        <div class="form-group">
                            <input type="color" name="primary_light"
                                ...
                                class="form-control form-control_color">
                            <div class="text-center">
                                <div class="title-color mb-4 mt-3">{{ $business_setting['primary_color_light'] ??
                                    '#CFDFFB' }}</div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body d-flex flex-column justify-content-around">
                        ...
                        <div class="mt-4 position-relative">
                            <input type="file" name="company_web_logo" id="customFileUploadWL" class="custom-file-input"
            ...
            <div class="col-xxl-4 col-sm-6 mb-3">
                <div class="card h-100">
                    ...
                    <div class="card-body d-flex flex-column justify-content-around">
                        ...
                        <div class="position-relative mt-4">
                            <input type="file" name="company_fav_icon" id="customFileUploadFI" class="custom-file-input"
                                accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                            <label class="custom-file-label"
