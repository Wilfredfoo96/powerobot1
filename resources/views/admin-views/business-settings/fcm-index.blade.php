        ...
        <div class="card-body">
            <form action="{{route('admin.business-settings.update-fcm')}}" method="post"
                ...
                <div class="row d--none">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$project_id}}" name="fcm_project_id" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                {{-- <div class="form-group">
                    ...
                    <textarea name="api_key" id="api_key" class="form-control" rows="1"
                        placeholder="{{translate('Ex: abcd1234efgh5678ijklmnop90qrstuvwxYZ')}}" required></textarea>
                </div>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="fcm_project_id" id="fcm_project_id" class="form-control"
                                placeholder="{{translate('Ex: my-awesome-app-12345')}}">
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="form-group">
                            <label for="auth_domain" class="title-color">{{translate('auth_domain')}}</label>
                            <input type="text" name="auth_domain" id="auth_domain" class="form-control"
                                placeholder="{{translate('Ex: my-awesome-app.firebaseapp.com')}}">
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="form-group">
                            <label for="storage_bucket" class="title-color">{{translate('storage_bucket')}}</label>
                            <input type="text" name="storage_bucket" id="storage_bucket" class="form-control"
                                placeholder="{{translate('Ex: my-awesome-app.appspot.com')}}">
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="form-group">
                            <label for="messaging_sender_id"
                                class="title-color">{{translate('messaging_sender_id')}}</label>
                            <input type="text" name="messaging_sender_id" id="messaging_sender_id" class="form-control"
                                placeholder="{{translate('Ex: 1234567890')}}">
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="api_id" id="api_id" class="form-control"
                                placeholder="{{translate('Ex: 9876543210')}}">
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="form-group">
                            <label for="measurement_ID" class="title-color">{{translate('measurement_ID')}}</label>
                            <input type="text" name="measurement_ID" id="measurement_ID" class="form-control"
                                placeholder="{{translate('Ex: F-12345678')}}">
                        </div>
                    </div>
                </div> --}}
                ...
                <div class="d-flex gap-3 justify-content-end">
                    ...
                    <button type="submit" onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
                ...
                <div class="swiper mySwiper pb-3">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/firebase-console.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Go to Firebase Console</h4>
                                <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                    <li>Open your web browser and go to the Firebase Console <br> ( <span
                                            class="text-decoration-underline">https://console.firebase.google.com/</span>
                                        ).</li>
                                    <li>Select the project for which you want to configure FCM from the Firebase Console
                                        dashboard.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/navigate-settings.png')}}" loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Navigate to Project Settings</h4>
                                <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                    <li>In the left-hand menu, click on the "Settings" gear icon, and then select
                                        "Project settings" from the dropdown.</li>
                                    <li>In the Project settings page, click on the "Cloud Messaging" tab from the top
                                        menu.</li>
                                </ul>
                            </div>
                        </div>
                        {{-- <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center text-center gap-2">
                                <img width="80" class="mb-3" src="{{asset('/assets/back-end/img/file.png')}}"
                                    loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Please Visit the Docs to Set FCM on Mobile Apps</h4>
                                <p>Please check the documentation below for detailed instructions on setting up your
                                    mobile app to receive Firebase Cloud Messaging (FCM) notifications.</p>

                                <div class="d-flex justify-content-center">
                                    <a href="#"
                                        class="btn-link text-decoration-underline">{{translate('click_here')}}</a>
                                </div>
                            </div>
                        </div> --}}
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3" src="{{asset('/assets/back-end/img/info-asked.png')}}"
                                    loading="lazy" alt="">
                                <h4 class="lh-md mb-3">Obtain All The Information Asked!</h4>
                                <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                    <li>In the Firebase Project settings page, click on the "General" tab from the top
                                        menu.</li>
                                    <li>Under the "Your apps" section, click on the "Web" app for which you want to
                                        configure FCM.</li>
                                    <li>Then Obtain API Key, FCM Project ID, Auth Domain, Storage Bucket, Messaging
                                        Sender ID.</li>
                                </ul>
                                <p>Note: Please make sure to use the obtained information securely and in accordance
                                    with Firebase and FCM documentation, terms of service, and any applicable laws and
                                    regulations.</p>
