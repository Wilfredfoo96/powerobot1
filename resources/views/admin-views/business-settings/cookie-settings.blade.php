            ...
            <div class="border-bottom py-3 px-4">
                <div class="d-flex justify-content-between align-items-center gap-10">
                    ...
                    <label class="switcher" for="cookie_setting_status"
                        ...
                        <input type="checkbox" class="switcher_input" name="status" id="cookie_setting_status"
                            data-section="cookie_setting_status" value="1"
                            {{isset($data['cookie_setting'])&&$data['cookie_setting']['status']==1?'checked':''}}>
            ...
            <div class="card-body">
                <div class="loyalty-point-section" id="cookie_setting_status_section">
                    <div class="form-group">
                        ...
                        <textarea name="cookie_text" id="" cols="30" rows="6"
                            class="form-control">{{isset($data['cookie_setting']) ? $data['cookie_setting']['cookie_text'] : ''}}</textarea>
                    </div>
