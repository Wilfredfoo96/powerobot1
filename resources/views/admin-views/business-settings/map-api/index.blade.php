...
<div class="content container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{env('APP_MODE')!='demo'?route('admin.business-settings.map-api-update'):'javascript:'}}"
                    ...
                    <div class="btn-group">
                        ...
                        <div
                            ...
                            <p class="title-color font-weight-medium mb-0">{{
                                translate('without_configuring_this_section_map_functionality_will_not_work_properly').'
                                '.translate('thus_the_whole_system_will_not_work_as_it_planned')}}</p>
                        </div>
                    </div>
                </div>

                <div class="mt-2 mb-4 valley-alert">
                    <img width="16" class="mt-1" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                    <p class="mb-0">
                        <strong>{{translate('NB')}}</strong>
                        : {{
                        translate('client_key_should_have_enable_map_javascript_api_and_you_can_restrict_it_with_http_refere').'
                        '.translate('server_key_should_have_enable_place_api_key_and_you_can_restrict_it_with_ip').'
                        '.translate('you_can_use_same_api_for_both_field_without_any_restrictions')}}.
                    </p>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="title-color d-flex">{{translate('map_api_key')}}
