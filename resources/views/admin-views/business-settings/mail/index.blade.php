            ...
            <div class="d-flex flex-wrap justify-content-between gap-3 border-bottom">
                <nav>
                    <div class="nav nav-tabs border-0" id="nav-tab" role="tablist">
                        <a class="nav-link d-flex align-items-center gap-2 active" id="nav-home-tab" data-toggle="tab"
                            ...
                            <div class="card-header">
                                ...
                                <label class="switcher">
                                    <input type="checkbox" name="status" value="1"
                                        ...
                                        `<p>{{translate('disabling_SMTP_mail_configuration_services_stops_email_sending')}}</p>`)" id="mail_config"
                                        {{$data_smtp['status']==1?'checked':''}} class="switcher_input">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="{{translate('ex')}}:{{translate('alex')}}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="{{translate('ex :')}}:{{translate('tls')}}"
                                ...
                                <label class="switcher">
                                    <input type="checkbox" class="switcher_input" name="status"
                                       ...
                                       '{{translate('want_to_Turn_ON_the_sendgrid_mail_configt_option')}}?','{{translate('want_to_Turn_OFF_the_sendgrid_mail_config_option')}}?',
                                        ...
                                        `<p>{{translate('disabling_sendgrid_mail_configuration_services_stops_email_sending')}}</p>`)" id="mail_config_sendgrid" value="1"
                            ...
                            <div class="col-xl-8 col-lg-10">
                                <div class="d-flex align-items-end gap-2 gap-sm-3">
                                    ...
                                    <button type="button" class="btn btn--primary px-sm-5" data-toggle="modal"
                                        data-target="#sendMailConfirmationModal">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3" src="{{asset('/assets/back-end/img/smtp-server.png')}}"
                                    loading="lazy" alt="">
                                <h4 class="lh-md mb-3 text-capitalize">{{translate('find_SMTP_server_details')}}</h4>
                                <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                    <li>{{translate('contact_your_email_service_provider_or_IT_administrator_to_obtain_the_SMTP_server_details_such_as_hostname_port_username_and_password')}}.
                                    </li>
                                    <li>{{translate('note')}}:
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3" src="{{asset('/assets/back-end/img/config-smtp.png')}}"
                                    loading="lazy" alt="">
                                ...
                                <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                    ...
                                    <li>{{translate('enter_the_obtained_SMTP_server_details,_including_the_hostname,_port,_username,_and
                                        password')}}.</li>
                                    <li>{{translate('choose_the_appropriate_encryption_method')}} (e.g., SSL, TLS)
                                        {{translate('if_required')}}.</li>
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2">
                                <img width="80" class="mb-3" src="{{asset('/assets/back-end/img/test-smtp.png')}}"
                                    loading="lazy" alt="">
                                <h4 class="lh-md mb-3 text-capitalize">{{translate('test_SMTP_connection')}}</h4>
                                <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                    <li>{{translate('click_on_the')}} "{{translate('send_test_mail')}}"
                                        {{translate('button_to_verify_the_SMTP_connection')}}.</li>
                                    <li>{{translate('if_successful,_you_will_see_a_confirmation_message_indicating_that_the_connection_is_working_fine')}}.
                                    </li>
                                    <li>{{translate('if_not,_double-check_your_SMTP_settings_and_try_again')}}.</li>
                                    <li>{{translate('note')}}:
                                        {{translate('if_you`re_unsure_about_the_SMTP_settings,_contact_your_email_service_provider_or_IT_administrator_for_assistance')}}.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                <img width="80" class="mb-3"
                                    src="{{asset('/assets/back-end/img/enable-mail-config.png')}}" loading="lazy"
                                    alt="">
                                <h4 class="lh-md mb-3 text-capitalize">{{translate('enable_mail_configuration')}}</h4>
                                <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                    <li>{{translate('if_the_SMTP_connection_test_is_successful,_you_can_now_enable_the_mail_configuration_services_by_toggling_the_switch_to_"ON"')}}
                                    </li>
                                    <li>{{translate('this_will_allow_the_system_to_send_emails_using_the_configured_SMTP_settings')}}.
                                    </li>
                                </ul>
                                <button class="btn btn-primary px-10 mt-3 text-capitalize" data-dismiss="modal">{{
                                    translate('got_it') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="sendMailConfirmationModal" tabindex="-1" aria-labelledby="sendMailConfirmationModal"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0 pb-0 d-flex justify-content-end">
            ...
            <div class="modal-body px-4 px-sm-5 pt-0 text-center">
                <div class="d-flex flex-column align-items-center gap-2">
                    <img width="80" class="mb-3" src="{{asset('/assets/back-end/img/send-mail.png')}}" loading="lazy"
                        alt="">
                    <h4 class="lh-md">{{translate('send_a_test_mail_to_your_email')}} ? </h4>
                    <p class="text-muted">{{translate('a_test_mail_will_be_send_to_your_email_to')}} <br>
                        {{translate('confirm_it_works_perfectly')}}.</p>
                    <button type="button" id="text_mail_send"
