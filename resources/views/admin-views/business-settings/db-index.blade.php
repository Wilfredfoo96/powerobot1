...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-12 mb-3">
            <div class="alert badge-soft-danger mb-0 mx-sm-2 {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}"
                role="alert">
                    ...
                    <form action="{{route('admin.business-settings.web-config.clean-db')}}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div
                                    class="form-group form-check {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}">
                                    <input type="checkbox" name="tables[]" value="{{$table}}" class="form-check-input"
                                        id="business_section_{{$key}}">
                                    <label class="form-check-label text-dark" style="{{Session::get('direction') === "
                                        rtl" ? 'margin-right: 1.25rem;' : '' }};"
                                        for="business_section_{{$key}}">{{translate(str_replace('_','
