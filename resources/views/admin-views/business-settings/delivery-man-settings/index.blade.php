                        ...
                        <div class="form-group d-flex justify-content-between align-items-center gap-10 form-control">
                            <span class="title-color">
                                ...
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                    ...
                                    title="{{translate('admin_can_set_whether_deliveryman_needs_to_upload_the_picture_of_delivery_by_enabling_or_disabling_this_button') }}">
                                    <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="">
                                </span>
                            </span>

                            <label class="switcher" for="upload_picture_on_delivery">
                                <input type="checkbox" class="switcher_input" name="upload_picture_on_delivery"
                                    id="upload_picture_on_delivery" {{ ($data && $data->value == 1) ? 'checked':'' }}
                                value="1"
                                onclick="toogleModal(event,'upload_picture_on_delivery','upload-picture-on.png','upload-picture-off.png','{{translate('by_Turning_ON_Picture_Upload_on_Delivery')}}','{{translate('by_Turning_OFF_Picture_Upload_on_Delivery')}}',`
                                <p>{{translate('if_enabled_deliverymen_can_upload_picture_at_the_order_deliveries_time')}}
                                </p>`,`<p>
                                    {{translate('if_enabled_deliverymen_can_not_upload_picture_at_the_order_deliveries_time')}}
                                </p>`)">
