                                ...
                                <div class="swiper mySwiper pb-3">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide mb-2">
                                            <img src="{{asset('assets/back-end/img/slider-1.png')}}" loading="lazy"
                                                alt="" class="dark-support rounded">
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                <img src="{{asset('assets/back-end/img/slider-2.png')}}" loading="lazy"
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                <img src="{{asset('assets/back-end/img/slider-3.png')}}" loading="lazy"
                                                    alt="" class="dark-support rounded mb-4">
                                                <p>
                                                    {{
                                                    translate('now_you’ll_be_successfully_able_to_use_the_theme_for_your')
                                                    }} {{ \App\CPU\Helpers::get_business_settings('company_name') ?? ''
                                                    }} {{ translate('website') }}
                                                </p>
                                                <p>
                                                    {{ translate('N:B you_can_upload_only') }} {{
                                                    \App\CPU\Helpers::get_business_settings('company_name') ?? '' }} {{
                                                    translate('theme_templates') }}.
                                                </p>
                                                <button class="btn btn-primary px-10 mt-3" data-dismiss="modal">{{
        ...
        <div class="card-body pl-md-10">
            ...
            <form enctype="multipart/form-data" id="theme_form">
                ...
                <div class="row g-3">
                    ...
                    @php($condition_one=str_replace('MB','',ini_get('upload_max_filesize'))>=20 &&
                    str_replace('MB','',ini_get('upload_max_filesize'))>=20)
                    @php($condition_two=str_replace('MB','',ini_get('post_max_size'))>=20 &&
                    str_replace('MB','',ini_get('post_max_size'))>=20)
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-end">
                            <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}" class="btn btn--primary px-5"
    ...
    <div class="card mb-5 p-4">
        <div class="card-body">
            ...
            <div class="modal fade" id="read_Before_Change_ThemeModal" tabindex="-1"
                aria-labelledby="read_Before_Change_ThemeModal" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header border-0 pb-0 d-flex justify-content-end">
                            <button type="button" class="btn-close border-0" data-dismiss="modal" aria-label="Close"><i
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                ...
                                                <div class="mb-3 text-center">
                                                    <img width="75" src="{{asset('assets/back-end/img/shift.png')}}"
                                                        alt="">
                                                </div>
                                                ...
                                                <ol class="my-5 text-start">
                                                    <li class="mb-3">{{
                                                        translate('all_the_promotional_banners_from_the_website_and_user_app_will_be_clear_once_the_theme_is_changed.')
                                                        }}{{
                                                        translate('you_have_to_input_all_the_banners_again_for_each_section')
                                                        }}</li>

                                                    <li class="mb-3">{{
                                                        translate('there_may_be_some_features_that_are_not_available_in_other_themes.')
                                                        }}{{
                                                        translate('in_these_cases_you_have_to_setup_data_for_those_features_after_changing_the_theme.')
                                                        }}</li>

                                                    <li class="mb-3">{{
                                                        translate('after_changing_any_theme_in_the_you_will_a_menu_option_with_the_menu_name.')
                                                        }} {{
                                                        translate('Under_this_menu_you_can_setup_all_the_new_features_option_that_are_only_available_for_that_specific_theme.')
                                                        }}{{ translate('you_setup_those_data_from_there.') }}</li>
                                                </ol>
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <img width="100"
                                                        src="{{asset('assets/back-end/img/arrow-right-for-frame.png')}}"
                                                        alt="">
                                                    <img class="w-60"
                                                        src="{{asset('assets/back-end/img/theme-dummy-frame.png')}}"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="swiper-pagination"></div>
            ...
            <div class="row g-1 g-sm-2">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header border-0 pb-0 d-flex justify-content-end">
                                                <button type="button" class="btn-close border-0" data-dismiss="modal"
                                                    aria-label="Close"><i class="tio-clear"></i></button>
                                            </div>
                                            <div class="modal-body px-4 px-sm-5 text-center">
                                                <div class="mb-3 text-center">
                                                    <img width="75" src="{{asset('assets/back-end/img/delete.png')}}"
                                                        alt="">
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-center gap-3 mb-3">
                                                    ...
                                                    <button type="submit" class="fs-16 btn btn-danger px-sm-5"
                                                        data-dismiss="modal" onclick="theme_delete('{{ $key }}')">{{
                                            ...
                                            <div class="modal-body px-4 px-sm-5 text-center">
                                                ...
                                                <div class="d-flex justify-content-center gap-3 mb-3">
                                                    ...
                                                    <button type="button" class="fs-16 btn btn--primary px-sm-5"
                                                        data-dismiss="modal" onclick="theme_publish('{{ $key }}')">{{
                        ...
                        <div class="p-2 p-sm-3">
                            <div class="aspect-ration-3:2 border border-color-primary-light radius-10">
                                <img class="img-fit radius-10"
                                    ...
                                    src="{{ asset('resources/themes/'.$key.'/addon/'.$theme['image']) }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="InformationThemeModal" tabindex="-1" aria-labelledby="shiftThemeModalLabel"
                    aria-hidden="true">
...
<script>
    function notify_all_the_sellers() {
            ...
            $.post({
                ...
                success: function (data) {
                    let message_html = `<img src="{{asset('/assets/back-end/img/notify_success.png')}}" alt="" width="50" class="mb-2">
