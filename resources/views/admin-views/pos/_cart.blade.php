<form action="{{route('admin.pos.order')}}" id='order_place' method="post">
    ...
    ?>
        <div class="pt-4">
            ...
            <div class="form-group col-12">
                <input type="hidden" class="form-control" name="amount" min="0" step="0.01"
                    value="{{\App\CPU\BackEndHelper::usd_to_currency($total+$total_tax-$coupon_discount)}}" readonly>
            </div>
            <div class="pt-4 mb-4">
        ...
        <div class="d-flex gap-2 justify-content-between align-items-center pt-3 bottom-sticky-btns">
            ...
            <button id="submit_order" type="button" class="btn btn--primary btn-block m-0" data-toggle="modal"
                data-target="#paymentModal" onclick="form_submit()">
