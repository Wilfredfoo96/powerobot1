                        ...
                        <div class="text-sm-right">
                            ...
                            <div class="d-flex flex-column gap-2 mt-3">
                                ...
                                <div class="order-status d-flex justify-content-sm-end gap-10 text-capitalize">
                                    ...
                                    <span
                                        class="badge color-caribbean-green-soft font-weight-bold radius-50 d-flex align-items-center py-1 px-2">{{translate(str_replace('_','
                                    ...
                                    <span
                                        ...
                                        {{translate(str_replace('_',' ',$order['order_status'] == 'processing' ?
                                        'Packaging' : $order['order_status']))}}
                                    </span>
                                ...
                                'pay_by_wallet' && !isset($order->offline_payments))
                                <div class="reference-code d-flex justify-content-sm-end gap-10 text-capitalize">
                                    ...
                                    <strong>{{str_replace('_',' ',$order['transaction_ref'])}} {{ $order->payment_method
                                        == 'offline_payment' ? '('.$order->payment_by.')':'' }}</strong>
                                </div>
                                @endif
                                        ...
                                        <div class="modal-content">
                                            <form action="{{ route('admin.orders.digital-file-upload-after-sell') }}"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @endif
                                                    @if(($product_details->added_by == 'admin') && $detail->seller_id ==
                                                    1)
                                                    <div class="inputDnD">
                                                        <div class="form-group inputDnD input_image input_image_edit rounded-lg"
                                                    ...
                                                    <h4 class="mt-3 text-center">
                                                        {{translate('admin_have_no_permission_for_sellers_digital_product_upload')}}
                                                    </h4>
                                                    @endif
                                                </div>
                    ...
                    <ul class="list-unstyled list-unstyled-py-4">
                        <li>
                            ...
                            <label class="font-weight-bold title-color fz-14">
                                ...
                                ({{$order->shipping ? translate(str_replace('_',' ',$order->shipping->title))
