                    ...
                    <tr>
                            ...
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">
                                        {{translate('duration')}}</th>
                                    <td class="p-0" style="padding: 3px 0;text-transform:capitalize">: {{ $duration }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">
                                ...
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">{{translate('status')}}
                                    </th>
                                    <td class="p-0" style="padding: 3px 0">:
                                        {{ $status }}
                                    </td>
                        ...
                        <td class="p-0 text-left">
                            <table>
                                ...
                                <tr>
                                    <th class="bold black p-0 text-left">{{translate('seller_Order')}}</th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        {{ $data['seller_orders'] }}
                                    </td>
                                </tr>
