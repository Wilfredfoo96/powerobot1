                            ...
                            <form action="{{ url()->current() }}" method="GET">
                                <div class="input-group input-group-custom input-group-merge">
                                    ...
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                        placeholder="{{ translate('search_by_name')}}" aria-label="Search by ID or name"
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('admin.brand.export',['search'=>request('search')]) }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('admin.brand.status-update')}}" method="post"
                                            id="brand_status{{$b['id']}}_form" class="brand_status_form">
                                            @csrf
                                            <input type="hidden" name="id" value="{{$b['id']}}">
                                            <label class="switcher mx-auto">
                                                <input type="checkbox" class="switcher_input"
                                                    id="brand_status{{$b['id']}}" name="status" value="1" {{
                                                    $b['status']==1 ? 'checked' :'' }}
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a class="btn btn-outline-danger btn-sm delete square-btn"
                                                title="{{ translate('delete')}}" id="{{$b['id']}}">
