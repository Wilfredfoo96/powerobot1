                    ...
                    <div class="position-relative">
                        <label class="switcher"
                            ...
                            <input type="checkbox" class="switcher_input" id="temporary_close"
                                {{$temporary_close['status']==1?'checked':''}}>
        ...
        <div class="card-body">
            <div class="d-flex flex-wrap gap-3 justify-content-between mb-4">
                <div class="d-flex flex-column gap-1">
                    ...
                    <p class="mb-0">{{translate('created_at')}} {{ date('d M, Y', strtotime($admin['updated_at']) )}}
                    </p>
                </div>
            ...
            <div class="pt-10 rounded bg-position-center bg-soft-secondary"
                data-bg-img="{{asset('storage/shop')}}/{{\App\CPU\Helpers::get_business_settings('shop_banner')}}">
                <div class="media flex-wrap align-items-end gap-3 p-2">
                    <div class="bg-white rounded py-4 px-5 shadow-lg">
                        <img width="80"
                            ...
                            onerror="this.src='{{asset('assets/back-end/img/image-place-holder.png')}}'" alt="">
                    </div>
                    <div class="media-body">
                        <div class="d-flex flex-column align-items-start gap-1 mb-3">
                            <h3 class="text-white fz-24">{{\App\Model\BusinessSetting::where(['type' =>
                                'company_name'])->pluck('value')[0]}} {{translate('shop')}}</h3>
                    ...
                    <div class="bg-white rounded border">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-mg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" class="form-control" name="minimum_order_amount"
                                            id="minimum_order_amount" placeholder="{{translate('ex')}}: 10"
                                            value="{{\App\CPU\Convert::default($minimum_order_amount) }}">
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="col-lg-4 col-mg-6">
                                    <div class="form-group">
                                        <label class="title-color d-flex" for="free_delivery_over_amount">{{
                                            translate('free_Delivery_Over_Amount') }} ({{
                                            \App\CPU\BackEndHelper::currency_symbol() }})</label>
                                        <input type="number" min="0" class="form-control"
                                            name="free_delivery_over_amount" id="free_delivery_over_amount"
                                            placeholder="{{translate('ex')}}: 10"
                                            value="{{\App\CPU\Convert::default($free_delivery_over_amount) }}">
                                    </div>
                                </div>
                                @endif
                            </div>
                ...
                <form action="{{route('admin.product-settings.vacation-add')}}" method="post">
                    <div class="modal-header border-bottom pb-2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="switcher">
                                    <input type="checkbox" name="status" class="switcher_input" id="vacation_close"
                                        {{$vacation['status']==1?'checked':''}}>
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="vacation_start_date"
                                    value="{{ $vacation['vacation_start_date'] }}" id="vacation_start_date"
                                    class="form-control" required>
                            </div>
                            <div class="col-md-6">
                                <label>{{translate('vacation_End')}}</label>
                                <input type="date" name="vacation_end_date" value="{{ $vacation['vacation_end_date'] }}"
                            ...
                            <div class="col-md-12 mt-2 ">
                                ...
                                <textarea class="form-control" name="vacation_note"
                                    id="vacation_note">{{ $vacation['vacation_note'] }}</textarea>
                            </div>
                        </div>
