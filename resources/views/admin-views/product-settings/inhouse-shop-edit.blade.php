                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative mt-4">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="shop_banner" id="BannerUpload" class="custom-file-input"
                        ...
                        <div class="col-lg-6 form-group">
                            <center>
                                <img class="upload-img-view upload-img-view__banner" id="viewerBottomBanner"
                                    onerror="this.src='{{asset('assets/back-end/img/400x400/img2.jpg')}}'"
                                    src="{{asset('storage/shop')}}/{{\App\CPU\Helpers::get_business_settings('bottom_banner')}}"
                                    alt="banner image" />
                            </center>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="bottom_banner" id="BottomBannerUpload"
                                        ...
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="BottomBannerUpload">{{translate('Upload')}}
                                        {{translate('secondary')}} {{translate('Banner')}}</label>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="col-lg-6 form-group">
                            <center>
                                <img class="upload-img-view upload-img-view__banner" id="viewerOfferBanner"
                                    onerror="this.src='{{asset('assets/back-end/img/400x400/img2.jpg')}}'"
                                    src="{{asset('storage/shop')}}/{{\App\CPU\Helpers::get_business_settings('offer_banner')}}"
                                    alt="banner image" />
                            </center>
                            ...
                            <div class="mt-4">
                                <div class="d-flex gap-1 align-items-center title-color mb-2">
                                    ...
                                    <span class="text-info">({{translate('ratio')}}
                                        {{translate('7')}}:{{translate('1')}})</span>
                                </div>

                                <div class="custom-file">
                                    <input type="file" name="offer_banner" id="OfferBannerUpload"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="OfferBannerUpload">{{translate('Upload')}}
                                        {{translate('Offer')}} {{translate('Banner')}}</label>
                                </div>
                            </div>
                        </div>
                        @endif
