            ...
            <form action="{{route('admin.profile.update',[$data->id])}}" method="post" enctype="multipart/form-data"
                ...
                <div class="card mb-3 mb-lg-5" id="generalDiv">
                    ...
                    <div class="profile-cover">
                        @php($shop_banners = $shop_banner ? asset('storage/shop/'.$shop_banner) :
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            <label for="firstNameLabel" class="col-sm-3 col-form-label input-label">
                                {{translate('full_name')}}
                                <i class="tio-help-outlined text-body ml-1" title="{{ translate('display_name') }}">
                                </i>
                            </label>
                        ...
                        <!-- Form Group -->
                        <div class="row form-group">
                            <label for="phoneLabel" class="col-sm-3 col-form-label input-label">{{translate('phone')}}
                                <span class="input-label-secondary">({{translate('optional')}})</span></label>
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel"
                                    ...
                                    value="{{$data->phone}}" data-hs-mask-options='{
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control" name="email" id="newEmailLabel"
                                    value="{{$data->email}}" placeholder="{{translate('enter_new_email_address')}}"
                                    aria-label="Enter new email address">
                            </div>
                        </div>
                        <div class="row">
                            <label for="newEmailLabel"
                                class="col-sm-3 input-label">{{translate('profile_Image')}}</label>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" onclick="{{env('APP_MODE')!='demo'?"
                                form_alert('admin-profile-form','Want to update admin info ?')":"call_demo()"}}"
            ...
            <div id="passwordDiv" class="card mb-3 mb-lg-5">
                ...
                <div class="card-body">
                    ...
                    <form id="changePasswordForm" action="{{route('admin.profile.settings-password')}}" method="post"
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" onclick="{{env('APP_MODE')!='demo'?"
                                form_alert('changePasswordForm','Want to update admin password ?')":"call_demo()"}}"
                                class="btn btn--primary">{{translate('save_changes')}}</button>
                        </div>
                    </form>
                    <!-- End Form -->
