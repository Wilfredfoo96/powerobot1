                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-example-responsive form-control w-100" name="banner_type" required
                                        ...
                                        <option value="Main Banner" {{$banner['banner_type']=='Main Banner'
                                            ?'selected':''}}>{{ translate('main_Banner')}}</option>
                                        <option value="Popup Banner" {{$banner['banner_type']=='Popup Banner'
                                            ?'selected':''}}>{{ translate('popup_Banner')}}</option>

                                        @if(theme_root_path() != 'theme_fashion')
                                        <option value="Footer Banner" {{$banner['banner_type']=='Footer Banner'
                                        ...
                                        <option value="Header Banner" {{$banner['banner_type']=='Header Banner'
                                            ?'selected':''}}>{{ translate('header_Banner')}}</option>
                                        <option value="Sidebar Banner" {{$banner['banner_type']=='Sidebar Banner'
                                            ?'selected':''}}>{{ translate('sidebar_Banner')}}</option>
                                        <option value="Top Side Banner" {{$banner['banner_type']=='Top Side Banner'
                                            ?'selected':''}}>{{ translate('top_Side_Banner')}}</option>
                                        @endif
                                        @if(theme_root_path() == 'theme_fashion')
                                        <option value="Promo Banner Left" {{$banner['banner_type']=='Promo Banner Left'
                                            ?'selected':''}}>{{ translate('promo_banner_left')}}</option>
                                        <option value="Promo Banner Middle Top"
                                            {{$banner['banner_type']=='Promo Banner Middle Top' ?'selected':''}}>{{
                                            translate('promo_banner_middle_top')}}</option>
                                        <option value="Promo Banner Middle Bottom"
                                            {{$banner['banner_type']=='Promo Banner Middle Bottom' ?'selected':''}}>{{
                                            translate('promo_banner_middle_bottom')}}</option>
                                        <option value="Promo Banner Right"
                                            {{$banner['banner_type']=='Promo Banner Right' ?'selected':''}}>{{
                                            translate('promo_banner_right')}}</option>
                                        <option value="Promo Banner Bottom"
                                            {{$banner['banner_type']=='Promo Banner Bottom' ?'selected':''}}>{{
                                ...
                                <div class="form-group">
                                    ...
                                    <select onchange="display_data(this.value)"
                                        ...
                                        <option value="product" {{$banner['resource_type']=='product' ?'selected':''}}>
                                            {{ translate('product') }}</option>
                                        <option value="category" {{$banner['resource_type']=='category'
                                            ?'selected':''}}>{{ translate('category') }}</option>
                                        <option value="shop" {{$banner['resource_type']=='shop' ?'selected':''}}>{{
                                            translate('shop') }}</option>
                                ...
                                <div class="form-group mb-0" id="resource-brand"
                                    ...
                                    <select class="js-example-responsive form-control w-100" name="brand_id">
                                        ...
                                        <option value="{{$brand['id']}}"
                                            {{$banner['resource_id']==$brand['id']?'selected':''}}>{{$brand['name']}}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div>
                                    <center class="mx-auto">
                                        <div class="uploadDnD">
                                            <div class="form-group inputDnD input_image input_image_edit"
                                                style="background-image: url('{{asset('storage/banner')}}/{{$banner['photo']}}')"
                                                data-title="{{ file_exists('storage/banner/'.$banner['photo']) ? '': 'Drag and drop file or Browse file'}}">
                                    ...
                                    <label for="name" class="title-color text-capitalize">
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                            ...
                                            data-original-title="{{translate('banner_image_ratio_is_not_same_for_all_sections_in_website').' '.translate('Please_review_the_ratio_before_upload')}}">
