...
@section('title', translate('seller_product_sale_Report'))
                ...
                <div class="row gx-2 gy-3 align-items-center text-left">
                    <div class="col-sm-6 col-md-3">
                        <select class="js-select2-custom form-control" name="seller_id">
                            <option value="all">{{translate('all_sellers')}}</option>
    ...
    <div class="store-report-content mb-2">
        ...
        <div class="center-chart-area">
            ...
            <canvas id="updatingData" class="store-center-chart" data-hs-chartjs-options='{
                ...
                [{ "label" : "{{translate('total_order_amount')}}" , "data" : [{{ '"' .implode('","', $chart_val).'"'
                }}], "backgroundColor" : "#a2ceee" , "hoverBackgroundColor" : "#0177cd" , "borderColor" : "#a2ceee" }]
                }, "options" : { "scales" : { "yAxes" : [{ "gridLines" : { "color" : "#e7eaf3" , "drawBorder" :
                false, "zeroLineColor" : "#e7eaf3" }, "ticks" : { "beginAtZero" : true, "fontSize" : 12, "fontColor"
                : "#97a4af" , "fontFamily" : "Open Sans, sans-serif" , "padding" : 5, "postfix"
                ...
                <form action="{{ url()->full() }}" method="GET" class="mb-0">
                    ...
                    <div class="input-group input-group-merge input-group-custom">
                        ...
                        <input id="datatableSearch_" type="search" value="{{ $search }}" name="search"
                            class="form-control" placeholder="Search by shop" aria-label="Search orders" required="">
                ...
                <table id="datatable" style="text-align: {{Session::get('direction') === " rtl" ? 'right' : 'left' }};"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{
                                \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($order->total_order_amount))
                                }}</td>
                            <td>{{
                                \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($order->total_admin_commission))
                                }}</td>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('admin.sellers.view', [$order->seller_id]) }}"
