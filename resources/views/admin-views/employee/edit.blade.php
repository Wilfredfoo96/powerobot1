                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="identify_type">
                                        <option value="" selected disabled>{{translate('select_identify_type')}}
                                        </option>
                                        <option value="nid" {{$e->identify_type == 'nid' ?'selected' :
                                            ''}}>{{translate('NID')}}</option>
                                        <option value="passport" {{$e->identify_type == 'passport' ?'selected' :
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="identify_number" value="{{$e->identify_number}}"
                                        class="form-control" placeholder="{{translate('ex')}} : 9876123123">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="text-center mb-3">
                                        <img class="upload-img-view" id="viewer"
                                            ...
                                            src="{{asset('storage/admin')}}/{{$e['image']}}" alt="Product thumbnail" />
                                    </div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="password" class="title-color">{{translate('password')}}</label><small> (
                                        {{translate('input_if_you_want_to_change')}} )</small>
