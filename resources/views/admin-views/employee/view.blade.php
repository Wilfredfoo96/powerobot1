                    ...
                    <div class="media align-items-center flex-wrap flex-sm-nowrap gap-3">
                        ...
                        <div class="media-body">
                            ...
                            <ul class="d-flex flex-column gap-3 px-0">
                                ...
                                {{-- <li class="d-flex gap-2 align-items-center">
                                    <i class="tio-poi"></i>
                                    <span class="text-dark">Avenue-10, House# 12, Road# 12, Mirpur <br> DOHS, Dhaka -
                                        1216</span>
                                </li> --}}
                                ...
                                <li class="d-flex gap-2 align-items-center">
                                    ...
                                    <span class="text-dark text-uppercase">
                                        {{$employee->identify_type}} -
                                        {{isset($employee->identify_number)?$employee->identify_number:
                                        translate('identify_number_not_found')}}</span>
                                </li>
                                @endif
                            </ul>
                        </div>
                    ...
                    <div class="bg-primary-light rounded p-3">
                        <div class="bg-white rounded p-3">
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <span class="text-dark">{{translate('join')}}:
                                    {{date('d/m/Y',strtotime($employee->created_at))}}</span>
                            </div>
                        </div>
                            ...
                            <div class="d-flex justify-content-between gap-3">
                                <div class="d-flex flex-column gap-4">
                                    <div class="d-flex gap-2 align-items-center">
                                        ...
                                        <h6 class="text-dark mb-0 text-capitalize">{{translate('access_abailable')}}:
                                        </h6>
                                    </div>
                                    @if (isset($employee->role))
                                    <div class="tags d-flex gap-2 flex-wrap">
                                        @foreach (json_decode($employee->role->module_access) as $key=>$value)
                                        <span class="badge bg-primary-light text-capitalize">{{str_replace('_' ,'
                                            ',$value)}}</span>
                                        @endforeach
                                    </div>
                                    @endif
                                ...
                                <a href="{{route('admin.employee.update',[$employee['id']])}}">
                                    <i class="tio-edit" data-toggle="tooltip" data-placement="top"
                                        title="{{translate('you_can_create_or_edit_role_form_employee_role_setup')}}"></i>
                                </a>
                            </div>
                        </div>
                    </div>
