                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            ...
                            <a class="btn p-0"
                                ...
                                <img class="img-thumbnail mb-2" src="{{asset('assets/back-end/img/folder.png')}}"
                                    alt="">
                                <p class="title-color">{{Str::limit($file['name'],10)}}</p>
                            </a>
                            @elseif($file['type']=='file')
                            <!-- <a class="btn" href="{{asset('storage/app/'.$file['path'])}}" download> -->
                            <button class="btn p-0 w-100" data-toggle="modal" data-target="#imagemodal{{$key}}"
                                title="{{$file['name']}}">
                                <span
                                    class="d-flex flex-column justify-content-center gallary-card aspect-1 overflow-hidden border rounded">
                                    <img src="{{asset('storage/app/'.$file['path'])}}" alt="{{$file['name']}}"
                                        class="h-auto w-100">
                                </span>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <img src="{{asset('storage/app/'.$file['path'])}}" class="w-100 h-auto"
                                                alt="">
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-info" onclick="copy_test('{{$file['db_path']}}')"><i
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{translate('upload_File')}} </h5>
                    ...
                    <form action="{{route('admin.file-manager.image-upload')}}" method="post"
                        ...
                        <div class="form-group">
                            <input class="btn btn--primary" type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}" value="{{translate('upload')}}">
                        </div>
                    </form>
