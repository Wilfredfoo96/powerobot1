                ...
                <div class="col-md-auto mb-3 mb-md-0">
                    <div class="d-flex align-items-center">
                        <img class="avatar avatar-xxl avatar-4by3 {{Session::get('direction') === " rtl" ? 'ml-4'
                            : 'mr-4' }}" onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                            src="{{asset('storage/delivery-man')}}/{{$delivery_man['image']}}" alt="Image Description">
                        <div class="d-block">
                ...
                <div class="col-md">
                    <ul class="list-unstyled list-unstyled-py-2 mb-0">
                        ...
                        <li class="d-flex align-items-center font-size-sm">
                            <span class="{{Session::get('direction') === " rtl" ? 'ml-3' : 'mr-3' }}">{{translate('5')}}
                                {{ translate('star') }}</span>
                        ...
                        <!-- Review Ratings -->
                        <li class="d-flex align-items-center font-size-sm">
                            <span class="{{Session::get('direction') === " rtl" ? 'ml-3' : 'mr-3' }}">{{translate('4')}}
                                {{ translate('star') }}</span>
                            <div class="progress flex-grow-1">
                                <div class="progress-bar" role="progressbar"
                        ...
                        <!-- Review Ratings -->
                        <li class="d-flex align-items-center font-size-sm">
                            <span class="{{Session::get('direction') === " rtl" ? 'ml-3' : 'mr-3' }}">{{translate('3')}}
                                {{ translate('star') }}</span>
                            <div class="progress flex-grow-1">
                                <div class="progress-bar" role="progressbar"
                        ...
                        <!-- Review Ratings -->
                        <li class="d-flex align-items-center font-size-sm">
                            <span class="{{Session::get('direction') === " rtl" ? 'ml-3' : 'mr-3' }}">{{translate('2')}}
                                {{ translate('star') }}</span>
                            <div class="progress flex-grow-1">
                                <div class="progress-bar" role="progressbar"
                        ...
                        <!-- Review Ratings -->
                        <li class="d-flex align-items-center font-size-sm">
                            <span class="{{Session::get('direction') === " rtl" ? 'ml-3' : 'mr-3' }}">{{translate('1')}}
                                {{ translate('star') }}</span>
                            <div class="progress flex-grow-1">
                                <div class="progress-bar" role="progressbar"
                ...
                <div class="col-md-3">
                    <div>
                        <select class="form-control" name="rating">
                            ...
                            <option value="1" {{ $rating==1 ? 'selected' : '' }}>{{ translate('1') }}</option>
                            <option value="2" {{ $rating==2 ? 'selected' : '' }}>{{ translate('2') }}</option>
                            <option value="3" {{ $rating==3 ? 'selected' : '' }}>{{ translate('3') }}</option>
                            <option value="4" {{ $rating==4 ? 'selected' : '' }}>{{ translate('4') }}</option>
                            <option value="5" {{ $rating==5 ? 'selected' : '' }}>{{ translate('5') }}</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-2">
            ...
            <table
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="title-color"
                                href="{{ $review->order_id ? route('admin.orders.details',['id'=>$review->order_id]) : ''}}">{{
                                $review->order_id }}</a>
                        </td>
                        <td>
                            ...
                            <div class="text-wrap">
                                ...
                                <div class="content p-0">
                                    ...
                                    <span id="show-more-{{$review->id}}" data-id="{{$review->id}}"
                                        onclick="toggle_btn(this)">...<a href="javascript:void(0)">{{
                                            translate('show_more') }}</a></span>

                                    <span id="show-more-content-{{$review->id}}" class="show-more-content">
                                        {{substr($review['comment'], 200)}}
                                        <span id="show-less-{{$review->id}}" data-id="{{$review->id}}"
                                            onclick="toggle_btn(this)"><a href="javascript:void(0)">{{
                                                translate('show_less') }}</a></span>
                                        @else
                                        {{ $review['comment'] }}
                                        @endif
                                </div>
