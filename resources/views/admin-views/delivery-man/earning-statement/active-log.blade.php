                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a type="submit" class="dropdown-item d-flex align-items-center gap-2 "
                                            href="{{route('admin.delivery-man.order-history-log-export',['id'=>$delivery_man->id,'type'=>'log','search'=>$search])}}">
                            ...
                            <table
                                ...
                                <tbody id="set-rows">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media align-items-center gap-10 flex-wrap">
                                                <button onclick="test({{ $order->id }})" class="btn btn-info"
                                                    data-toggle="modal" data-target="#exampleModalLong"><i
                                                        class="tio-history"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                    @empty
