            ...
            <div class="row g-2">
                <div class="col-sm-6 col-lg-4">
                    ...
                    <div class="business-analytics">
                        ...
                        <h2 class="business-analytics__title">{{ $total_earn ?
                            \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($total_earn)) :
                            \App\CPU\BackEndHelper::set_symbol(0) }}</h2>
                        <img src="{{ asset('assets/back-end/img/aw.png') }}" width="40" class="business-analytics__img"
                            alt="">
                    </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    ...
                    <div class="business-analytics">
                        ...
                        <h2 class="business-analytics__title">{{ $withdrawable_balance <= 0 ?
                                \App\CPU\BackEndHelper::set_symbol(0) :
                                \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($withdrawable_balance))
                                }}</h2>
                                <img src="{{ asset('assets/back-end/img/pw.png') }}" width="40"
                ...
                <div class="col-sm-6 col-lg-4">
                    ...
                    <div class="business-analytics">
                        ...
                        <h2 class="business-analytics__title">{{ $delivery_man->wallet?
                            \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($delivery_man->wallet->total_withdraw))
                            : \App\CPU\BackEndHelper::set_symbol(0) }}</h2>
                        <img src="{{ asset('assets/back-end/img/withdraw.png') }}" width="40"
                            class="business-analytics__img" alt="">
                    </div>
                            ...
                            <form action="" method="GET">
                                <div class="input-group input-group-merge input-group-custom">
                                    ...
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                        placeholder="{{ translate('search_by_order_no') }}" aria-label="Search orders"
                                        value="{{ $search }}">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a type="submit" class="dropdown-item d-flex align-items-center gap-2 "
                                            href="{{route('admin.delivery-man.order-history-log-export',['id'=>$delivery_man->id,'type'=>'earn','search'=>$search])}}">
                ...
                <div class="col-sm-12 mb-3">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive datatable-custom">
                            <table
                                class="table table-hover table-borderless table-thead-bordered table-align-middle card-table text-left">
