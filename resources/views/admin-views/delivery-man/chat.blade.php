                ...
                <div class="media align-items-center px-3 gap-3 mb-4">
                    <div class="avatar avatar-sm avatar-circle">
                        <img class="avatar-img"
                            ...
                            src="{{asset('storage/admin/')}}/{{auth('admin')->user()->image}}" alt="Image Description">
                    ...
                    <form class="search-form px-3" id="chat-search-form">
                        <div class="search-input-group">
                            ...
                            <input class="" id="myInput" type="text"
                                placeholder="{{translate('search_delivery_man')}}..." aria-label="Search customers...">
                        </div>
                    </form>
                    ...
                    <div class="inbox_chat d-flex flex-column mt-1">
                        ...
                        <div class="list_search">
                            <div class="chat_list p-3 d-flex gap-2 user_{{$chatting->delivery_man_id}} seller-list @if ($key == 0) active @endif"
                                ...
                                onclick="message_view('{{$chatting->delivery_man_id}}')">
                                ...
                                <div class="message-status bg-danger" id="notif-alert-{{ $chatting->delivery_man_id }}">
                                </div>
                                @endif
                            </div>
                        </div>
                                                ...
                                                <div class="col-sm-3 col-md-2 position-relative img_row{{$index}}">
                                                    <a data-lightbox="mygallery" href="{{asset("
                                                        ...
                                                        <img onerror="this.src=' {{asset('assets/back-end/img/image-place-holder.png')}}'"
                                                            src="{{asset('storage/chatting/'.$photo)}}" alt=""
                                                            class="img-fit">
                                                    </a>
                                                </div>
                                                @endforeach
