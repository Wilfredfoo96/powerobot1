...
<div class="content container-fluid">
    ...
    <div class="mb-3">
        <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
            ...
            {{translate('delivery_man')}} <span class="badge badge-soft-dark radius-50 fz-12">{{ $delivery_men->count()
                }}</span>
        </h2>
    </div>
    <!-- End Page Title -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column gap-1">
                                        ...
                                        <a class="title-color hover-c1"
                                            href="tel:+{{$dm['country_code']}}{{$dm['phone']}}">+{{
                                            $dm['country_code'].' '. $dm['phone']}}</a>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('admin.delivery-man.rating', ['id' => $dm['id']]) }}"
                                        ...
                                        <span>{{ isset($dm->rating[0]->average) ? number_format($dm->rating[0]->average,
                                            2, '.', ' ') : 0 }} <i class="tio-star"></i> </span>
                                    </a>
                                </td>
                                <td>

                                    <form action="{{route('admin.delivery-man.status-update')}}" method="post"
                                        id="deliveryman_status{{$dm['id']}}_form" class="deliveryman_status_form">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$dm['id']}}">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input"
                                                id="deliveryman_status{{$dm['id']}}" name="status" value="1" {{
