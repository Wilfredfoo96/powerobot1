...
<div class="content container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-inline_ text-start" action="{{route('admin.currency.system-currency-update')}}"
                method="post">
                @csrf
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name"
                                    placeholder="{{translate('ex')}} : United States Dollar" required>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" max="1000000" name="exchange_rate" step="0.00000001"
                                    class="form-control" id="exchange_rate" placeholder="{{translate('ex')}} : 120"
                                    required>
                            </div>
                        </div>
                        @endif
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{route('admin.currency.status')}}" method="post"
                                        id="currency_status{{$data['id']}}_form" class="currency_status_form">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$data['id']}}">
                                        <label class="switcher">
                                            <input type="checkbox" class="switcher_input"
                                                id="currency_status{{$data['id']}}" name="status"
                                                class="toggle-switch-input" {{$data->status?'checked':''}}
                                            onclick="toogleStatusModal(event,'currency_status{{$data['id']}}','currency-on.png','currency-off.png','{{translate('Want_to_Turn_ON_Currency_Status')}}','{{translate('Want_to_Turn_OFF_Currency_Status')}}',`
                                            <p>{{translate('if_enabled_this_currency_will_be_available_throughout_the_entire_system')}}
                                            </p>`,`<p>
                                                {{translate('if_disabled_this_currency_will_be_hidden_from_the_entire_system')}}
                                            </p>`)">
                                ...
                                <td>
                                    <div class="d-flex gap-10 justify-content-center">
                                        ...
                                        <a title="{{translate('delete')}}" type="button"
                                            class="btn btn-outline-danger btn-sm btn-xs delete" id="{{$data->id}}">
                                            <i class="tio-delete"></i>
                                        </a>
                                        @else
                                        <a href="javascript:" title="{{translate('delete')}}" type="button"
