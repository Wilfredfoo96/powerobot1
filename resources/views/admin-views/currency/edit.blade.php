                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" placeholder="{{translate('currency_Name')}}"
                                        class="form-control" id="name" value="{{$data->name}}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="title-color">{{translate('currency_Symbol')}} :</label>
                                    <input type="text" name="symbol" placeholder="{{translate('currency_Symbol')}}"
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="code" placeholder="{{translate('currency_Code')}}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" min="0" max="1000000" name="exchange_rate" step="0.00000001"
                                        placeholder="{{translate('exchange_Rate')}}" class="form-control"
                                        id="exchange_rate" value="{{$data->exchange_rate}}">
                                </div>
                                @endif
                            </div>
                        </div>
