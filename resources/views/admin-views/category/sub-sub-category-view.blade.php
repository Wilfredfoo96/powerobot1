                        ...
                        <div class="row">
                            ...
                            <div class="col-12 form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                ...
                                <label class="title-color"
                                    for="exampleFormControlInput1">{{translate('sub_sub_category_name')}}<span
                                        class="text-danger">*</span>
                                    ({{strtoupper($lang)}})</label>
                                <input type="text" name="name[]" class="form-control"
                                    placeholder="{{translate('new_Sub_Sub_Category')}}"
                            ...
                            <div class="col-12">
                                <div class="form-group lang_form" id="{{$default_lang}}-form">
                                    <label class="title-color">{{translate('sub_sub_category_name')}}<span
                                            class="text-danger">*</span>
                                        ({{strtoupper($lang)}})</label>
                                    <input type="text" name="name[]" class="form-control"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="cat_id" required>
                                        <option value="" disabled selected>{{translate('select_main_category')}}
                                        </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="title-color text-capitalize"
                                        for="name">{{translate('sub_category_Name')}}<span
