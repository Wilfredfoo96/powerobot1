                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="priority" id="" required>
                                        @for ($i = 0; $i <= 10; $i++) <option value="{{$i}}"
                                            {{$category['priority']==$i?'selected':''}}>{{$i}}</option>
                                            @endfor
                                    </select>
                                </div>
                                <!--image upload only for main category-->
                                @if($category['parent_id']==0 || ($category['position'] == 1 && theme_root_path() ==
                                'theme_aster'))
                                ...
                                <div class="form-group">
                                    <center>
                                        <img class="upload-img-view" id="viewer"
                                            ...
                                            src="{{asset('storage/category')}}/{{$category['icon']}}" alt="" />
                                    </center>
                                </div>
                            </div>
                            @endif
                            @if($category['position'] == 2 || ($category['position'] == 1 && theme_root_path() !=
                            'theme_aster'))
