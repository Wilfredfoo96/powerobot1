                    ...
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-user" id="exampleInputPhone"
                                name="phone" value="{{old('phone')}}" placeholder="{{translate('ex')}}: +09587498"
                                required>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <div class="title-color mb-2 d-flex gap-1 align-items-center">{{translate('seller_Image')}}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <input type="password" class="form-control form-control-user" minlength="8"
                            ...
                            placeholder="{{translate('ex')}} : {{ translate('8+_Character') }}" required>
                        <div class="pass invalid-feedback">{{translate('repeat')}} {{translate('password')}}
                            {{translate('not_match')}} .</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="BottomBannerUpload">{{translate('Upload')}}
                                    {{translate('Bottom')}} {{translate('Banner')}}</label>
                            </div>
                        </div>
                    </div>
                    @endif
