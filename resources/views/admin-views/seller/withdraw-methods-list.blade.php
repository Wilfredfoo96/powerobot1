...
<div class="content container-fluid">
    ...
    <div class="mb-3">
        <div class="page-title-wrap d-flex justify-content-between flex-wrap align-items-center gap-3 mb-3">
            ...
            <a href="{{route('admin.sellers.withdraw-method.create')}}" class="btn btn--primary">+
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="badge badge-success opacity-75 fz-12 border border-white">
                                        ...
                                        <b>{{translate('is_Required')}}:</b> {{ $method_field['is_required'] ?
                                ...
                                <td>
                                    ...
                                    <form action="{{route('admin.sellers.withdraw-method.status-update')}}"
                                        method="post" id="withdrawal_method_status{{$withdrawal_method['id']}}_form"
                                        class="withdrawal_method_status_form">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$withdrawal_method['id']}}">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input"
                                                id="withdrawal_method_status{{$withdrawal_method['id']}}" name="status"
                                                value="1" {{ $withdrawal_method['is_active']==1 ? 'checked' :'' }}
                                ...
                                <td>
                                    <form action="{{route('admin.sellers.withdraw-method.default-status-update')}}"
                                        method="post" id="withdrawal_method_default{{$withdrawal_method['id']}}_form"
                                        class="withdrawal_method_default_form">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$withdrawal_method['id']}}">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input"
                                                id="withdrawal_method_default{{$withdrawal_method['id']}}" name="status"
                                                value="1" {{ $withdrawal_method['is_default']==1 ? 'checked' :'' }}
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <form
                                            action="{{route('admin.sellers.withdraw-method.delete',[$withdrawal_method->id])}}"
