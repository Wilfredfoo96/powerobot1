...
<div class="content container-fluid">
        ...
        <div>
            ...
            <div class="mt-4 pr-2">
                <div class="flex-start">
                    ...
                    <div>
                        <h4>{{translate('seller_request_for_open_a_shop')}}.</h4>
                    </div>
                </div>
    ...
    <div class="page-header">
        <div class="flex-between mx-1 row">
            <div>
                <h1 class="page-header-title">{{ $seller->shop ? $seller->shop->name : translate("shop_Name")." :
                    ".translate("update_Please") }}</h1>
            </div>
    ...
    <div class="row g-3">
        <div class="col-md-6">
            <form action="{{ url()->current() }}" style="text-align: {{Session::get('direction') === " rtl" ? 'right'
                : 'left' }};" method="GET">
                <div class="card">
                    <div class="card-header">
                        ...
                        <label class="switcher" for="commission_status">
                            <input type="checkbox" class="switcher_input" value="1" name="commission_status"
                                id="commission_status" {{ $seller['sales_commission_percentage'] !=null ? 'checked' :''
                                }}
                                onclick="toogleModal(event,'commission_status','general-icon.png','general-icon.png','{{translate('want_to_Turn_ON_Sales_Commission_For_This_Seller')}}?','{{translate('want_to_Turn_OFF_Sales_Commission_For_This_Seller')}}?',`<p>{{translate('if_sales_commission_is_enabled_here_the_this_commission_will_be_applied')}}</p>`,`<p>{{translate('if_sales_commission_is_disabled_here_the_system_default_commission_will_be_applied')}}</p>`)">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" value="{{$seller['sales_commission_percentage']}}" class="form-control"
                                name="commission">
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <label class="switcher" for="gst_status">
                            <input type="checkbox" class="switcher_input" value="1" name="gst_status" id="gst_status" {{
                                $seller['gst'] !=null ? 'checked' :'' }}
                                onclick="toogleModal(event,'gst_status','general-icon.png','general-icon.png','{{translate('want_to_Turn_ON_GST_Number_For_This_Seller')}}?','{{translate('want_to_Turn_OFF_GST_Number_For_This_Seller')}}?',`<p>{{translate('if_GST_number_is_enabled_here_it_will_be_show_in_invoice')}}</p>`,`<p>{{translate('if_GST_number_is_disabled_here_it_will_not_show_in_invoice')}}</p>`)">
                            <span class="switcher_control"></span>
                        </label>
