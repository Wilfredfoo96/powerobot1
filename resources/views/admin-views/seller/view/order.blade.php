            ...
            <div class="row pt-2">
                <div class="col-md-12">
                    <div class="card w-100">
                        ...
                        <!-- Card -->
                        @php($pending_order =
                        App\Model\Order::where(['seller_is'=>'seller'])->where(['seller_id'=>$seller->id])->where('order_status','pending')->where('order_type','default_type')->get())
                        <div class="card-body">
                            <div class="row">
                                ...
                                @php($delivered_order =
                                App\Model\Order::where(['seller_is'=>'seller'])->where(['seller_id'=>$seller->id])->where('order_status','delivered')->where('order_type','default_type')->get())
                                <div class="col-md-4 mb-3 mb-md-0">
                                ...
                                @php($total_order =
                                App\Model\Order::where(['seller_is'=>'seller'])->where(['seller_id'=>$seller->id])->where('order_type','default_type')->get())
                                <div class="col-md-4">
                        ...
                        <div class="table-responsive datatable-custom">
                            <table id="datatable" style="text-align: {{Session::get('direction') === " rtl" ? 'right'
                                : 'left' }};"
                                ...
                                <tbody id="set-rows">
                                    ...
                                    <tr class="status class-all">
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-soft-info fz-12">{{translate('paid')}}</span>
                                            @else
                                        ...
                                        <td class="text-capitalize">
                                            ...
                                            <span class="badge badge-soft-info fz-12">{{translate('confirmed')}}</span>
                                            ...
                                            @else
                                            <span class="badge badge-soft-danger fz-12">{{translate(str_replace('_','
