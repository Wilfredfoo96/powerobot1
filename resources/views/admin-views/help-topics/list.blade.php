                ...
                <div class="card-body px-0">
                    <div class="table-responsive">
                        <table
                            ...
                            id="dataTable" cellspacing="0" style="text-align: {{Session::get('direction') === " rtl"
                            ? 'right' : 'left' }};">
                                ...
                                <tr id="data-{{$help->id}}">
                                    ...
                                    <td>
                                        <form action="{{ route('admin.helpTopic.status', ['id'=>$help['id']])}}"
                                            method="get" id="helpTopic_status{{$help['id']}}_form"
                                            class="helpTopic_status_form">
                                            <label class="switcher mx-auto">
                                                <input type="checkbox" class="switcher_input"
                                                    id="helpTopic_status{{$help['id']}}" {{ $help['status']==1
                                                    ? 'checked' :'' }}
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-10">
                                            <a class="btn btn-outline--primary btn-sm edit" data-toggle="modal"
                                                data-target="#editModal" title="{{ translate('edit')}}"
                                                data-id="{{ $help->id }}">
                                                <i class="tio-edit"></i>
                                            </a>
                                            <a class="btn btn-outline-danger btn-sm delete"
                                                title="{{ translate('delete')}}" id="{{$help['id']}}">
                    ...
                    <div class="modal-body" style="text-align: {{Session::get('direction') === " rtl" ? 'right' : 'left'
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="answer" cols="5" rows="5"
                                placeholder="{{translate('type_Answer')}}"></textarea>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="" method="post" id="editForm" style="text-align: {{Session::get('direction') === " rtl"
                ? 'right' : 'left' }};">
                @csrf
                {{-- @method('put') --}}
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>{{translate('question')}}</label>
                        <input type="text" class="form-control" name="question"
                            placeholder="{{translate('type_Question')}}" id="e_question" class="e_name">
                    </div>
                    ...
                    <div class="form-group">
                        <label>{{translate('answer')}}</label>
                        <textarea class="form-control" name="answer" cols="5" rows="5"
                            placeholder="{{translate('type_Answer')}}" id="e_answer"></textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label for="ranking">{{translate('ranking')}}</label>
