                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4 form-group">
                                ...
                                <select class="form-control" id="coupon_type" name="coupon_type" required>
                                    ...
                                    <option value="discount_on_purchase" {{$c['coupon_type']=='discount_on_purchase'
                                        ?'selected':''}}>{{translate('discount_on_Purchase')}}</option>
                                    <option value="free_delivery" {{$c['coupon_type']=='free_delivery' ?'selected':''}}>
                            ...
                            <div class="col-md-6 col-lg-4 form-group">
                                ...
                                <input type="text" name="code" value="{{$c['code']}}" class="form-control" id="code"
                            ...
                            <div class="col-md-6 col-lg-4 form-group coupon_type first_order">
                                ...
                                <select class="js-example-basic-multiple js-states js-example-responsive form-control"
                                    ...
                                    <option value="{{ $customer->id }}" {{$c['customer_id']==$customer->id ?
                            ...
                            <div class="col-md-6 col-lg-4 form-group first_order">
                                ...
                                <input type="number" name="limit" min="0" value="{{ $c['limit'] }}" id="coupon_limit"
                            ...
                            <div class="col-md-6 col-lg-4 form-group free_delivery">
                                <label for="name" class="title-color text-capitalize">{{translate('discount_Amount')}}
