                    ...
                    <form action="{{route('admin.coupon.store-coupon')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 form-group coupon_by first_order">
                                <label for="name"
                                    class="title-color font-weight-medium d-flex">{{translate('seller')}}</label>
                            ...
                            <div class="col-md-6 col-lg-4 form-group free_delivery">
                                <label for="name"
                                    class="title-color font-weight-medium d-flex">{{translate('discount_Amount')}} <span
                            ...
                            <div class="col-md-6 col-lg-4 form-group">
                                ...
                                <input id="start_date" type="date" name="start_date" value="{{ old('start_date') }}"
                                    class="form-control" placeholder="{{translate('start_date')}}" required>
                            </div>
                            <div class="col-md-6 col-lg-4 form-group">
                                <label for="name"
                                ...
                                <input id="expire_date" type="date" name="expire_date" value="{{ old('expire_date') }}"
                                    class="form-control" placeholder="{{translate('expire_date')}}" required>
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="ml-1">{{translate('used')}}: <strong>{{ $c['order_count']
                                            }}</strong></span>
                                </td>
                                <td>{{ $c['coupon_bearer'] == 'inhouse' ? 'admin':$c['coupon_bearer'] }}</td>
                                <td>
                                    <form action="{{route('admin.coupon.status',[$c['id'],$c->status?0:1])}}"
                                        method="GET" id="coupon_status{{$c['id']}}_form" class="coupon_status_form">
                                        <label class="switcher">
                                            <input type="checkbox" class="switcher_input" id="coupon_status{{$c['id']}}"
                                                name="status" value="1" {{ $c->status == 1 ? 'checked':'' }}
                                            onclick="toogleStatusModal(event,'coupon_status{{$c['id']}}','coupon-status-on.png','coupon-status-off.png','{{translate('Want_to_Turn_ON_Coupon_Status')}}','{{translate('Want_to_Turn_OFF_Coupon_Status')}}',`
                                ...
                                <td>
                                    <div class="d-flex gap-10 justify-content-center">
                                        <button class="btn btn-outline--primary square-btn btn-sm mr-1"
                                            onclick="get_details(this)" data-id="{{ $c['id'] }}" data-toggle="modal"
                                        ...
                                        <form action="{{route('admin.coupon.delete',[$c['id']])}}" method="post"
                                            id="coupon-{{$c['id']}}">
                                            @csrf @method('delete')
                                        </form>
                                    </div>
