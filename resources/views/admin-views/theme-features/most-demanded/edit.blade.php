...
<div class="content container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.most-demanded.update',['id'=>$most_demanded_product->id])}}"
                            ...
                            <div class="col-lg-6">
                                <div class="mb-2">
                                    ...
                                    <select
                                        ...
                                        <option value="{{ $product->id }}" {{$most_demanded_product->product_id ==
                                            $product->id ?'selected':''}}>
                                            {{$product['name']}}
                                        </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    <div class="text-center mt-lg-3">
                                        <img class="border radius-10 ratio-4:1 max-w-655px w-100" id="viewer"
                                            ...
                                            src="{{asset('storage/most-demanded')}}/{{$most_demanded_product['banner']}}"
                                            alt="banner image" />
                                    </div>
                                </div>
                            </div>
