                ...
                <div class="navbar-brand-wrapper justify-content-between side-logo">
                    ...
                    <a class="navbar-brand" href="{{route('seller.dashboard.index')}}" aria-label="Front">
                        ...
                        <img onerror="this.src='{{asset('assets/back-end/img/900x400/img1.jpg')}}'"
                            class="navbar-brand-logo-mini for-seller-logo" src="{{asset(" storage/shop/$shop->image")}}"
                        alt="Logo">
                        @else
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/processing')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['processing'])}}" title="">
                                        ...
                                        <span class="text-truncate">
                                            {{translate('packaging')}}
                                            <span
                                                class="badge badge-soft-warning badge-pill {{Session::get('direction') === "
                                                rtl" ? 'mr-1' : 'ml-1' }}">
                                                {{
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/delivered')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['delivered'])}}" title="">
                                        ...
                                        <span class="text-truncate">
                                            {{translate('delivered')}}
                                            <span
                                                class="badge badge-soft-success badge-pill {{Session::get('direction') === "
                                                rtl" ? 'mr-1' : 'ml-1' }}">
                                                {{
                                    ...
                                    <a class="nav-link" href="{{route('seller.refund.list',['pending'])}}">
                                        ...
                                        <span class="text-truncate">
                                            ...
                                            <span class="badge badge-soft-danger badge-pill ml-1">
                                                ...
                                                $query->where('seller_is',
                                                'seller')->where('seller_id',auth('seller')->id());
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('seller/coupon*')?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{route('seller.coupon.add-new')}}" title="{{translate('coupon')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{route('seller.report.order-report')}}" title="{{translate('order_Report')}}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{Request::is('seller/profile/view') || Request::is('seller/profile/bank-edit/*') ?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
