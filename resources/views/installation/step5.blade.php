...
<div class="pb-2">
    <div class="progress cursor-pointer" role="progressbar" aria-label="6valley Software Installation"
        aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" data-bs-toggle="tooltip" data-bs-placement="top"
        data-bs-custom-class="custom-progress-tooltip" data-bs-title="Final Step!" data-bs-delay='{"hide":1000}'>
            ...
            <div class="bg-light p-4 rounded mb-4">
                <div class="px-xl-2 pb-sm-3">
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="from-group">
                                <label for="first-name" class="d-flex align-items-center gap-2 mb-2">Business
                                    Name</label>
                                <input type="text" id="first-name" class="form-control" name="company_name" required
                                    placeholder="Ex: 6valley">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="from-group">
                                <label for="admin-name" class="d-flex align-items-center gap-2 mb-2">
                                    Admin Name</label>
                                <input type="text" id="admin-name" class="form-control" name="admin_name" required
                        ...
                        <div class="col-md-6">
                            <div class="from-group">
                                <label for="password" class="d-flex align-items-center gap-2 mb-2">Currency
                                    Model</label>
                        ...
                        <div class="col-md-6">
                            <div class="from-group">
                                <label for="password" class="d-flex align-items-center gap-2 mb-2">Admin Password (At
                                ...
                                <div class="input-inner-end-ele position-relative">
                                    ...
                                    <div class="togglePassword">
                                        <img src="{{asset('assets/installation')}}/assets/img/svg-icons/eye.svg" alt=""
                                            class="svg eye">
