...
<div class="pb-2">
    <div class="progress cursor-pointer" role="progressbar" aria-label="6valley Software Installation"
        aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" data-bs-toggle="tooltip" data-bs-placement="top"
        data-bs-custom-class="custom-progress-tooltip" data-bs-title="Fourth Step!" data-bs-delay='{"hide":1000}'>
...
<div class="card mt-4 position-relative">
    ...
    <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
        ...
        @else
        <div class="text-center">
            <a href="{{ route('import_sql') }}" class="btn btn-dark px-sm-5" onclick="showLoder()">Click Here</a>
        </div>
        @endif
