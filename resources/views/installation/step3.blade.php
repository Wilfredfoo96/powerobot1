                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="from-group">
                                <label for="db_host" class="d-flex align-items-center gap-2 mb-2">Database Host</label>
                        ...
                        <div class="col-md-6">
                            <div class="from-group">
                                <label for="db_name" class="d-flex align-items-center gap-2 mb-2">Database Name</label>
                        ...
                        <div class="col-md-6">
                            <div class="from-group">
                                ...
                                <div class="input-inner-end-ele position-relative">
                                    <input type="password" id="db_pass" min="8" autocomplete="new-password"
                                        class="form-control" name="DB_PASSWORD" placeholder="Ex: password"
                                        autocomplete="off">
