...
<div class="content container-fluid">
    ...
    <div class="row my-3 gy-3">
                        ...
                        <div class="mb-3">
                            <label class="title-color" for="minimum_order_amount">{{translate('amount')}}
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                    data-placement="top"
                                    title="{{translate('set_the_minimum_order_amount_a_customer_must_order_from_this_seller_shop')}}">
                            ...
                            <input type="number" step="0.01" class="form-control w-100" id="minimum_order_amount"
                                ...
                                value="{{ \App\CPU\Convert::default($seller->minimum_order_amount) ?? 0 }}"
                                placeholder="0.00">
                        </div>
        ...
        <div
            class="col-sm-12 col-md-6 {{ ($free_delivery_status && $free_delivery_responsibility == 'admin') ? 'd--none':'' }}">
            <form action="{{route('seller.shop.order-settings')}}" method="post" enctype="multipart/form-data"
                id="add_fund">
                @csrf
                <div class="card h-100">
                                ...
                                <div
                                    ...
                                    <label class="switcher" for="free_delivery_status">
                                        <input type="checkbox" class="switcher_input" name="free_delivery_status"
                                            id="free_delivery_status" {{$seller->free_delivery_status ==
                                        1?'checked':''}}
                                        onclick="toogleModal(event,'free_delivery_status','free-delivery-on.png','free-delivery-off.png','{{translate('want_to_Turn_ON_Free_Delivery')}}','{{translate('want_to_Turn_OFF_Free_Delivery')}}',`
                                        <p>{{translate('if_enabled_the_free_delivery_feature_will_be_shown_from_the_system')}}
                                        </p>`,`<p>
                                            {{translate('if_disabled_the_free_delivery_feature_will_be_hidden_from_the_system')}}
                                        </p>`)">
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="form-group">
                                    <label class="title-color d-flex align-items-center gap-2"
                                        ...
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                            data-placement="top"
                                            title="{{ translate('customers_will_get_free_delivery_if_the_order_amount_exceeds_the_given_amount') }} {{ translate('and_the_given_amount_will_be_added_as_seller_expenses') }}">
                                            <img width="16" src="{{asset('/assets/back-end/img/info-circle.svg')}}"
                                                alt="">
                                        </span>
                                    </label>
