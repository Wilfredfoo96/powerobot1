                ...
                <table class="bs-0">
                    <tr>
                        <td class="p-0 text-left">
                            ...
                            <span class="p-0" style="padding: 3px 0;text-transform:capitalize">{{ $data['duration']
                                }}</span>
                            <br><br>
                            <span class="bold black p-0 text-left">{{translate('seller_Info')}}</span> :
                            <span class="p-0" style="padding: 3px 0;text-transform:capitalize">{{ $data['shop_name']
                                }}</span>
                        </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
