                ...
                <table class="bs-0">
                    <tr>
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">
                                        {{translate('order_ID')}}</th>
                                    <td class="p-0" style="padding: 3px 0">: {{ $transaction['order_id'] }}</td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">{{translate('date')}}
                                    </th>
                        ...
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    ...
                                    <td class="p-0" style="padding: 3px 0;">:
                                        @if($transaction->order->delivery_type =='self_delivery' &&
                                        !empty($transaction->order->delivery_man_id))
                                        {{translate('delivery_man')}} {{ $transaction->order->delivery_man->seller_id ==
                                        0 ? 'admin':'seller' }}
                                        @else
                                ...
                                <tr>
                                    ...
                                    <td class="p-0" style="padding: 3px 0;">:
                                        @if(in_array($transaction->order->payment_method, ['cash', 'cash_on_delivery',
                                        'pay_by_wallet', 'offline_payment']))
                    ...
                    <tbody>
                        <tr>
                            <td class="pl-0 pr-0 text-center"
                                style="background-color: #0177CD important; color: white; font-weight: bold">
                                {{translate('SL')}}</td>
                            <td style="background-color: #0177CD important; color: white; font-weight: bold">
                                {{translate('details')}}</td>
                            <td class="text-right"
                                style="background-color: #0177CD important; color: white; font-weight: bold">
                                {{translate('amount')}}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                * $transaction->order_details_sum_qty)) }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(($transaction->order_details_sum_price
                                * $transaction->order_details_sum_qty) - $transaction->order_details_sum_discount -
                                (isset($transaction->order->coupon) && $transaction->order->coupon->coupon_type !=
                                'free_delivery'?$transaction->order->discount_amount:0)))}}
                            </td>
                        </tr>
                        <tr>
        ...
        <tbody class="bs-0 __product-table inter add-info-border-top-bottom">
            <tr>
                ...
                <td class="text-right">
                    ...
                    $transaction->order->discount_type == 'coupon_discount') ? $transaction->order->discount_amount : 0)
