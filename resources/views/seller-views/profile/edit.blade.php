...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <form action="{{route('seller.profile.update',[$data->id])}}" method="post" enctype="multipart/form-data"
                ...
                <div class="card mb-3 mb-lg-5" id="generalDiv">
                    ...
                    <div class="profile-cover">
                        @php($shop_banners = $shop_banner ? asset('storage/shop/banner/'.$shop_banner) :
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" onclick="{{env('APP_MODE')!='demo'?"
                                form_alert('seller-profile-form','Want to update seller info ?')":"call_demo()"}}"
