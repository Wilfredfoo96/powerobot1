                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-6 col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card bank-info-card bg-bottom bg-contain bg-img"
                                style="background-image: url({{asset('/assets/back-end/img/bank-info-card-bg.png')}});">
                                <div class="border-bottom p-3">
                                    <h4 class="mb-0 fw-semibold">{{translate('holder_Name')}} :
                                        <strong>{{$data->holder_name ?? 'No Data found'}}</strong></h4>
                                </div>

                                <div class="card-body position-relative">
                                    <img class="bank-card-img" width="78"
                                        src="{{asset('/assets/back-end/img/bank-card.png')}}" alt="">
                                    ...
                                    <ul class="list-unstyled d-flex flex-column gap-4">
                                        ...
                                        <li>
                                            ...
                                            <div>{{$data->account_no ?? translate('no_data_found')}}</div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
