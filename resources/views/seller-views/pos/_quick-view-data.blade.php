<div class="modal-header p-2">
    ...
    <button class="radius-50 border-0 font-weight-bold text-black-50" type="button" data-dismiss="modal"
        aria-label="Close">
                ...
                <form id="add-to-cart-form">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <div class="color-select d-flex gap-2 flex-wrap" id="option1">
                                ...
                                <input class="btn-check" type="radio" onclick="color_change(this);"
                                    id="{{ $product->id }}-color-{{ $key }}" name="color" value="{{ $color }}"
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        <input class="btn-check" type="radio" id="{{ $choice->name }}-{{ $option }}"
                            ...
                            autocomplete="off">
                        <label class="btn btn-sm check-label border-0 mb-0" for="{{ $choice->name }}-{{ $option }}">{{
                            $option }}</label>
                        @endforeach
                    </div>
                    @endforeach
                    ...
                    <div class="d-flex flex-wrap gap-4 default-quantity-system">
                        ...
                        <div class="d-flex flex-column gap-1 mt-3 title-color" id="chosen_price_div">
                            ...
                            <div class="product-price c1">
                                ...
                                <span class="text-muted fz-10">( {{ translate('tax') }} <span
                                        class="product-tax-show">{{ $product->tax_model == 'include' ? 'incl.' :
                                        \App\CPU\Helpers::currency_converter($product->tax)}}</span> )</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex-wrap gap-4 in-cart-quantity-system d--none">
                        ...
                        <div class="d-flex gap-2 align-items-center mt-3">
                            ...
                            <div class="product-quantity d-flex align-items-center">
                                <div class="d-flex align-items-center">
                                    <span class="product-quantity-group">
                                        <button type="button" class="btn-number in-cart-quantity-minus"
                                            onclick="getVariantForAlreayInCart('minus')">
                                            <i class="tio-remove"></i>
                                        </button>
                                        <input type="text" name="quantity_in_cart"
                                            class="form-control input-number text-center in-cart-quantity-field"
                                            placeholder="1" value="1" min="1" max="100">
                                        <button type="button" class="btn-number in-cart-quantity-plus"
                                            onclick="getVariantForAlreayInCart('plus')">
                                            <i class="tio-add"></i>
                                        </button>
                                    </span>
                                </div>
                        ...
                        <div class="d-flex flex-column gap-1 mt-3 title-color" id="chosen_price_div">
                            ...
                            <div class="product-price c1">
                                ...
                                <span class="text-muted fz-10">( {{ translate('tax') }} {{ $product->tax_model ==
                                    'include' ? 'incl.' : \App\CPU\Helpers::currency_converter($product->tax)}})</span>
                            </div>
                        </div>
                    </div>

                    <div class="d-flex justify-content-center mt-3">
                        <button class="btn btn--primary btn-block quick-view-modal-add-cart-button"
