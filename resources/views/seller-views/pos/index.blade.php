                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <select name="category" id="category" class="form-control js-select2-custom mx-1"
                                        ...
                                        <option value="{{$item->id}}" {{$category==$item->
                                            id?'selected':''}}>{{$item->defaultName}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group d-flex gap-2">
                            ...
                            <select onchange="customer_change(this.value);" id='customer' name="customer_id"
                                data-placeholder="Walking Customer"
                                class="js-example-matcher form-control form-ellipsis">
                                <option value="0" {{ $user_id==0 ? 'selected' :''}}>{{translate('walking_customer')}}
                                </option>
                                @foreach ($customers as $customer)
                                <option value="{{ $customer->id }}" {{ $user_id==$customer->id ? 'selected':''}}>{{
...
<button class="d-none" id="hold-orders-modal-btn" type="button" data-toggle="modal"
    data-target="#hold-orders-modal"></button>
            ...
            <div class="modal-header pt-3 flex-wrap gap-2">
                ...
                <div class="">
                    <div class="search-form">
                        ...
                        <input type="text" class="js-form-search form-control view_all_hold_orders_seach"
                            placeholder="Search...">
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <button class="btn btn--primary" onclick="coupon_discount();" data-dismiss="modal">{{
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <button class="btn btn--primary" onclick="extra_discount()" data-dismiss="modal">{{
                        translate('submit') }}</button>
                </div>
            </div>
        </div>
