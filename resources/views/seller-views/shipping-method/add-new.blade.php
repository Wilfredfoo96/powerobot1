    ...
    <div class="row">
        <div class="col-md-12 ">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 text-capitalize" style="text-align: {{Session::get('direction') === " rtl"
                            ? 'right' : 'left' }};">
                            <select class="form-control text-capitalize" name="shippingCategory"
                                onchange="seller_shipping_type(this.value);">
                        ...
                        <div class="mt-2 mx-3" id="product_wise_note">
                            <p>
                                <img width="16" class="mt-n1" src="{{asset('/assets/back-end/img/danger-info.png')}}"
                                    alt="">
                ...
                <table id="datatable" style="text-align: {{Session::get('direction') === " rtl" ? 'right' : 'left' }};"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('seller.business-settings.shipping-method.status-update')}}"
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    ...
                                    <a class="btn btn-outline-danger btn-sm delete" title="{{translate('delete')}}"
                                        id="{{ $method['id'] }}">
                        ...
                        <form action="{{route('seller.business-settings.category-shipping-cost.store')}}" method="POST">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" class="form-control w-auto" min="0" step="0.01" name="cost[]"
                                        value="{{\App\CPU\BackEndHelper::usd_to_currency($item->cost)}}">
                                </td>
                                <td>
                                    <label class="switcher mx-auto">
                                        <input type="checkbox" name="multiplyQTY[]" class="switcher_input" id=""
