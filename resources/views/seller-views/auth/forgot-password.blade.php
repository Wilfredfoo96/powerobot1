            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    ...
                    <ol class="list-unstyled font-size-md">
                        <li><span class="text-primary mr-2">1.</span>{{translate('fill_in_your_email_address_below.')}}
                        </li>
                        <li><span class="text-primary mr-2">2.</span>{{translate('we_will_send_email you a temporary
                            code.')}}</li>
                        <li><span
                                class="text-primary mr-2">3.</span>{{translate('use_the_code_to_change_your_password_on_our_secure_website.')}}
                        </li>
                    </ol>
