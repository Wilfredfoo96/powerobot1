                ...
                <div class="inbox_people">
                    <form class="search-form px-3" id="chat-search-form">
                        <div class="search-input-group">
                            ...
                            <input class="" id="myInput" type="text" @if(Request::is('seller/messages/chat/customer'))
                                placeholder="{{translate('search_customers')}}..."
                                @elseif(Request::is('seller/messages/chat/delivery-man'))
                                placeholder="{{translate('search_delivery_men')}}..." @endif
                    ...
                    <div class="inbox_chat d-flex flex-column mt-1">
                        ...
                        <div class="list_filter">
                            <div class="chat_list p-3 d-flex gap-2 user_{{$chatting->user_id? $chatting->user_id : $chatting->delivery_man_id}} seller-list @if ($key == 0) active @endif"
                                ...
                                data-phone="{{ $chatting->phone }}" @if (Request::is('seller/messages/chat/customer'))
                                data-image="{{ asset('storage/profile/'.$chatting->image) }}" @else
                                data-image="{{ asset('storage/delivery-man/'.$chatting->image) }}" @endif
                                ...
                                <div class="chat_people media gap-10" id="chat_people">
                                    <div class="chat_img avatar avatar-sm avatar-circle">
                                        <img @if (Request::is('seller/messages/chat/customer'))
                                            src="{{ asset('storage/profile/'.$chatting->image) }}" @else
            ...
            <div class="card card-body card-chat justify-content-between Chat">
                ...
                <div
                    ...
                    <div class="media align-items-center gap-3">
                        <div class="avatar avatar-sm avatar-circle">
                            <img class="avatar-img" id="profile_image" @if
                                (Request::is('seller/messages/chat/customer'))
                                src="{{ asset('storage/profile/'.$chattings_user[0]->image) }}" @else
                        ...
                        <div class="media-body">
                            <h5 class="profile-name mb-1" id="profile_name">{{ $chattings_user[0]->f_name.'
                                '.$chattings_user[0]->l_name }}</h5>
                    ...
                    <div class="inbox_msg">
                        ...
                        <div class="mesgs">
                            <div class="msg_history d-flex flex-column-reverse pr-2" id="show_msg">
                                ...
                                @if ( $message->sent_by_customer? $message->sent_by_customer:
                                $message->sent_by_delivery_man)
                                                ...
                                                <div class="col-sm-3 col-md-2 position-relative img_row{{$index}}">
                                                    <a data-lightbox="mygallery" href="{{asset("
                                                        ...
                                                        <img onerror="this.src=' {{asset('assets/back-end/img/image-place-holder.png')}}'"
                                                            ...
                                                            class="img-fit" alt="VR Collection">
                                                    </a>
                                                </div>
                                                @endforeach
                                            </div>
                                ...
                                <div class="input_msg_write">
                                    <form class="mt-4" id="myForm" enctype="multipart/form-data">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <label
                                                class="py-0 px-3 d-flex align-items-center m-0 cursor-pointer position-absolute top-3">
                                                ...
                                                <input type="file" id="msgfilesValue"
                                                    class="h-100 position-absolute w-100 " hidden multiple
                                                    accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                            </label>
                                            @endif

                                            <textarea class="form-control {{ theme_root_path() == " default" ? 'pl-8'
