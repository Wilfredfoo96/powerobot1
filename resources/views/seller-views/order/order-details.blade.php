                        ...
                        <div class="d-flex flex-column gap-10">
                            ...
                            <div class="d-flex flex-wrap gap-10">
                                <div
                                    ...
                                    {{translate('linked_orders')}} ({{$linked_orders->count()}}) : </div>
                        ...
                        <div class="text-sm-right">
                            <div class="d-flex flex-wrap gap-10 justify-content-end">
                                ...
                                <div class="">
                                    <button class="btn btn--primary px-4" data-toggle="modal"
                                        ...
                                        {{translate('show_locations_on_map')}}</button>
                                </div>
                                @endif
                            ...
                            <div class="d-flex flex-column gap-2 mt-3">
                                ...
                                <div class="order-status d-flex justify-content-sm-end gap-10 text-capitalize">
                                    ...
                                    <span
                                        class="badge color-caribbean-green-soft font-weight-bold radius-50 d-flex align-items-center py-1 px-2">{{str_replace('_','
                                        ', translate($order['order_status']) )}}</span>
                                    @elseif($order['order_status']=='failed')
                                    <span
                                        class="badge badge-danger font-weight-bold radius-50 d-flex align-items-center py-1 px-2">{{str_replace('_','
                                        ', translate('failed_To_Deliver'))}}</span>
                                    @elseif($order['order_status']=='processing' ||
                                    $order['order_status']=='out_for_delivery')
                                    <span
                                        class="badge badge-soft-warning font-weight-bold radius-50 d-flex align-items-center py-1 px-2">{{str_replace('_','
                                        ', $order['order_status'] == 'processing' ? translate('Packaging') :
                                        translate($order['order_status']))}}</span>
                                ...
                                <div class="modal fade" id="fileUploadModal-{{ $detail->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <form action="{{ route('seller.orders.digital-file-upload-after-sell') }}"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <a href="{{ asset('storage/product/digital-product/'.$detail->digital_file_after_sell) }}"
                                                            class="btn btn-success btn-sm" title="Download" download><i
                                                    ...
                                                    <div class="inputDnD form-group input_image"
                                                        ...
                                                        <input type="file" name="digital_file_after_sell"
                                                            ...
                                                            id="inputFile" accept=".jpg, .jpeg, .png, .gif, .zip, .pdf"
                                                            onchange="readUrl(this)"
                                                            data-title="{{translate('drag_&_drop_file_or_browse_file')}}">
                                                    </div>
                                                    <div class="mt-1 text-info">{{translate('file_type')}}: jpg, jpeg,
                                                        png, gif, zip, pdf</div>
                        ...
                        <div class="col-md-9 col-lg-8">
                            <dl class="row gy-1 text-sm-right">
                                ...
                                <dt class="col-5">{{translate('delivery_fee_discount')}} ({{
                                    translate($order['free_delivery_bearer']) }} {{translate('bearer')}})</dt>
                                <dd class="col-6 title-color">
                                    +
                                ...
                                @if($order['coupon_discount_bearer'] == 'inhouse' && !in_array($order['coupon_code'],
                                [0, NULL]))
                                ...
                                <dd class="col-6 title-color">
                                    <strong>{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($total+$shipping-$coupon_discount
                                        -$delivery_fee_discount))}}</strong>
                                </dd>
                            </dl>
                            <!-- End Row -->
                        </div>
                ...
                <div class="card-body text-capitalize d-flex flex-column gap-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center gap-10 form-control flex-wrap h-100">
                        ...
                        <div class="d-flex justify-content-end min-w-100 align-items-center gap-2">
                            <span class="text--primary font-weight-bold">{{ $order->payment_status=='paid' ?
                                translate('paid'):translate('unpaid')}}</span>
                            <label class="switcher payment-status-text">
                                <input class="switcher_input payment_status" type="checkbox" name="status"
                                    value="{{$order->payment_status}}" {{ $order->payment_status=='paid' ?
                                'checked':''}} >
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <label class="font-weight-bold title-color fz-14">
                                {{translate('shipping_method')}} ({{$order->shipping ? $order->shipping->title :
                        ...
                        <li id="choose_delivery_man" class="mt-3 choose_delivery_man">
                            ...
                            <div class="p-2 bg-light rounded mt-4">
                                <div class="media m-1 gap-3">
                                    <img class="avatar rounded-circle"
                                        ...
                                        src="{{asset('storage/profile/'.isset($order->delivery_man->image) ?? '')}}"
                                        alt="Image">
                                    <div class="media-body">
                                        <h5 class="mb-1">{{ isset($order->delivery_man) ? $order->delivery_man->f_name.'
                                            '.$order->delivery_man->l_name :''}}</h5>
                                        <a href="tel:{{isset($order->delivery_man) ? $order->delivery_man->phone : ''}}"
                                            class="fz-12 title-color">{{isset($order->delivery_man) ?
                            ...
                            <div class="p-2 bg-light rounded mt-4">
                                <div class="media m-1 gap-3">
                                    <img class="avatar rounded-circle"
                                        onerror="this.src='{{asset('assets/back-end/img/image-place-holder.png')}}'"
                                        src="{{asset('assets/back-end/img/delivery-man.png')}}" alt="Image">
                                    <div class="media-body">
                        ...
                        <li class="choose_delivery_man mt-3">
                            ...
                            <input type="number" id="deliveryman_charge" onkeyup="amountDateUpdate(this, event)"
                                value="{{ $order->deliveryman_charge }}" name="deliveryman_charge" class="form-control"
                        ...
                        <li class=" mt-3" id="by_third_party_delivery_service_info">
                            <div class="p-2 bg-light rounded mt-4">
                                <div class="media m-1 gap-3">
                                    <img class="avatar rounded-circle"
                                        onerror="this.src='{{asset('assets/back-end/img/image-place-holder.png')}}'"
                                        src="{{asset('assets/back-end/img/third-party-delivery.png')}}" alt="Image">
                                    <div class="media-body">
                                        <h5 class="">{{isset($order->delivery_service_name) ?
                                            $order->delivery_service_name :translate('not_assign_yet')}}</h5>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <div>
                            ...
                            <strong>{{$shipping_address->contact_person_name}}</strong> {{ $order->is_guest ? '('.
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <div>
                            <span>{{translate('name')}} :</span>
                            <strong>{{$billing->contact_person_name}}</strong> {{ $order->is_guest ? '('.
                            translate('guest_customer') .')':''}}
                        </div>
                        <div>
                            <span>{{translate('contact')}} :</span>
                    ...
                    <div class="row gx-2">
                        ...
                        <div class="col-lg-4 col-sm-6 ">
                            <div class="mb-2 mt-2 border-1">
                                <img src="{{asset(" storage/delivery-man/verification-image/".$image->image)}}"
                                class="w-100"
                                onerror="this.src='{{asset('assets/back-end/img/image-place-holder.png')}}'"
                                >
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="phone_number" id="phone_number"
                                        ...
                                        class="form-control" placeholder="{{ translate('ex') }}:32416436546" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="country" id="country" class="form-control">
                                        ...
                                        <option value="{{ $country['name'] }}" {{ isset($shipping_address) &&
                                            $country['name']==$shipping_address->country ? 'selected' : ''}}>{{
                                            $country['name'] }}</option>
                                        @empty
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="city" id="city"
                                        ...
                                        class="form-control" placeholder="{{ translate('ex') }}:{{translate('dhaka')}}"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="zip" class="form-control" data-live-search="true" required>
                                        ...
                                        <option value="{{ $code->zipcode }}" {{isset($shipping_address) && $code->
                                            zipcode == $shipping_address->zip ? 'selected' : ''}}>{{ $code->zipcode }}
                                        </option>
                                        @empty
                            ...
                            <div class="row gx-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="country" id="country" class="form-control">
                                            @forelse($countries as $country)
                                            <option value="{{ $country['name'] }}" {{ isset($billing) &&
                                                $country['name']==$billing->country ? 'selected' : ''}}>{{
                                                $country['name'] }}</option>
                                            @empty
                                            <option value="">{{ translate('No_country_to_deliver') }}</option>
                                            @endforelse
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="zip" class="form-control" data-live-search="true" required>
                                            @forelse($zip_codes as $code)
                                            <option value="{{ $code->zipcode }}" {{isset($billing) && $code->zipcode ==
                                                $billing->zip ? 'selected' : ''}}>{{ $code->zipcode }}</option>
                                            @empty
                                            <option value="">{{ translate('no_zip_to_deliver') }}</option>
                                            @endforelse
                                        </select>
