                ...
                <div class="card-body" style="text-align: {{Session::get('direction') === " rtl" ? 'right' : 'left'
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <button type="button" class="btn btn-success float-{{Session::get('direction') === " rtl"
                                ? 'left' : 'right' }}" data-toggle="modal"
                ...
                <div class="card-body" style="text-align: {{Session::get('direction') === " rtl" ? 'right' : 'left'
                    ...
                    <div class="mt-2">
                        <div class="flex-start">
                            ...
                            <div class="mx-1">
                                <h4>{{$details->delivery_men->bank_name ?? translate('no_data_found')}}</h4>
                            </div>
                        </div>
                        <div class="flex-start">
                            <div>
                            ...
                            <div class="mx-1">
                                <h6>{{$details->delivery_men->branch ?? translate('no_data_found') }}</h6>
                            </div>
                        </div>
                        <div class="flex-start">
                            <div>
                            ...
                            <div class="mx-1">
                                <h6>{{$details->delivery_men->holder_name ?? translate('no_data_found') }}</h6>
                            </div>
                        </div>
                        <div class="flex-start">
                            <div>
                            ...
                            <div class="mx-1">
                                <h6>{{$details->delivery_men->account_no ?? translate('no_data_found') }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
