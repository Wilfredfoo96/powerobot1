...
<div class="modal-body px-4 px-sm-5 text-center">
    ...
    <p class="p-3">
        ...
        {{ translate('we_have_updated_our_website_theme') }}! {{
        translate('please_take_a_moment_to_review_the_changes_in_your_shop.') }}{{
        translate('if_you_come_across_any_image_size_issues_kindly_resize_and_upload_them_to_ensure_a_refreshed_look_for_your_shop.')
        }}
    </p>
    ...
    <div class="d-flex flex-column gap-2 justify-content-center align-items-center" id="notify_all_the_sellers_area">
        <a class="fs-16 btn btn--primary px-sm-5 w-fit-content" target="_blank"
            href="{{ route('shopView',['id'=>$shop->id]) }}">{{ translate('visit_store') }}</a>
    </div>
</div>