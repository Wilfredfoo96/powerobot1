    ...
    <div class="coupon__details-left">
        ...
        <div class="coupon-info">
            <div class="coupon-info-item">
                ...
                <strong
                    id="min_purchase">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($coupon->min_purchase))}}</strong>
            </div>
            ...
            <div class="coupon-info-item" id="max_discount_modal_div">
                ...
                <strong
                    id="max_discount">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($coupon->max_discount))}}</strong>
            </div>
            @endif
            <div class="coupon-info-item">
            ...
            <div class="coupon-info-item">
                ...
                <span id="expire_date">{{ $coupon->coupon_bearer == 'inhouse' ? translate('admin') :
                    translate($coupon->coupon_bearer) }}</span>
            </div>
        </div>
    </div>
