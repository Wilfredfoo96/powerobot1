                ...
                <div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a class="dropdown-item"
                                href="{{ route('seller.report.product-stock-export', ['category_id' => request('category_id'), 'sort' => request('sort'), 'search' => request('search')]) }}">{{translate('excel')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <table
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="p-name">
                                    <a href="{{route('seller.product.view',[$data['id']])}}"
                            ...
                            <td>
                                <div class="text-center">
                                    ...
                                    @elseif($data['current_stock'] < $stock_limit) <span
                                        class="badge __badge badge-soft--primary">{{translate('soon_Stock_Out')}}</span>
                                        @endif
                                </div>
                            </td>
                        </tr>
