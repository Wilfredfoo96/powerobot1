...
<div class="content container-fluid">
    <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
        <h2 class="h1 mb-0 d-flex gap-2">
            <img src="http://localhost/6valley/assets/back-end/img/all-orders.png" alt="">
            {{ translate('add_new_product') }}
        </h2>
    </div>

    <!-- Form -->
    <form class="product-form text-start" action="{{ route('seller.product.add-new') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <select class="js-select2-custom form-control" name="sub_sub_category_id"
                                ...
                                <option value="{{ null }}" selected disabled>{{ translate('select_Sub_Sub_Category') }}
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3" id="digital_product_type_show">
                        <div class="form-group">
                            ...
                            <select name="digital_product_type" id="digital_product_type" class="form-control" required>
                                <option value="{{ old('category_id') }}" selected disabled>---{{ translate('select')
                                    }}---</option>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="text" minlength="6" id="generate_number" name="code" class="form-control"
                                value="{{ old('code') }}" placeholder="{{ translate('code') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{translate('enter_tag')}}" name="tags"
                                data-role="tagsinput">
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row align-items-end">
                        ...
                        <div class="form-group">
                            <div class="d-flex gap-2 mb-2">
                                <label class="title-color mb-0" for="minimum_order_qty">{{
                                    translate('minimum_order_qty') }}</label>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="quantity">
                        <div class="form-group">
                            <div class="d-flex gap-2 mb-2">
                                <label class="title-color mb-0" for="current_stock_qty">{{
                                    translate('current_stock_qty') }}</label>
                            ...
                            <input type="number" min="0" value="0" step="1" placeholder="{{ translate('quantity') }}"
                                name="current_stock" id="current_stock_qty" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <div class="d-flex gap-2 mb-2">
                                <label class="title-color mb-0" for="discount_Type">{{ translate('discount_Type') }}
                                    <span class="discount_type_symbol" style="display: none">(%)</span></label>
                        ...
                        <div class="form-group">
                            <div class="d-flex gap-2">
                                <label class="title-color" for="discount">{{ translate('discount_amount') }} <span
                                        class="discount_amount_symbol">({{\App\CPU\BackEndHelper::currency_symbol()}})</span></label>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="0" step="0.01" placeholder="{{ translate('ex: 5') }}"
                                name="tax" id="tax" value="{{ old('tax') }}" class="form-control">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    ...
                                    <span class="badge badge-soft-info">{{ THEME_RATIO[theme_root_path()]['Product
                                        Image'] }}</span>
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                    ...
                                    <div>
                                        <div class="custom_upload_input">
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2">
                                                <img id="pre_img_viewer" class="h-auto aspect-1 bg-white" src="img"
                            ...
                            <div class="form-group w-100">
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="pre_meta_image_viewer" class="h-auto aspect-1 bg-white" src="img"
                                                onerror="this.classList.add('d-none')">
                                        </div>
                                        <div
                                            class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
