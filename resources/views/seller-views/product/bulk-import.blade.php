    ...
    <div class="row" style="text-align: {{Session::get('direction') === " rtl" ? 'right' : 'left' }};">
        <div class="col-12">
            <div class="card card-body">
                ...
                <p>{{ translate('3') }}.
                    {{translate('once_you_have-downloaded_and_filled_the_format_file_upload_it_in_the_form_below_and_submit.')}}
                </p>
                <p>{{ translate('4') }}.
                    {{translate('after_uploading_products_you_need_to_edit_them_and_set_products_images_and_choices.')}}
                </p>
                <p>{{ translate('5') }}.
                    {{translate('you_can_get_brand_and_category_id_from_their_list_please_input_the_right_ids.')}}</p>
                <p>{{ translate('6') }}.
                    {{translate('you_can_upload_your_product_images_in_product_folder_from_gallery_and_copy_images_path.')}}
                </p>
            </div>
        </div>
