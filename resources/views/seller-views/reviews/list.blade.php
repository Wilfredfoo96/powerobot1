                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="customer_id">
                            ...
                            <option value="{{ isset($item->id) ? $item->id : $customer_id }}" {{ $customer_id !=null &&
                                $customer_id==$item->id ? 'selected' : '' }}>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="gap-1">
                                ...
                                <a class="" href="{{ asset('storage/review') }}/{{ $img }}" data-lightbox="mygallery">
                                    <img clsss="p-2" width="60" height="60"
                                        onerror="this.src='{{asset('assets/back-end/img/160x160/img2.jpg')}}'"
                                        src="{{ asset('storage/review') }}/{{ $img }}" alt="Image">
                                </a>
                                @endforeach
                                @endif
                            </div>
