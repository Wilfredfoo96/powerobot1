                    ...
                    <td style="width:50%;vertical-align: top; margin-top:5px;">
                        ...
                        <div style="text-align:left;margin-top:10px;">
                            ...
                            <div style="display:flex; align-items:center;margin-top:10px;">
                                ...
                                <img style="border:0;border-radius:50%;" src="{{asset('/storage/shop/'.$shop->image)}}"
                        ...
                        <div style="text-align:right;margin-top:10px;">
                            ...
                            <div style="margin-top: 10px;">
                                <span style="color: #414141 !important ; text-transform: capitalize;">{{
                                    str_replace('_',' ',$order->payment_method) }}</span><br>
            ...
            <tbody style="">
                ...
                <tr>
                    <td>
                        <?php
                        if($order->is_guest) {
                            $user_phone = $order->shipping_address_data ? json_decode($order->shipping_address_data)->phone : json_decode($order->billing_address_data)->phone;
                        }else{
            ...
            <tbody>
                <tr>
                    <th style="text-align: left;">
                        <h1>
                            {{$company_name = \App\Model\BusinessSetting::where('type',
                        ...
                        justify-content: flex-start;">
                            ...
                            <div class="">
                                <a href="{{$item->link}}" target=”_blank”>
                                    <img src="{{asset('assets/back-end/img/'.$item->name.'.png')}}" alt=""
