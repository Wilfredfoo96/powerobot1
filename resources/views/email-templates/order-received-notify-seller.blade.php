                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer"
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" colspan="2"
                            ...
                            <span style="font-size: 18px; font-weight: normal;">{{\App\CPU\translate('Notification mail
                                for new order received')}}</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" colspan="2" style="padding-top: 10px;">
                            ...
                            <span style="font-size: 12px; line-height: 1.5; color: #333333;">
                                ...
                                {{\App\CPU\translate('We have sent you this email to notify that you have a new order.
                                You will be able to see your orders after login to your panel')}}.
                                ...
                                <a href="javascript:">
                                    <h3 style="font-weight: 1000">{{$id}}</h3>
                                </a>

                                <br /><br />

                                {{\App\CPU\translate('if_you_need_help')}},
                                {{\App\CPU\translate('or_you_have_any_other_questions')}},
                                {{\App\CPU\translate('feel_free_to_email_us')}}.
